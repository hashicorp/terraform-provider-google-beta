...
sidebar_current: "docs-google-secretmanager-secret-version"
description: |-
...
```
$ terraform import -provider=google-beta google_secretmanager_secret_version.default {{name}}/{{name}}
```
