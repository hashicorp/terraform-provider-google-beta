...
* Update CHANGELOG for version 7.44.0 ([#12887](https://github.com/hashicorp/terraform-provider-google-beta/pull/12887))
* oracledatabase: randomize CIDR range in OdbSubnet acceptance test ([#12907](https://github.com/hashicorp/terraform-provider-google-beta/pull/12907))
NOTES:
* compute: migrated `google_compute_images` data source to use direct HTTP rather than a client library ([#12901](https://github.com/hashicorp/terraform-provider-google-beta/pull/12901))
* compute: migrated `google_compute_images` data source to use direct HTTP rather than a client library (revert) ([#12904](https://github.com/hashicorp/terraform-provider-google-beta/pull/12904))
* compute: migrated `google_compute_instance_serial_port` data source to use direct HTTP rather than a client library ([#12897](https://github.com/hashicorp/terraform-provider-google-beta/pull/12897))
* compute: migrated `google_compute_interconnect_location` data source to use direct HTTP rather than a client library ([#12864](https://github.com/hashicorp/terraform-provider-google-beta/pull/12864))
* compute: migrated google_compute_router_interface interconnect attachment fetching to use direct HTTP rather than a client library ([#12867](https://github.com/hashicorp/terraform-provider-google-beta/pull/12867))
* datasource: migrated google_compute_networks data source to use direct HTTP rather than a client library ([#12866](https://github.com/hashicorp/terraform-provider-google-beta/pull/12866))
* storage: migrated the Compute API lookup in the `google_storage_bucket` resource to use direct HTTP rather than a client library ([#12900](https://github.com/hashicorp/terraform-provider-google-beta/pull/12900))
...
* **New Resource:** agenticapplications: added `google_agentic_applications_analyst_agent_persona` resource ([#12895](https://github.com/hashicorp/terraform-provider-google-beta/pull/12895))
...
* accesscontextmanager: supported in-place updates for `google_access_context_manager_service_perimeter_dry_run_ingress_policy` and `google_access_context_manager_service_perimeter_dry_run_egress_policy` ([#12877](https://github.com/hashicorp/terraform-provider-google-beta/pull/12877))
...
* certificatemanager: Enable write-only support for `pem_private_key` to `google_certificate_manager_certificate` resource ([#12905](https://github.com/hashicorp/terraform-provider-google-beta/pull/12905))
...
* chronicle: Added `schedule_customizations` field to `RuleDeployment` resource. ([#12856](https://github.com/hashicorp/terraform-provider-google-beta/pull/12856))
* cloudrunv2: added `templates.sandboxes` field to the `google_cloud_run_v2_service` resource ([#12868](https://github.com/hashicorp/terraform-provider-google-beta/pull/12868))
* colab: added `custom_environment_spec.shielded_instance_config` and `workbench_runtime.vm_image` fields to `google_colab_notebook_execution` ([#12892](https://github.com/hashicorp/terraform-provider-google-beta/pull/12892))
* securityscanner: added `static_ip_scan` field to `google_security_scanner_scan_config` ([#12899](https://github.com/hashicorp/terraform-provider-google-beta/pull/12899))
* sql: added `cpu_utilization_threshold_percent`, `memory_usage_threshold_percent`, `history_list_length_threshold_count`, `semaphore_wait_threshold_count`, `transaction_lock_wait_threshold_count`, `transaction_kill_threshold_seconds`, `transaction_kill_type`, and `transaction_kill_excluded_user_hosts` to `settings.performance_capture_config` in `google_sql_database_instance` (beta) ([#12910](https://github.com/hashicorp/terraform-provider-google-beta/pull/12910))
...
* apphub: Fixed a panic in `google_apphub_service` and `google_apphub_workload` resources when parsing `extended_metadata` containing MCP server definitions. ([#12883](https://github.com/hashicorp/terraform-provider-google-beta/pull/12883))
...
* colab: made `google_colab_notebook_execution` catch drift on the `directNotebookSource.content` field. ([#12892](https://github.com/hashicorp/terraform-provider-google-beta/pull/12892))
...
* compute: fixed permadiffs for `google_compute_disk` onFedora CoreOS images ([#12853](https://github.com/hashicorp/terraform-provider-google-beta/pull/12853))
* compute: fixed truncation of results at 500 images in `google_compute_images` data source ([#12901](https://github.com/hashicorp/terraform-provider-google-beta/pull/12901))
* compute: fixed truncation of results at 500 images in `google_compute_images` data source (revert) ([#12904](https://github.com/hashicorp/terraform-provider-google-beta/pull/12904))
* networksecurity: fixed `google_network_security_gateway_security_policy` to force replacement (`ForceNew`) when `name` or `location` is modified ([#12894](https://github.com/hashicorp/terraform-provider-google-beta/pull/12894))
* networkservices: fixed `google_network_services_gateway` to force replacement (`ForceNew`) when `name` or `location` is modified ([#12902](https://github.com/hashicorp/terraform-provider-google-beta/pull/12902))
