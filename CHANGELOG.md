...
BREAKING CHANGES:
* netapp: made `google_netapp_volumes.squash_mode` not preserve values returned by the API. Without this change, unsetting `squash_mode` in the provider can cause an API error. ([#11023](https://github.com/hashicorp/terraform-provider-google-beta/pull/11023))
...
* netapp: fixed bug where unsetting `squash_mode` on `google_netapp_volumes` can cause an API error ([#11023](https://github.com/hashicorp/terraform-provider-google-beta/pull/11023))
