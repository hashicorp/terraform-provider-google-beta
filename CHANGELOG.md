...
* compute: added `rules` and `tcp_time_wait_timeout_sec` to `google_compute_router_nat` ([#4526](https://github.com/hashicorp/terraform-provider-google-beta/pull/4526))
