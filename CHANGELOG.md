...
* * activedirectory: added `deletion_protection` field to `google_active_directory_domain` resource. This field defaults to `true`, preventing accidental deletions. To delete a `google_active_directory_domain` resource, you must first set `deletion_protection = false` and apply this change before destroying the resource. ([#7837](https://github.com/hashicorp/terraform-provider-google-beta/pull/7837))
