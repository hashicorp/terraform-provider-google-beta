...
* Revert "feat(vertexai): add google_vertex_ai_online_evaluator resource" (#18084) (#12611) ([#12612](https://github.com/hashicorp/terraform-provider-google-beta/pull/12612))
NOTES:
* The `google_vertex_ai_online_evaluator` resource has been reverted. ([#12611](https://github.com/hashicorp/terraform-provider-google-beta/pull/12611))
* compute: Migrate `expandAdvancedMachineFeatures`, `flattenAdvancedMachineFeatures` functions in `compute_instance_helpers.go.tmpl` to use direct HTTP rather than a client library ([#12610](https://github.com/hashicorp/terraform-provider-google-beta/pull/12610))
...
* **New Resource:** `google_bigquery_analytics_hub_query_template` (beta) ([#12669](https://github.com/hashicorp/terraform-provider-google-beta/pull/12669))
* **New Resource:** `google_chronicle_environment_group` (beta) ([#12627](https://github.com/hashicorp/terraform-provider-google-beta/pull/12627))
* **New Resource:** `google_chronicle_findings_refinement_deployment` (ga) ([#12658](https://github.com/hashicorp/terraform-provider-google-beta/pull/12658))
...
* **New Resource:** `google_network_connectivity_custom_hardware_instance` ([#12639](https://github.com/hashicorp/terraform-provider-google-beta/pull/12639))
...
* **New Resource:** `google_vertex_ai_semantic_governance_policy_engine` (beta) ([#12624](https://github.com/hashicorp/terraform-provider-google-beta/pull/12624))
* **New Resource:** chronicle: `google_chronicle_environment` (GA) ([#12628](https://github.com/hashicorp/terraform-provider-google-beta/pull/12628))
* **New Resource:** chronicle: added `google_chronicle_data_export` resource - GA ([#12657](https://github.com/hashicorp/terraform-provider-google-beta/pull/12657))
...
* compute: added `send_empty_value` field to `enableProxyProtocol` on `ServiceAttachment` resource ([#12668](https://github.com/hashicorp/terraform-provider-google-beta/pull/12668))
...
* compute: promote `instance_lifecycle_policy.on_repair.allow_changing_zone` to  ga. ([#12614](https://github.com/hashicorp/terraform-provider-google-beta/pull/12614))
...
* sql: added `enforce_new_sql_network_architecture` field to `google_sql_database_instance` resource (create-only) ([#12653](https://github.com/hashicorp/terraform-provider-google-beta/pull/12653))
...
* storage: depercated `admin-on-second-miss` in `google_storage_anywhere_cache` ([#12632](https://github.com/hashicorp/terraform-provider-google-beta/pull/12632))
...
* chronicle: suppressed a permadiff on `google_chronicle_rule.text` caused by the Chronicle API appending a trailing newline to every stored rule body ([#12637](https://github.com/hashicorp/terraform-provider-google-beta/pull/12637))
...
* eventarc: added a custom flattener to fix a type mismatch when an `google_eventarc_trigger` resource returns non-empty `conditions`. ([#12646](https://github.com/hashicorp/terraform-provider-google-beta/pull/12646))
