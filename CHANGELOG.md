...
* compute: fixed unable to create default rule when using `google_compute_region_security_policy_rule` resource (beta) ([#8535](https://github.com/hashicorp/terraform-provider-google-beta/pull/8535))
* compute: fixed unable to create default rule when using `google_compute_security_policy_rule` resource ([#8535](https://github.com/hashicorp/terraform-provider-google-beta/pull/8535))
