...
* Add Stateful ip field to instance group manager ([#4992](https://github.com/hashicorp/terraform-provider-google-beta/pull/4992))
* Promote GKE Backup BackupPlan to GA ([#5030](https://github.com/hashicorp/terraform-provider-google-beta/pull/5030))
...
* **New Resource:** Add IAM to DNS managed Zone, change DNS name for failed tests in quickstartExample ([#5007](https://github.com/hashicorp/terraform-provider-google-beta/pull/5007))
* **New Resource:** `firebase_database_instance` (beta) ([#5019](https://github.com/hashicorp/terraform-provider-google-beta/pull/5019))
...
* **New Resource:** `google_iam_workforce_pool` (ga only) ([#5003](https://github.com/hashicorp/terraform-provider-google-beta/pull/5003))

IMPROVEMENTS:
* Adding support to 2nd Gen Cloud Functions Terraform Provider for: max_instance_request_concurrency and available_cpu to allow for setting concurrency. ([#5011](https://github.com/hashicorp/terraform-provider-google-beta/pull/5011))
* anthos-fleet-management: added feature `configmanagement:config_sync:oci` to resource `google_gke_hub_feature_membership`. ([#5013](https://github.com/hashicorp/terraform-provider-google-beta/pull/5013))
* compute: Add support for Local IP Ranges in `google_compute_firewall` ([#4979](https://github.com/hashicorp/terraform-provider-google-beta/pull/4979))
...
* container: Promoted `google_container_node_pool.placement_policy` to GA ([#5034](https://github.com/hashicorp/terraform-provider-google-beta/pull/5034))
...
* dataproc: deprecate the v1beta2 API. ([#5009](https://github.com/hashicorp/terraform-provider-google-beta/pull/5009))
...
* sql_database_instance: added [new deletion protection](https://cloud.google.com/sql/docs/mysql/deletion-protection) feature `deletion_protection_enabled` to guard against deletion from all surfaces. ([#4987](https://github.com/hashicorp/terraform-provider-google-beta/pull/4987))
...
BUG FIXES:
* REVERT: datacatalog: fixed the import failure when the `project` is different from the default on `google_data_catalog_taxonomy` ([#5040](https://github.com/hashicorp/terraform-provider-google-beta/pull/5040))
...
* cloudplatform: handled async operation for `google_folder` deletion ([#5039](https://github.com/hashicorp/terraform-provider-google-beta/pull/5039))
...
* datacatalog: fixed the import failure when the `project` is different from the default on `google_data_catalog_taxonomy` ([#5036](https://github.com/hashicorp/terraform-provider-google-beta/pull/5036))
* fix `cloud_identity_group_membership` to properly handle 403 responses when membership does not exist ([#5020](https://github.com/hashicorp/terraform-provider-google-beta/pull/5020))
