...
NOTES:
* Promote google_chronicle_data_access_label resource of chronicle to GA ([#9594](https://github.com/hashicorp/terraform-provider-google-beta/pull/9594))
* cloudrunv2: removed "by-invitation only" language for invokerIamDisabled; feature is now generally available ([#9592](https://github.com/hashicorp/terraform-provider-google-beta/pull/9592))
* google_compute_router_route_policy (GA) ([#9589](https://github.com/hashicorp/terraform-provider-google-beta/pull/9589))
* upgrade google.golang.org/api to v0.226.0 ([#9588](https://github.com/hashicorp/terraform-provider-google-beta/pull/9588))
...
IMPROVEMENTS:
* bigquery: added support for the managed disaster recovery feature in google_bigquery_reservation ([#9575](https://github.com/hashicorp/terraform-provider-google-beta/pull/9575))
...
* compute: Add `group_placement_policy.0.gpu_topology` field to  `google_compute_resource_policy` resource (beta) ([#9555](https://github.com/hashicorp/terraform-provider-google-beta/pull/9555))
* compute: Added `shieldedInstanceInitialState` structure to `google_compute_image` resource ([#9583](https://github.com/hashicorp/terraform-provider-google-beta/pull/9583))
...
* compute: added `instance_lifecycle_policy.on_failed_health_check` field in resources `google_compute_instance_group_manager` and `google_compute_region_instance_group_manager` (beta) ([#9598](https://github.com/hashicorp/terraform-provider-google-beta/pull/9598))
...
* metastore: promoted `scaling_config` field to GA ([#9560](https://github.com/hashicorp/terraform-provider-google-beta/pull/9560))
* networkmanagement: added `destination.forwardingRule`, `destination.gkeMasterCluster`, `destination.fqdn`, `destination.cloudSqlInstance`, `destination.redisInstance`, `destination.redisCluster`,  fields to `google_network_management_connectivity_test` resource ([#9591](https://github.com/hashicorp/terraform-provider-google-beta/pull/9591))
* networkmanagement: added `roundTrip`, `bypassFirewallChecks` fields to `google_network_management_connectivity_test` resource ([#9591](https://github.com/hashicorp/terraform-provider-google-beta/pull/9591))
* networkmanagement: added `source.gkeMasterCluster`,  `source.cloudSqlInstance`, `source.cloudFunction`, `source.appEngineVersion`, `source.cloudRunRevision` fields to `google_network_management_connectivity_test` resource ([#9591](https://github.com/hashicorp/terraform-provider-google-beta/pull/9591))
* networksecurity: added `connectedDeploymentGroup` and `associations` fields to `google_network_security_intercept_endpoint_group` resource ([#9586](https://github.com/hashicorp/terraform-provider-google-beta/pull/9586))
...
* storage: added metadata_options in transfer_spec ([#9567](https://github.com/hashicorp/terraform-provider-google-beta/pull/9567))
...
* compute: fixed the issue that user can't use regional disk in `global_instance_template`. ([#9569](https://github.com/hashicorp/terraform-provider-google-beta/pull/9569))
