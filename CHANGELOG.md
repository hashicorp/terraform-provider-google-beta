...
* Bridge gap between Terraform and API for AlloyDB ([#6363](https://github.com/hashicorp/terraform-provider-google-beta/pull/6363))
* Update CHANGELOG.md for v4.84.0 ([#6381](https://github.com/hashicorp/terraform-provider-google-beta/pull/6381))
* add support for inter-VPC communications in router_nat resource ([#6371](https://github.com/hashicorp/terraform-provider-google-beta/pull/6371))
NOTES:
* compute: `google_compute_node_group` made to require one of `initial_size` or `autoscaling_policy` fields configured upon resource creation ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
DEPRECATIONS:
* cloudiot:  deprecated datasource `google_cloudiot_registry_iam_policy` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudiot:  deprecated resource `google_cloudiot_device` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudiot: deprecated resource  `google_cloudiot_registry` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudiot: deprecated resource `google_cloudiot_registry_iam_*` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* privateca: removed deprecated fields `configValues`, `pemCertificates` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
BREAKING CHANGES:
* accesscontextmanager: changed multiple array fields to sets where appropriate to prevent duplicates and fix diffs caused by server side reordering. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* bigquery: added more input validations for BigQuery table schema ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* bigquery: made `routine_type` required for `google_bigquery_routine` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudfunction2: made `location` required on `google_cloudfunctions2_function` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudrunv2: Removed deprecated field `liveness_probe.tcp_socket` from `google_cloud_run_v2_service` resource. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudrunv2: Removed deprecated fields `startup_probe` and `liveness_probe` from `google_cloud_run_v2_job` resource. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudrunv2: transitioned `volumes.cloud_sql_instance.instances` to SET from ARRAY for `google_cloud_run_v2_service` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* compute: `size` in `google_compute_node_group` is now an output only field. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* compute: removed default value for `rule.rate_limit_options.encorce_on_key` on resource `google_compute_security_policy` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* container: `google_container_cluster` now has `deletion_protection` enabled to `true` by default. When enabled, this field prevents Terraform from deleting the resource. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* container: removed the behaviour that `google_container_cluster` will delete the cluster if it's created in an error state. Instead, it will mark the cluster as tainted, allowing manual inspection and intervention. To proceed with deletion, run another `terraform apply`. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* container: reworked the `taint` field in `google_container_cluster` and `google_container_node_pool` to only manage a subset of taint keys based on those already in state. Most existing resources are unaffected, unless they use `sandbox_config`- see upgrade guide for details. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* dataplex: removed `data_profile_result` and `data_quality_result` from `google_dataplex_scan` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* firebase: changed `deletion_policy` default to `DELETE` for `google_firebase_web_app`. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* firebase: made `google_firebase_rules.release` immutable ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* firebase: removed `google_firebase_project_location` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* gameservices: Remove Terraform support for `gameservices` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* logging: changed the default value of `unique_writer_identity` from `false` to `true` in `google_logging_project_sink`. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* logging: made `growth_factor`, `num_finite_buckets`, and `scale` required for `google_logging_metric` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* looker: removed `LOOKER_MODELER` as a possible value in `google_looker_instance. platform_edition` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* monitoring: fixed perma-diffs in `google_monitoring_dashboard.dashboard_json` by suppressing values returned by the API that are not in configuration ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* monitoring: made `labels` immutable in `google_monitoring_metric_descriptor` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* provider: Empty strings in the provider configuration block will no longer be ignored when configuring the provider ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* provider: data sources now return errors on 404s when applicable instead of silently failing ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* provider: fixed many import functions throughout the provider that matched a subset of the provided input when possible. Now, the GCP resource id supplied to "terraform import" must match exactly. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* secretmanager: removed `automatic` field in `google_secret_manager_secret` resource ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* servicenetworking: used Create instead of Patch to create `google_service_networking_connection` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* servicenetworking: used the `deleteConnection` method to delete the resource `google_service_networking_connection` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* container: added the `effective_taints` attribute to `google_container_cluster` and `google_container_node_pool`, outputting all known taint values ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* container: allow setting `addons_config.gcs_fuse_csi_driver_config` on `google_container_cluster` with `enable_autopilot: true`. ([#6378](https://github.com/hashicorp/terraform-provider-google-beta/pull/6378))
* containeraws: added `binary_authorization` to `google_container_aws_cluster` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* containeraws: added `update_settings` to `google_container_aws_node_pool` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* google_compute_instance ([#6331](https://github.com/hashicorp/terraform-provider-google-beta/pull/6331))
...
* provider: added provider default labels ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
BUG FIXES:
* `dataflow`: fixed issue causing error message when max_workers and num_workers were supplied via parameters. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* `dataflow`: fixed max_workers read value permanently displaying as 0. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* `dataflow`: fixed permadiff when SdkPipeline values are supplied via parameters. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* bigquery: fix diff suppression in `external_data_configuration.connection_id` ([#6368](https://github.com/hashicorp/terraform-provider-google-beta/pull/6368))
* bigquery: fixed view and materialized view creation when schema is specified ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* bigtable: avoided re-creation of instance when cluster is still updating and storage type changed ([#6353](https://github.com/hashicorp/terraform-provider-google-beta/pull/6353))
...
* compute: added default value to `metric.filter` in the resource `google_compute_autoscaler` (beta) ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* compute: removed the default value for field `reconcile_connections ` in resource `google_compute_service_attachment`, the field will now default to a value returned by the API when not set in configuration ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* compute: used APIs default value for field `enable_endpoint_independent_mapping` in resource `google_compute_router_nat` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* monitoring: fixed an issue where `metadata` was not able to be updated in `google_monitoring_metric_descriptor` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* provider: fixed a bug where labels/annotations field not exists in GA for some resources ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* sql: fixed diffs when re-ordering existing `database_flags` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* workstations: fixed in-place updates of `host.gceInstance.accelerators` in `workstation_config` ([#6354](https://github.com/hashicorp/terraform-provider-google-beta/pull/6354))
