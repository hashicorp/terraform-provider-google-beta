...
* bigquery: added more input validations for BigQuery table schema ([#5975](https://github.com/hashicorp/terraform-provider-google-beta/pull/5975))
...
* privateca: removed deprecated fields `configValues`, `pemCertificates` ([#6097](https://github.com/hashicorp/terraform-provider-google-beta/pull/6097))
...
IMPROVEMENTS:
* provider: added provider default labels ([#6207](https://github.com/hashicorp/terraform-provider-google-beta/pull/6207))
...
BUG FIXES:
* dataflow: fixed issue causing error message when max_workers and num_workers were supplied via parameters. ([#6357](https://github.com/hashicorp/terraform-provider-google-beta/pull/6357))
* dataflow: fixed max_workers read value permanently displaying as 0. ([#6357](https://github.com/hashicorp/terraform-provider-google-beta/pull/6357))
* dataflow: fixed permadiff when SdkPipeline values are supplied via parameters. ([#6357](https://github.com/hashicorp/terraform-provider-google-beta/pull/6357))
...
* bigquery: fixed view and materialized view creation when schema is specified ([#6034](https://github.com/hashicorp/terraform-provider-google-beta/pull/6034))
...
* compute: used APIs default value for field `enable_endpoint_independent_mapping` in resource `google_compute_router_nat` ([#6053](https://github.com/hashicorp/terraform-provider-google-beta/pull/6053))
...
* sql: fixed diffs when re-ordering existing `database_flags` ([#6172](https://github.com/hashicorp/terraform-provider-google-beta/pull/6172))
