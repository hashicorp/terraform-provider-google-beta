...
* **New Resource:** `google_vmwareengine_cluster` (GA only) ([#6735](https://github.com/hashicorp/terraform-provider-google-beta/pull/6735))
...
IMPROVEMENTS:
* bigquery: added `external_dataset_reference` field to `google_bigquery_dataset` resource (beta) ([#6716](https://github.com/hashicorp/terraform-provider-google-beta/pull/6716))
* compute: added `numeric_id` field to `google_compute_network` resource ([#6719](https://github.com/hashicorp/terraform-provider-google-beta/pull/6719))
...
* container: changed `machineType`/`diskType`/`diskSizeGb` to `ForceNew: false` on `NodePool` ([#6722](https://github.com/hashicorp/terraform-provider-google-beta/pull/6722))
...
* orgpolicy: added `dry_run_spec` to `google_org_policy_policy` (beta) ([#6732](https://github.com/hashicorp/terraform-provider-google-beta/pull/6732))
...
* spanner: added support for defining autoscaling limit using node count in `google_spanner_instance` ([#6748](https://github.com/hashicorp/terraform-provider-google-beta/pull/6748))
...
* logging: value change of `unique_writer_identity` on `google_logging_project_sink` does not trigger diff on dependent's usages of `writer_identity` ([#6742](https://github.com/hashicorp/terraform-provider-google-beta/pull/6742))
