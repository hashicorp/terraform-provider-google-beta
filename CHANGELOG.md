...
BUG FIXES:
* compute: fix permadiff regression when iap is omitted from `google_compute_backend_service` ([#13041](https://github.com/hashicorp/terraform-provider-google-beta/pull/13041))
