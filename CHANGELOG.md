...
NOTES:
* (revert) cloudfunctions2: added new fields `direct_vpc_network_interface` and `direct_vpc_egress`. Users who have enabled DirectVPC on the underlying Run service will need to take extra care, as the values may now need to be explicitly set in your configuration ([#11560](https://github.com/hashicorp/terraform-provider-google-beta/pull/11560))
* (revert) cloudfunctions2: promoted `direct_vpc_network_interface` and `direct_vpc_egress` fields to GA in the `google_cloudfunctions2_function` resource. ([#11560](https://github.com/hashicorp/terraform-provider-google-beta/pull/11560))
* REMOVE alloydb: added write-only support for `initial_user.password_wo` to `google_alloydb_cluster` ([#11511](https://github.com/hashicorp/terraform-provider-google-beta/pull/11511))
* compute: promoted `allow_subnet_cidr_routes_overlap` field to GA in `google_compute_subnetwork` resource ([#11506](https://github.com/hashicorp/terraform-provider-google-beta/pull/11506))
BREAKING CHANGES:
* cloudfunctions2: added new fields `direct_vpc_network_interface` and `direct_vpc_egress`. Users who have enabled DirectVPC on the underlying Run service will need to take extra care, as the values may now need to be explicitly set in your configuration ([#11550](https://github.com/hashicorp/terraform-provider-google-beta/pull/11550))
...
* **New Data Source:** `google_kms_secret_asymmetric` (ga) ([#11565](https://github.com/hashicorp/terraform-provider-google-beta/pull/11565))
...
* **New Resource:** `google_cloud_identity_policy` (beta) ([#11536](https://github.com/hashicorp/terraform-provider-google-beta/pull/11536))
* **New Resource:** `google_compute_rollout_plan` ([#11562](https://github.com/hashicorp/terraform-provider-google-beta/pull/11562))
* **New Resource:** `google_dataform_folder` (beta) ([#11542](https://github.com/hashicorp/terraform-provider-google-beta/pull/11542))
...
IMPROVEMENTS:
* alloydb: added write-only support for `initial_user.password_wo` to `google_alloydb_cluster` ([#11507](https://github.com/hashicorp/terraform-provider-google-beta/pull/11507))
...
* biglakeiceberg: clarified the usage of the `name` field in `google_biglake_iceberg_catalog` resource. ([#11509](https://github.com/hashicorp/terraform-provider-google-beta/pull/11509))
* ces: added MCP Toolset to `toolset` resource ([#11513](https://github.com/hashicorp/terraform-provider-google-beta/pull/11513))
* cloudfunctions2: promoted `direct_vpc_network_interface` and `direct_vpc_egress` fields to GA in the `google_cloudfunctions2_function` resource. ([#11550](https://github.com/hashicorp/terraform-provider-google-beta/pull/11550))
* compute: Enable write-only support for `private_key` to `google_compute_region_ssl_certificate` resource ([#11544](https://github.com/hashicorp/terraform-provider-google-beta/pull/11544))
* compute: Enable write-only support for `private_key` to `google_compute_ssl_certificate` resource ([#11544](https://github.com/hashicorp/terraform-provider-google-beta/pull/11544))
* compute: added `enable` field to `google_compute_packet_mirroring` ([#11537](https://github.com/hashicorp/terraform-provider-google-beta/pull/11537))
...
* compute: added `slice-controller` field to `resource_container_cluster` resource ([#11510](https://github.com/hashicorp/terraform-provider-google-beta/pull/11510))
...
* filestore: added `replica_action` to `google_filestore_instance` ([#11553](https://github.com/hashicorp/terraform-provider-google-beta/pull/11553))
* networksecurity: added `policy_profile`, `http_rules.0.to.0.operations.0.mcp` to `google_network_security_authz_policy`. Relaxed `load_balancing_scheme` validation to support non-Backend Service targets. ([#11559](https://github.com/hashicorp/terraform-provider-google-beta/pull/11559))
...
* spanner: Remove restriction on CMEK for incremental backup schedules ([#11541](https://github.com/hashicorp/terraform-provider-google-beta/pull/11541))
* spanner: support user_project_override in `spanner_database_iam` and `spanner_instance_iam` resources ([#11527](https://github.com/hashicorp/terraform-provider-google-beta/pull/11527))
* sql: added `server_certificate_rotation_mode` field to `google_sql_database_instance` resource ([#11539](https://github.com/hashicorp/terraform-provider-google-beta/pull/11539))
* sql: added `server_certificate_rotation_mode` field to `google_sql_database_instance` resource (revert) ([#11568](https://github.com/hashicorp/terraform-provider-google-beta/pull/11568))
