...
* cloudbuild: added `repository_event_config` field to `google_cloudbuild_trigger` resource (ga) ([#5857](https://github.com/hashicorp/terraform-provider-google-beta/pull/5857))
* cloudbuildv2: added `gitlab_config` field to `google_cloudbuildv2_connection` resource (beta) ([#5848](https://github.com/hashicorp/terraform-provider-google-beta/pull/5848))
...
* container: made `monitoring_config.enable_components` optional in `google_container_cluster` ([#5872](https://github.com/hashicorp/terraform-provider-google-beta/pull/5872))
* gkehub: promoted the `google_gke_hub_feature` resource's `fleetobservability` block to GA. ([#5861](https://github.com/hashicorp/terraform-provider-google-beta/pull/5861))
