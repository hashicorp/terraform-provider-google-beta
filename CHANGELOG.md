...
DEPRECATIONS:
* alloydb: deprecated `network` field in favor of `network_config`. ([#6297](https://github.com/hashicorp/terraform-provider-google-beta/pull/6297))
...
* **New Resource:** `google_tpu_v2_vm` (beta) ([#6264](https://github.com/hashicorp/terraform-provider-google-beta/pull/6264))
...
IMPROVEMENTS:
* alloydb: added `network_config` field to support named IP ranges. ([#6297](https://github.com/hashicorp/terraform-provider-google-beta/pull/6297))
...
* container: promoted `node_pool_auto_config` field in `google_container_cluster` from beta provider to GA provider. (ga) ([#6299](https://github.com/hashicorp/terraform-provider-google-beta/pull/6299))
* container: promoted field `placement_policy.tpu_topology` in resource `google_container_node_pool` to GA ([#6286](https://github.com/hashicorp/terraform-provider-google-beta/pull/6286))
* containeraws: added support for `auto_repair` in `container_aws_node_pool` ([#6282](https://github.com/hashicorp/terraform-provider-google-beta/pull/6282))
* containerazure: added support for `auto_repair` in `container_azure_node_pool` ([#6282](https://github.com/hashicorp/terraform-provider-google-beta/pull/6282))
...
* networkconnectivity: added support for `linked_vpc_network` in `network_connectivity_spoke` ([#6282](https://github.com/hashicorp/terraform-provider-google-beta/pull/6282))
...
* eventarc: field `event_data_content_type` in `eventarc_trigger` now marked as computed ([#6282](https://github.com/hashicorp/terraform-provider-google-beta/pull/6282))
