...
* provider: made data sources return errors on 404s when applicable instead of silently failing ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* provider: made empty strings in the provider configuration block no longer be ignored when configuring the provider ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* cloudiot: removed deprecated datasource `google_cloudiot_registry_iam_policy` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudiot: removed deprecated resource `google_cloudiot_device` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudiot: removed deprecated resource  `google_cloudiot_registry` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* cloudiot: removed deprecated resource `google_cloudiot_registry_iam_*` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* compute: made `google_compute_node_group` require one of `initial_size` or `autoscaling_policy` fields configured upon resource creation ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
* compute: made `size` in `google_compute_node_group` an output only field. ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* gameservices: removed Terraform support for `gameservices` ([#6395](https://github.com/hashicorp/terraform-provider-google-beta/pull/6395))
...
* compute: added `type` field to `google_compute_router_nat` resource (beta) ([#6331](https://github.com/hashicorp/terraform-provider-google-beta/pull/6371)) 
* compute: added `rules.action.source_nat_active_ranges` field to `google_compute_router_nat` resource (beta) ([#6331](https://github.com/hashicorp/terraform-provider-google-beta/pull/6371)) 
* compute: added `rules.action.source_nat_drain_ranges` field to `google_compute_router_nat` resource (beta) ([#6331](https://github.com/hashicorp/terraform-provider-google-beta/pull/6371)) 
* compute: added `network_attachment` to `google_compute_instance` (beta) ([#6331](https://github.com/hashicorp/terraform-provider-google-beta/pull/6331))
...
* bigquery: fixed diff suppression in `external_data_configuration.connection_id` ([#6368](https://github.com/hashicorp/terraform-provider-google-beta/pull/6368))
