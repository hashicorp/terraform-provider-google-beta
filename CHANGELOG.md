...
* **New Resource:** `google_iap_agent_registry_iam_binding` (beta) ([#11905](https://github.com/hashicorp/terraform-provider-google-beta/pull/11905))
* **New Resource:** `google_iap_agent_registry_iam_member` (beta) ([#11905](https://github.com/hashicorp/terraform-provider-google-beta/pull/11905))
* **New Resource:** `google_iap_agent_registry_iam_policy` (beta) ([#11905](https://github.com/hashicorp/terraform-provider-google-beta/pull/11905))
* **New Resource:** `google_iap_location_web_iam_binding` (beta) ([#11905](https://github.com/hashicorp/terraform-provider-google-beta/pull/11905))
* **New Resource:** `google_iap_location_web_iam_member` (beta) ([#11905](https://github.com/hashicorp/terraform-provider-google-beta/pull/11905))
* **New Resource:** `google_iap_location_web_iam_policy` (beta) ([#11905](https://github.com/hashicorp/terraform-provider-google-beta/pull/11905))
* **New Resource:** `google_service_usage_v2_folder_consumer_policy` (beta) ([#11875](https://github.com/hashicorp/terraform-provider-google-beta/pull/11875))
* **New Resource:** `google_service_usage_v2_folder_consumer_policy` (beta) (revert) ([#11895](https://github.com/hashicorp/terraform-provider-google-beta/pull/11895))
...
* vertexai: added 10-second wait before reading the updated resource in `google_vertex_ai_reasoning_engine` resource, preventing stale values getting written to state ([#11918](https://github.com/hashicorp/terraform-provider-google-beta/pull/11918))
