...
* **New Resource:** `google_network_connectivity_custom_hardware_instance` (revert, cherrypicked 7.40.0) ([#12682](https://github.com/hashicorp/terraform-provider-google-beta/pull/12682))

IMPROVEMENTS:
* accesscontextmanager: added `allowed_service_patterns` and `service_patterns_enforcement_scopes` fields to `google_access_context_manager_service_perimeter` to support VPC Service Controls for non-GCP APIs. ([#12705](https://github.com/hashicorp/terraform-provider-google-beta/pull/12705))
* accesscontextmanager: added `pscEndpoint` to `sources` in `ingress_from` and `egress_from` under resources `google_access_context_manager_service_perimeter` and variants ([#12678](https://github.com/hashicorp/terraform-provider-google-beta/pull/12678))
* backupdr: added `backup_blocked_by_vault_access_restriction` to `data.google_backup_dr_data_source` resource  ([#12717](https://github.com/hashicorp/terraform-provider-google-beta/pull/12717))
* backupdr: added `force_update_access_restriction` to `google_backup_dr_backup_vault` resource ([#12717](https://github.com/hashicorp/terraform-provider-google-beta/pull/12717))
...
* certificatemanager: added in-place update support for the `self_managed` certificate data (`pem_certificate` / `pem_private_key`) on `google_certificate_manager_certificate`; changing the certificate data is now applied via update instead of forcing recreation ([#12696](https://github.com/hashicorp/terraform-provider-google-beta/pull/12696))
* cloudrunv2: added `tags` field to `google_cloud_run_v2_service` and `google_cloud_run_v2_job` resources to allow setting tags for services and jobs at creation time. ([#12690](https://github.com/hashicorp/terraform-provider-google-beta/pull/12690))
* cloudsql: added `max_custom_on_demand_retention_days` to create backup_plan example for sqladmin ([#12700](https://github.com/hashicorp/terraform-provider-google-beta/pull/12700))
...
* dataproc: added the `instance_selection.disk_config` field to the `google_dataproc_cluster` resource ([#12698](https://github.com/hashicorp/terraform-provider-google-beta/pull/12698))
...
* google_sql_database_instance: Added `instance_auto_dns_status` and `write_endpoint_auto_dns_status` output fields to the `psc_auto_connections` block in `google_sql_database_instance`. ([#12692](https://github.com/hashicorp/terraform-provider-google-beta/pull/12692))
...
* vertexai: added `traffic_config`, `url`, `agent_server_mode`, `agent_gateway_config`, `keep_alive_probe`, `dedicated_ingress_endpoint_enabled`, `agent_config_source`, `agent_card`, `example_store`, `build_spec`, `traffic_config`, and `example_store_config` fields to `google_vertex_ai_reasoning_engine` (beta) ([#12671](https://github.com/hashicorp/terraform-provider-google-beta/pull/12671))
...
* workebench: added `enable_deletion_protection` field to `google_workbench_instance` resource ([#12712](https://github.com/hashicorp/terraform-provider-google-beta/pull/12712))
...
BUG FIXES:
* compute: fixed bug where a permadiff on `google_compute_reservation_region_commitment.existing_reservations` would persist after upgrading ([#12709](https://github.com/hashicorp/terraform-provider-google-beta/pull/12709))
* compute: fixed permadiff on `keepalive_interval` for `google_compute_router` bgp block when set to default value ([#12676](https://github.com/hashicorp/terraform-provider-google-beta/pull/12676))
...
* securityposture: Fixed a bug where the `enforce` field in `google_securityposture_posture` was always set, causing failures for list constraints. ([#12715](https://github.com/hashicorp/terraform-provider-google-beta/pull/12715))
* vmwareengine: added correct `update_mask` value to `google_vmwareengine_private_cloud` updates ([#12716](https://github.com/hashicorp/terraform-provider-google-beta/pull/12716))
