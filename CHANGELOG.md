...
* `google_compute_address` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_cross_site_network` ([#12497](https://github.com/hashicorp/terraform-provider-google-beta/pull/12497))
* `google_compute_https_health_check` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_machine_image` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_node_template` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_packet_mirroring` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_region_autoscaler` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_region_composite_health_check` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_region_health_aggregation_policy` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_compute_region_health_source` ([#12528](https://github.com/hashicorp/terraform-provider-google-beta/pull/12528))
* `google_project_iam_member` ([#12516](https://github.com/hashicorp/terraform-provider-google-beta/pull/12516))
* `google_pubsub_topic` ([#12525](https://github.com/hashicorp/terraform-provider-google-beta/pull/12525))
* `google_secret_manager_secret` ([#12521](https://github.com/hashicorp/terraform-provider-google-beta/pull/12521))
