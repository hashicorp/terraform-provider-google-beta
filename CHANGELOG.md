...
* Update CHANGELOG 5.26.0 ([#7298](https://github.com/hashicorp/terraform-provider-google-beta/pull/7298))
NOTES:
...
* **New Resource:** `google_privileged_access_manager_entitlement` (beta) ([#7283](https://github.com/hashicorp/terraform-provider-google-beta/pull/7283))
...
* bigquery: promoted `external_dataset_reference` in `bigquery_dataset` to GA ([#7284](https://github.com/hashicorp/terraform-provider-google-beta/pull/7284))
* composer: promoted `config.0.software_config.0.image_version` in-place updates to GA in resource `google_composer_environment` ([#7303](https://github.com/hashicorp/terraform-provider-google-beta/pull/7303))
...
* integrations: Deprecated `create_sample_workflows` and `provision_gmek` fields and added `create_sample_integrations` in `google_integrations_client` to keep it consistent with terminology. ([#7285](https://github.com/hashicorp/terraform-provider-google-beta/pull/7285))
...
BUG FIXES:
* dns: fixed bug where the deletion of manages zones that have a SOA-Record set with terraform did not work ([#7305](https://github.com/hashicorp/terraform-provider-google-beta/pull/7305))
