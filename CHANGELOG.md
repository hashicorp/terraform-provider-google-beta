...
* **New Resource:** `google_network_security_gateway_security_policy` ([#5615](https://github.com/hashicorp/terraform-provider-google-beta/pull/5615))
...
* cloudrunv2: Added `template.containers.depends_on` to `google_cloud_run_v2_service`. ([#5613](https://github.com/hashicorp/terraform-provider-google-beta/pull/5613))
...
* cloudrunv2: Added `template.volumes.empty_dir` to `google_cloud_run_v2_service`. ([#5613](https://github.com/hashicorp/terraform-provider-google-beta/pull/5613))
...
* container: Added GCSFuse for GKE cluster. ([#5616](https://github.com/hashicorp/terraform-provider-google-beta/pull/5616))
