...
* Added go:build tools line ([#3670](https://github.com/hashicorp/terraform-provider-google-beta/pull/3670))
* Added monitoring metrics scope and monitored project resources. ([#3642](https://github.com/hashicorp/terraform-provider-google-beta/pull/3642))
DEPRECATIONS:
...
* compute: Fixed recreation of GCE instances when updating `resource_policies` property ([#3668](https://github.com/hashicorp/terraform-provider-google-beta/pull/3668))
...
* filestore: fixed `reserved_ip_range` can't be updated on `google_filestore_instance` ([#3651](https://github.com/hashicorp/terraform-provider-google-beta/pull/3651))
* serviceusage: enabled the service api to retry on failed operation calls in anticipation of transient errors that occur when first enabling the service. ([#3666](https://github.com/hashicorp/terraform-provider-google-beta/pull/3666))
