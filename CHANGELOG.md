...
* compute: fixed errors details for zonal resize request & align with API errors details on `google_compute_resize_request` ([#8941](https://github.com/hashicorp/terraform-provider-google-beta/pull/8941))
...
* container: made nodepool concurrent operations scale better ([#8943](https://github.com/hashicorp/terraform-provider-google-beta/pull/8943))
