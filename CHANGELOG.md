...
* datastream: made `password` mutable in `google_datastream_connection_profile` not cause recreation of the resource. ([#6140](https://github.com/hashicorp/terraform-provider-google-beta/pull/6140))
