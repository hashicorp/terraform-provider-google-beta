...
* sql: added `instance_auto_dns_status` and `write_endpoint_auto_dns_status` output fields to `psc_auto_connections` block in `google_sql_database_instance` resource ([#12692](https://github.com/hashicorp/terraform-provider-google-beta/pull/12692))
...
* vertexai: added `traffic_config`, `url`, `agent_server_mode`, `agent_gateway_config`, `keep_alive_probe`, `dedicated_ingress_endpoint_enabled`, `agent_config_source`, `agent_card`, `example_store`, `build_spec`, and `example_store_config` fields to `google_vertex_ai_reasoning_engine` (beta) ([#12671](https://github.com/hashicorp/terraform-provider-google-beta/pull/12671))
