...
* fix: Update workflow_basic.tf.erb ([#5910](https://github.com/hashicorp/terraform-provider-google-beta/pull/5910))

FEATURES:
* **New Resource:** `google_dns_response_policy_rule` (ga) ([#5878](https://github.com/hashicorp/terraform-provider-google-beta/pull/5878))
* **New Resource:** `google_dns_response_policy` (ga) ([#5878](https://github.com/hashicorp/terraform-provider-google-beta/pull/5878))
...
* compute: added field `enableConfidentialCompute` for `google_compute_disk` resource ([#5897](https://github.com/hashicorp/terraform-provider-google-beta/pull/5897))
...
* monitoring: fixed an issue which occurred when `name` field of `google_monitoring_monitored_project` was long-form ([#5905](https://github.com/hashicorp/terraform-provider-google-beta/pull/5905))
* tags:  Add mutex to `google_tags_location_tag_binding` ([#5904](https://github.com/hashicorp/terraform-provider-google-beta/pull/5904))
