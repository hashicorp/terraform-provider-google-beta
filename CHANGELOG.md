...
* dataform: added `disabled` field to `google_dataform_repository_workflow_config` resource (beta) ([#12394](https://github.com/hashicorp/terraform-provider-google-beta/pull/12394))
...
* firebaseailogic: added `regional_propagation_disabled` field to `google_firebase_ai_logic_prompt_template` and `google_firebase_ai_logic_prompt_template_lock` resources (beta) ([#12349](https://github.com/hashicorp/terraform-provider-google-beta/pull/12349))
