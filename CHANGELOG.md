...
FEATURES:
* **New Data Source:** `firebase_android_app_config` ([#5425](https://github.com/hashicorp/terraform-provider-google-beta/pull/5425))
...
* compute: added SEV_LIVE_MIGRATABLE to guestOsFeatures enum. ([#5424](https://github.com/hashicorp/terraform-provider-google-beta/pull/5424))
* compute: added stack_type to resource `ha_vpn_gateway` ([#5395](https://github.com/hashicorp/terraform-provider-google-beta/pull/5395))
...
* enhancement: increased the max count for `route_rule` to 200 on `google_network_services_edge_cache_service` ([#5433](https://github.com/hashicorp/terraform-provider-google-beta/pull/5433))
