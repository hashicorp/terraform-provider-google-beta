...
* bigquery: added `external_runtime_options` and `python_options` fields to `bigquery_routine` resource (beta) ([#11125](https://github.com/hashicorp/terraform-provider-google-beta/pull/11125))
...
* filestore: add support for updating `directory_services` fields in place in `google_filestore_instance` ([#11137](https://github.com/hashicorp/terraform-provider-google-beta/pull/11137))
...
* netapp: Add public docs link for `google_netapp_host_group` resource ([#11160](https://github.com/hashicorp/terraform-provider-google-beta/pull/11160))
...
* servicedirectory: promoted `google_service_directory_namespace`, `google_service_directory_service`, and `google_service_directory_endpoint` to GA ([#11078](https://github.com/hashicorp/terraform-provider-google-beta/pull/11078))
...
* spanner: prevented forceNew when kmsKeyName and kmsKeyNames are same for `google_spanner_database` ([#11083](https://github.com/hashicorp/terraform-provider-google-beta/pull/11083))
