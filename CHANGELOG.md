...
BUG FIXES:
* compute: fixed default handling for `enableDynamicPortAllocation` to be managed by the api ([#4391](https://github.com/hashicorp/terraform-provider-google-beta/pull/4391))
