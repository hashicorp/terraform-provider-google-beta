...
* compute: added `rule.rate_limit_options.enforce_on_key_configs` field to `google_compute_security_policy` resource (GA) ([#8849](https://github.com/hashicorp/terraform-provider-google-beta/pull/8849))
...
* container: promoted `google_container_cluster.enable_fqdn_network_policy` to GA ([#8855](https://github.com/hashicorp/terraform-provider-google-beta/pull/8855))
...
* compute: updating labels on `resource_google_compute_resource_policy` will no longer fail because of a Patch error with `guest_flush` ([#8874](https://github.com/hashicorp/terraform-provider-google-beta/pull/8874))
