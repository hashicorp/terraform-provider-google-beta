...
NOTES:
* compute: migrated `resource_compute_instance_template` resource partially to use direct HTTP rather than a client library ([#12576](https://github.com/hashicorp/terraform-provider-google-beta/pull/12576))
* compute: migrated `resource_compute_network_peering` resource to use direct HTTP rather than a client library ([#12587](https://github.com/hashicorp/terraform-provider-google-beta/pull/12587))
...
* **New Resource:** `google_compute_zonal_vm_extension_policy` ([#12595](https://github.com/hashicorp/terraform-provider-google-beta/pull/12595))
...
* compute: migrated `compute_instance_helpers` interfaces ([#12506](https://github.com/hashicorp/terraform-provider-google-beta/pull/12506))
