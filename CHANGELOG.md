...
* bigtable: add support for explicit disable automated backup on create for `google_bigtable_table` ([#9943](https://github.com/hashicorp/terraform-provider-google-beta/pull/9943))
* compute: add `guest_os_features` and `architecture` to `google_compute_instance_template` and `google_compute_region_instance_template` ([#9950](https://github.com/hashicorp/terraform-provider-google-beta/pull/9950))
