...
* datastream: added `gtid`, `binaryLogPosition` fields to `google_datastream_stream` resource ([#8967](https://github.com/hashicorp/terraform-provider-google-beta/pull/8967))
...
* apigee: fixed error 404 for `google_apigee_environment` update requests. ([#8949](https://github.com/hashicorp/terraform-provider-google-beta/pull/8949))
...
* networkconnectivity: made `include_export_ranges`, `exclude_export_ranges` mutable in `google_network_connectivity_spoke` to avoid recreation of resources (b/383149651) ([#8946](https://github.com/hashicorp/terraform-provider-google-beta/pull/8946))
