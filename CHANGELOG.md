...
* compute: added `group_placement_policy.0.gpu_topology` field to  `google_compute_resource_policy` resource (beta) ([#9555](https://github.com/hashicorp/terraform-provider-google-beta/pull/9555))
