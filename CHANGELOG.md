...
* **New Resource:** `google_biglake_iceberg_namespace` ([#11547](https://github.com/hashicorp/terraform-provider-google/pull/11547))
...
* bigqueryanalyticshub: fixed update failure for `replica_locations` in `google_bigquery_analytics_hub_listing` ([#11523](https://github.com/hashicorp/terraform-provider-google-beta/pull/11523))
