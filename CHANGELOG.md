...
* **New Resource:** pubsub: added GCS ingestion settings and platform log settings to `google_pubsub_topic` resource ([#8298](https://github.com/hashicorp/terraform-provider-google-beta/pull/8298))

IMPROVEMENTS:
* assuredworkloads: added `HEALTHCARE_AND_LIFE_SCIENCES_CONTROLS` and `HEALTHCARE_AND_LIFE_SCIENCES_CONTROLS_WITH_US_SUPPORT` enum values to `compliance_regime` in the `google_assuredworkload_workload` resource ([#8326](https://github.com/hashicorp/terraform-provider-google-beta/pull/8326))
...
* compute: promoted `client_destination_port` and `instance` fields in `google_compute_region_network_endpoint` resource to GA (revert) ([#8305](https://github.com/hashicorp/terraform-provider-google-beta/pull/8305))
...
* dataproc: switched to the v1 API for `google_dataproc_autoscaling_policy` resource (beta) ([#8306](https://github.com/hashicorp/terraform-provider-google-beta/pull/8306))
...
* compute: fixed the issue that `labels` is not set when creating the resource `google_compute_interconnect` ([#8284](https://github.com/hashicorp/terraform-provider-google-beta/pull/8284))
