...
* compute: allowed in-place updates to the `secondary_ip_range` field for resource `google_compute_subnetwork` ([#11830](https://github.com/hashicorp/terraform-provider-google-beta/pull/11830))
...
* pubsub: added `aiInference` field to `Topic` and `Subscription` resources. ([#11852](https://github.com/hashicorp/terraform-provider-google-beta/pull/11852))
* vertexai: added support for `context_spec` including `memory_bank_config` in `google_vertex_ai_reasoning_engine` ([#11827](https://github.com/hashicorp/terraform-provider-google-beta/pull/11827))
...
BUG FIXES:
* compute: fixed a permadiff on the `adaptive_protection_config` field for `google_compute_security_policy` resource ([#11833](https://github.com/hashicorp/terraform-provider-google-beta/pull/11833))
...
* google_biglake_iceberg_catalog: changed the `primary-location` parameter to `primary_location` in the create URL. ([#11836](https://github.com/hashicorp/terraform-provider-google-beta/pull/11836))
* oracledatabase: updated disaster recovery test for Oracle Database@Google Cloud Autonomous AI Database ([#11809](https://github.com/hashicorp/terraform-provider-google-beta/pull/11809))
* securityposture: changed to always send value of `enforce` attribute to the api on `google_securityposture_posture` ([#11817](https://github.com/hashicorp/terraform-provider-google-beta/pull/11817))
