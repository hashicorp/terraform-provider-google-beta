...
* **New Datasource**: `google_composer_image_versions` [GH-752]
...
* compute: `google_compute_region_backend_service` now supports failover policies ([GH-1857](https://github.com/GoogleCloudPlatform/magic-modules/pull/1857))
