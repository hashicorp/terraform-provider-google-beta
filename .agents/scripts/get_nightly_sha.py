...
def query_teamcity(sha_short, token):
    url = f"https://hashicorp.teamcity.com/app/rest/builds?locator=project:(id:TerraformProviders_GoogleCloud_GOOGLE_BETA_NIGHTLYTESTS),branch:(name:refs/heads/nightly-test),number:{sha_short},count:1000&fields=build(id,status,state,finishDate,webUrl)"
    ...
    if not builds:
        return {
            ...
            "finish_date": "UNKNOWN",
            "web_url": "https://hashicorp.teamcity.com/project/TerraformProviders_GoogleCloud_GOOGLE_BETA_NIGHTLYTESTS?branch_TerraformProviders_GoogleCloud_GOOGLE_BETA_NIGHTLYTESTS=refs%2Fheads%2Fnightly-test"
        }
    ...
    return {
        ...
        "compute_web_url": compute_web_url if compute_web_url else "https://hashicorp.teamcity.com/project/TerraformProviders_GoogleCloud_GOOGLE_BETA_NIGHTLYTESTS?branch_TerraformProviders_GoogleCloud_GOOGLE_BETA_NIGHTLYTESTS=refs%2Fheads%2Fnightly-test"
    }
