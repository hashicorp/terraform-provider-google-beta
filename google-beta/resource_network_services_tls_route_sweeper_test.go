...
func init() {
	resource.AddTestSweepers("NetworkServicesTlsRoute", &resource.Sweeper{
		Name: "NetworkServicesTlsRoute",
		F:    testSweepNetworkServicesTlsRoute,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepNetworkServicesTlsRoute(region string) error {
