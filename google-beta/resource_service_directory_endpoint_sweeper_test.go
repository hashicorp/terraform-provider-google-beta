...
func init() {
	resource.AddTestSweepers("ServiceDirectoryEndpoint", &resource.Sweeper{
		Name: "ServiceDirectoryEndpoint",
		F:    testSweepServiceDirectoryEndpoint,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepServiceDirectoryEndpoint(region string) error {
	resourceName := "ServiceDirectoryEndpoint"
