...
func init() {
	resource.AddTestSweepers("NetworkSecurityAuthorizationPolicy", &resource.Sweeper{
		Name: "NetworkSecurityAuthorizationPolicy",
		F:    testSweepNetworkSecurityAuthorizationPolicy,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepNetworkSecurityAuthorizationPolicy(region string) error {
	resourceName := "NetworkSecurityAuthorizationPolicy"
