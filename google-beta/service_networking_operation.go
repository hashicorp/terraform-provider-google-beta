...
func serviceNetworkOperationWaitTimeWithRolesResponse(config *Config, op *servicenetworking.Operation, response *servicenetworking.AddRolesResponse, activity, userAgent string, timeout time.Duration) error {
