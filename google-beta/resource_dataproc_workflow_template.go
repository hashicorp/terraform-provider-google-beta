	...
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"gke_cluster_config": {
				...
				MaxItems:    1,
				Elem:        DataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigSchema(),
			},
			...
			"metastore_config": {
				...
				MaxItems:    1,
				Elem:        DataprocWorkflowTemplatePlacementManagedClusterConfigMetastoreConfigSchema(),
			},
	...
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"namespaced_gke_deployment_target": {
				...
				MaxItems:    1,
				Elem:        DataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSchema(),
			},
		},
	}
}
...
func expandDataprocWorkflowTemplatePlacementManagedClusterConfig(o interface{}) *dataproc.WorkflowTemplatePlacementManagedClusterConfig {
	...
	return &dataproc.WorkflowTemplatePlacementManagedClusterConfig{
		...
		GkeClusterConfig:      expandDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig(obj["gke_cluster_config"]),
		...
		MetastoreConfig:       expandDataprocWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig(obj["metastore_config"]),
...
func flattenDataprocWorkflowTemplatePlacementManagedClusterConfig(obj *dataproc.WorkflowTemplatePlacementManagedClusterConfig) interface{} {
	...
	transformed := map[string]interface{}{
		...
		"gke_cluster_config":      flattenDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig(obj.GkeClusterConfig),
		...
		"metastore_config":        flattenDataprocWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig(obj.MetastoreConfig),
...
func expandDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig(o interface{}) *dataproc.WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig {
	if o == nil {
		return dataproc.EmptyWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig
	}
	objArr := o.([]interface{})
	if len(objArr) == 0 || objArr[0] == nil {
		return dataproc.EmptyWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig
	...
	obj := objArr[0].(map[string]interface{})
	return &dataproc.WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig{
		NamespacedGkeDeploymentTarget: expandDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(obj["namespaced_gke_deployment_target"]),
	}
}

func flattenDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig(obj *dataproc.WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
		"namespaced_gke_deployment_target": flattenDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(obj.NamespacedGkeDeploymentTarget),
	}
...
func expandDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(o interface{}) *dataproc.WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	if o == nil {
		return dataproc.EmptyWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	}
	objArr := o.([]interface{})
	if len(objArr) == 0 || objArr[0] == nil {
		return dataproc.EmptyWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	...
	obj := objArr[0].(map[string]interface{})
	return &dataproc.WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{
		ClusterNamespace: dcl.String(obj["cluster_namespace"].(string)),
		TargetGkeCluster: dcl.String(obj["target_gke_cluster"].(string)),
	}
}

func flattenDataprocWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(obj *dataproc.WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
...
func expandDataprocWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig(o interface{}) *dataproc.WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig {
	if o == nil {
		return dataproc.EmptyWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig
	}
	objArr := o.([]interface{})
	if len(objArr) == 0 || objArr[0] == nil {
		return dataproc.EmptyWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig
	...
	obj := objArr[0].(map[string]interface{})
	return &dataproc.WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig{
		DataprocMetastoreService: dcl.String(obj["dataproc_metastore_service"].(string)),
	}
}

func flattenDataprocWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig(obj *dataproc.WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig) interface{} {
	if obj == nil || obj.Empty() {
		return nil
	}
	transformed := map[string]interface{}{
