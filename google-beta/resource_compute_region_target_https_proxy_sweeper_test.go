...
func testSweepComputeRegionTargetHttpsProxy(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/targetHttpsProxies", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/targetHttpsProxies/{{name}}"
