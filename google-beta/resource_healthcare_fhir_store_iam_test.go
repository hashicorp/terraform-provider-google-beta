		...
		Steps: []resource.TestStep{
			{
				...
				Check: testAccCheckGoogleHealthcareFhirStoreIamBindingExists("foo", roleId, []string{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testAccCheckGoogleHealthcareFhirStoreIamMemberExists("foo", roleId,
					fmt.Sprintf("serviceAccount:%s@%s.iam.gserviceaccount.com", account, projectId),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: testAccCheckGoogleHealthcareFhirStoreIamPolicyExists("foo", roleId,
					fmt.Sprintf("serviceAccount:%s@%s.iam.gserviceaccount.com", account, projectId),
				),
			},
			{
...
func testAccCheckGoogleHealthcareFhirStoreIamBindingExists(bindingResourceName, roleId string, members []string) resource.TestCheckFunc {
...
func testAccCheckGoogleHealthcareFhirStoreIamMemberExists(n, role, member string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
...
func testAccCheckGoogleHealthcareFhirStoreIamPolicyExists(n, role, policy string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
