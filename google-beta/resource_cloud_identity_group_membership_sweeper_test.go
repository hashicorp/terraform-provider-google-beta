...
func init() {
	resource.AddTestSweepers("CloudIdentityGroupMembership", &resource.Sweeper{
...
func testSweepCloudIdentityGroupMembership(region string) error {
	resourceName := "CloudIdentityGroupMembership"
	...
	listTemplate := strings.Split("https://cloudidentity.googleapis.com/v1beta1/{{group}}/memberships", "?")[0]
	...
	resourceList, ok := res["groupMemberships"]
	if !ok {
