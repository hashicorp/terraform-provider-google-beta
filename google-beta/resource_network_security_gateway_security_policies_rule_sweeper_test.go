...
func testSweepNetworkSecurityGatewaySecurityPoliciesRule(region string) error {
	...
	listTemplate := strings.Split("https://networksecurity.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/gatewaySecurityPolicies/{{gateway_security_policy}}/rules", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://networksecurity.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/gatewaySecurityPolicies/{{gateway_security_policy}}/rules/{{name}}"
