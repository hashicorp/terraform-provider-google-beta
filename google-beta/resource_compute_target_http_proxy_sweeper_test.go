...
func testSweepComputeTargetHttpProxy(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/beta/projects/{{project}}/global/targetHttpProxies", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/beta/projects/{{project}}/global/targetHttpProxies/{{name}}"
