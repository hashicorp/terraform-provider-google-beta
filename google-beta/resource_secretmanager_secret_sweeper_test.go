...
func init() {
	resource.AddTestSweepers("SecretmanagerSecret", &resource.Sweeper{
		Name: "SecretmanagerSecret",
		F:    testSweepSecretmanagerSecret,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepSecretmanagerSecret(region string) error {
	...
	listTemplate := strings.Split("https://secretmanager.googleapis.com/v1beta1/projects/{{project}}/secrets", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://secretmanager.googleapis.com/v1beta1/projects/{{project}}/secrets/{{secret_id}}"
