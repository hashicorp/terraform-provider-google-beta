...
func init() {
	resource.AddTestSweepers("ComputeRegionSecurityPolicy", &resource.Sweeper{
		Name: "ComputeRegionSecurityPolicy",
		F:    testSweepComputeRegionSecurityPolicy,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepComputeRegionSecurityPolicy(region string) error {
