	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"snapshot_encryption_key": {
				...
				Optional:         true,
				ForceNew:         true,
				DiffSuppressFunc: snapshotEncryptionKeyDiffSuppress,
				MaxItems:         1,
			...
			"source_disk_encryption_key": {
				...
				Optional:         true,
				ForceNew:         true,
				DiffSuppressFunc: sourceDiskEncryptionKeyDiffSuppress,
				MaxItems:         1,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"kms_key_name": {
...
func resourceComputeSnapshotCreate(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "https://www.googleapis.com/compute/beta/projects/{{project}}/zones/{{zone}}/disks/{{source_disk}}/createSnapshot")
	if err != nil {
		return err
	}
...
func resourceComputeSnapshotRead(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "https://www.googleapis.com/compute/beta/projects/{{project}}/global/snapshots/{{name}}")
	if err != nil {
		return err
	}
...
func resourceComputeSnapshotUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("labels") || d.HasChange("label_fingerprint") {
		...
		url, err := replaceVars(d, config, "https://www.googleapis.com/compute/beta/projects/{{project}}/global/snapshots/{{name}}/setLabels")
		if err != nil {
			return err
		}
		res, err := sendRequest(config, "POST", url, obj)
...
func flattenComputeSnapshotSnapshotEncryptionKey(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["kms_key_name"] =
		flattenComputeSnapshotSnapshotEncryptionKeyKmsKeyName(original["kmsKeyName"], d)
