...
func testSweepVertexAIEndpoint(region string) error {
	...
	listTemplate := strings.Split("https://{{region}}-aiplatform.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/endpoints", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://{{region}}-aiplatform.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/endpoints/{{name}}"
