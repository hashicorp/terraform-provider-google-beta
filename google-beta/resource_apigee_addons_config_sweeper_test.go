...
func init() {
	resource.AddTestSweepers("ApigeeAddonsConfig", &resource.Sweeper{
		Name: "ApigeeAddonsConfig",
		F:    testSweepApigeeAddonsConfig,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepApigeeAddonsConfig(region string) error {
	resourceName := "ApigeeAddonsConfig"
