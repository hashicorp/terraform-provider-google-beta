...
func testSweepComputeTargetInstance(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/beta/projects/{{project}}/aggregated/targetInstances", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/beta/projects/{{project}}/zones/{{zone}}/targetInstances/{{name}}"
