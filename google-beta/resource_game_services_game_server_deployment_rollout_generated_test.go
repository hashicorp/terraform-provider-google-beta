...
func TestAccGameServicesGameServerDeploymentRollout_gameServiceDeploymentRolloutBasicExample(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy: testAccCheckGameServicesGameServerDeploymentRolloutDestroy,
...
func testAccCheckGameServicesGameServerDeploymentRolloutDestroy(s *terraform.State) error {
