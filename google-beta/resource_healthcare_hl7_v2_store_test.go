...
func TestAccHealthcareHl7V2Store_basic(t *testing.T) {
	...
	hl7_v2StoreName := fmt.Sprintf("tf-test-hl7_v2-store-%s", acctest.RandString(10))
...
func testAccCheckGoogleHealthcareHl7V2StoreUpdate(pubsubTopic string) resource.TestCheckFunc {
