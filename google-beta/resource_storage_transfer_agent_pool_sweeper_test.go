...
func init() {
	resource.AddTestSweepers("StorageTransferAgentPool", &resource.Sweeper{
		Name: "StorageTransferAgentPool",
		F:    testSweepStorageTransferAgentPool,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepStorageTransferAgentPool(region string) error {
	resourceName := "StorageTransferAgentPool"
