...
var generatedIAMDatasources = map[string]*schema.Resource{
	...
	"google_cloud_run_v2_worker_pool_iam_policy":                   tpgiamresource.DataSourceIamPolicy(cloudrunv2.CloudRunV2WorkerPoolIamSchema, cloudrunv2.CloudRunV2WorkerPoolIamUpdaterProducer),
	...
	"google_compute_storage_pool_iam_policy":                       tpgiamresource.DataSourceIamPolicy(compute.ComputeStoragePoolIamSchema, compute.ComputeStoragePoolIamUpdaterProducer),
	...
	"google_vertex_ai_feature_group_iam_policy":                    tpgiamresource.DataSourceIamPolicy(vertexai.VertexAIFeatureGroupIamSchema, vertexai.VertexAIFeatureGroupIamUpdaterProducer),
	"google_vertex_ai_feature_online_store_iam_policy":             tpgiamresource.DataSourceIamPolicy(vertexai.VertexAIFeatureOnlineStoreIamSchema, vertexai.VertexAIFeatureOnlineStoreIamUpdaterProducer),
	"google_vertex_ai_feature_online_store_featureview_iam_policy": tpgiamresource.DataSourceIamPolicy(vertexai.VertexAIFeatureOnlineStoreFeatureviewIamSchema, vertexai.VertexAIFeatureOnlineStoreFeatureviewIamUpdaterProducer),
...
var generatedResources = map[string]*schema.Resource{
	...
	"google_apigee_security_feedback":                                            apigee.ResourceApigeeSecurityFeedback(),
	...
	"google_apphub_boundary":                                                     apphub.ResourceApphubBoundary(),
	...
	"google_backup_dr_restore_workload":                                          backupdr.ResourceBackupDRRestoreWorkload(),
	...
	"google_ces_tool":                                                            ces.ResourceCESTool(),
	...
	"google_cloud_run_v2_worker_pool":                                            cloudrunv2.ResourceCloudRunV2WorkerPool(),
	"google_cloud_run_v2_worker_pool_iam_binding":                                tpgiamresource.ResourceIamBinding(cloudrunv2.CloudRunV2WorkerPoolIamSchema, cloudrunv2.CloudRunV2WorkerPoolIamUpdaterProducer, cloudrunv2.CloudRunV2WorkerPoolIdParseFunc),
	...
	"google_compute_region_health_aggregation_policy":                            compute.ResourceComputeRegionHealthAggregationPolicy(),
	"google_compute_region_health_check":                                         compute.ResourceComputeRegionHealthCheck(),
	"google_compute_region_health_source":                                        compute.ResourceComputeRegionHealthSource(),
	...
	"google_compute_resource_policy_attachment":                                  compute.ResourceComputeResourcePolicyAttachment(),
	...
	"google_compute_snapshot_settings":                                           compute.ResourceComputeSnapshotSettings(),
	...
	"google_compute_storage_pool_iam_binding":                                    tpgiamresource.ResourceIamBinding(compute.ComputeStoragePoolIamSchema, compute.ComputeStoragePoolIamUpdaterProducer, compute.ComputeStoragePoolIdParseFunc),
	"google_compute_storage_pool_iam_member":                                     tpgiamresource.ResourceIamMember(compute.ComputeStoragePoolIamSchema, compute.ComputeStoragePoolIamUpdaterProducer, compute.ComputeStoragePoolIdParseFunc),
	"google_compute_storage_pool_iam_policy":                                     tpgiamresource.ResourceIamPolicy(compute.ComputeStoragePoolIamSchema, compute.ComputeStoragePoolIamUpdaterProducer, compute.ComputeStoragePoolIdParseFunc),
	...
	"google_dataplex_data_asset":                                                 dataplex.ResourceDataplexDataAsset(),
	...
	"google_dataproc_session_template":                                           dataproc.ResourceDataprocSessionTemplate(),
	...
	"google_dialogflow_cx_playbook":                                              dialogflowcx.ResourceDialogflowCXPlaybook(),
	...
	"google_discovery_engine_control":                                            discoveryengine.ResourceDiscoveryEngineControl(),
	...
	"google_discovery_engine_serving_config":                                     discoveryengine.ResourceDiscoveryEngineServingConfig(),
	...
	"google_gemini_data_sharing_with_google_setting_binding":                     gemini.ResourceGeminiDataSharingWithGoogleSettingBinding(),
	"google_gemini_gemini_gcp_enablement_setting":                                gemini.ResourceGeminiGeminiGcpEnablementSetting(),
	"google_gemini_gemini_gcp_enablement_setting_binding":                        gemini.ResourceGeminiGeminiGcpEnablementSettingBinding(),
	...
	"google_iam_workforce_pool_provider_scim_token":                              iamworkforcepool.ResourceIAMWorkforcePoolWorkforcePoolProviderScimToken(),
	...
	"google_netapp_host_group":                                                   netapp.ResourceNetappHostGroup(),
	...
	"google_network_connectivity_multicloud_data_transfer_config":                networkconnectivity.ResourceNetworkConnectivityMulticloudDataTransferConfig(),
	...
	"google_network_security_dns_threat_detector":                                networksecurity.ResourceNetworkSecurityDnsThreatDetector(),
	...
	"google_network_security_sac_attachment":                                     networksecurity.ResourceNetworkSecuritySacAttachment(),
	...
	"google_network_services_multicast_group_consumer_activation":                networkservices.ResourceNetworkServicesMulticastGroupConsumerActivation(),
	...
	"google_oracle_database_exascale_db_storage_vault":                           oracledatabase.ResourceOracleDatabaseExascaleDbStorageVault(),
	...
	"google_parameter_manager_parameter_version":                                 parametermanager.ResourceParameterManagerParameterVersion(),
	...
	"google_saas_runtime_release":                                                saasruntime.ResourceSaasRuntimeRelease(),
	"google_saas_runtime_rollout_kind":                                           saasruntime.ResourceSaasRuntimeRolloutKind(),
	...
	"google_storage_insights_dataset_config":                                     storageinsights.ResourceStorageInsightsDatasetConfig(),
	...
	"google_vertex_ai_feature_group_iam_policy":                                  tpgiamresource.ResourceIamPolicy(vertexai.VertexAIFeatureGroupIamSchema, vertexai.VertexAIFeatureGroupIamUpdaterProducer, vertexai.VertexAIFeatureGroupIdParseFunc),
	...
	"google_vertex_ai_feature_online_store_iam_binding":                          tpgiamresource.ResourceIamBinding(vertexai.VertexAIFeatureOnlineStoreIamSchema, vertexai.VertexAIFeatureOnlineStoreIamUpdaterProducer, vertexai.VertexAIFeatureOnlineStoreIdParseFunc),
	"google_vertex_ai_feature_online_store_iam_member":                           tpgiamresource.ResourceIamMember(vertexai.VertexAIFeatureOnlineStoreIamSchema, vertexai.VertexAIFeatureOnlineStoreIamUpdaterProducer, vertexai.VertexAIFeatureOnlineStoreIdParseFunc),
	"google_vertex_ai_feature_online_store_iam_policy":                           tpgiamresource.ResourceIamPolicy(vertexai.VertexAIFeatureOnlineStoreIamSchema, vertexai.VertexAIFeatureOnlineStoreIamUpdaterProducer, vertexai.VertexAIFeatureOnlineStoreIdParseFunc),
	"google_vertex_ai_feature_online_store_featureview":                          vertexai.ResourceVertexAIFeatureOnlineStoreFeatureview(),
	"google_vertex_ai_feature_online_store_featureview_iam_binding":              tpgiamresource.ResourceIamBinding(vertexai.VertexAIFeatureOnlineStoreFeatureviewIamSchema, vertexai.VertexAIFeatureOnlineStoreFeatureviewIamUpdaterProducer, vertexai.VertexAIFeatureOnlineStoreFeatureviewIdParseFunc),
	"google_vertex_ai_feature_online_store_featureview_iam_member":               tpgiamresource.ResourceIamMember(vertexai.VertexAIFeatureOnlineStoreFeatureviewIamSchema, vertexai.VertexAIFeatureOnlineStoreFeatureviewIamUpdaterProducer, vertexai.VertexAIFeatureOnlineStoreFeatureviewIdParseFunc),
	"google_vertex_ai_feature_online_store_featureview_iam_policy":               tpgiamresource.ResourceIamPolicy(vertexai.VertexAIFeatureOnlineStoreFeatureviewIamSchema, vertexai.VertexAIFeatureOnlineStoreFeatureviewIamUpdaterProducer, vertexai.VertexAIFeatureOnlineStoreFeatureviewIdParseFunc),
