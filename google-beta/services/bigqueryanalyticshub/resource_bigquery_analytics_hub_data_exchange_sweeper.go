...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBigqueryAnalyticsHubDataExchange,
		DeleteFunction: testSweepBigqueryAnalyticsHubDataExchange,
	}
...
func testSweepBigqueryAnalyticsHubDataExchange(_ string) error {
	return listAndActionBigqueryAnalyticsHubDataExchange(deleteResourceBigqueryAnalyticsHubDataExchange)
}

func listAndActionBigqueryAnalyticsHubDataExchange(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'dataExchanges'")
		} else {
...
func deleteResourceBigqueryAnalyticsHubDataExchange(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
