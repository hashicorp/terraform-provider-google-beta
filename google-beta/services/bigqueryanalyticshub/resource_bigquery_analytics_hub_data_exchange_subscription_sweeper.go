...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBigqueryAnalyticsHubDataExchangeSubscription,
		DeleteFunction: testSweepBigqueryAnalyticsHubDataExchangeSubscription,
	}
...
func testSweepBigqueryAnalyticsHubDataExchangeSubscription(_ string) error {
	return listAndActionBigqueryAnalyticsHubDataExchangeSubscription(deleteResourceBigqueryAnalyticsHubDataExchangeSubscription)
}

func listAndActionBigqueryAnalyticsHubDataExchangeSubscription(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "BigqueryAnalyticsHubDataExchangeSubscription"
...
func deleteResourceBigqueryAnalyticsHubDataExchangeSubscription(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
