...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBigqueryAnalyticsHubListingSubscription,
		DeleteFunction: testSweepBigqueryAnalyticsHubListingSubscription,
	}
...
func testSweepBigqueryAnalyticsHubListingSubscription(_ string) error {
	return listAndActionBigqueryAnalyticsHubListingSubscription(deleteResourceBigqueryAnalyticsHubListingSubscription)
}

func listAndActionBigqueryAnalyticsHubListingSubscription(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceBigqueryAnalyticsHubListingSubscription(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
