...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBackupDRBackupPlan,
		DeleteFunction: testSweepBackupDRBackupPlan,
	}
...
func testSweepBackupDRBackupPlan(_ string) error {
	return listAndActionBackupDRBackupPlan(deleteResourceBackupDRBackupPlan)
}

func listAndActionBackupDRBackupPlan(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "BackupDRBackupPlan"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://backupdr.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/backupPlans", "?")[0]
...
func deleteResourceBackupDRBackupPlan(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://backupdr.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/backupPlans/{{backup_plan_id}}"
