...
func init() {
	sweeper.AddTestSweepers("BackupDRBackupPlanAssociation", testSweepBackupDRBackupPlanAssociation)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepBackupDRBackupPlanAssociation(region string) error {
