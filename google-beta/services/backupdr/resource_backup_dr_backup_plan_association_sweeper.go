...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBackupDRBackupPlanAssociation,
		DeleteFunction: testSweepBackupDRBackupPlanAssociation,
	}
...
func testSweepBackupDRBackupPlanAssociation(_ string) error {
	return listAndActionBackupDRBackupPlanAssociation(deleteResourceBackupDRBackupPlanAssociation)
}

func listAndActionBackupDRBackupPlanAssociation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "BackupDRBackupPlanAssociation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://backupdr.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/backupPlanAssociations", "?")[0]
...
func deleteResourceBackupDRBackupPlanAssociation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://backupdr.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/backupPlanAssociations/{{backup_plan_association_id}}"
