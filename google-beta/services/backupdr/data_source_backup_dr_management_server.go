...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/backupdr/data_source_backup_dr_management_server.go
//
...
func dataSourceGoogleCloudBackupDRServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := tpgresource.ReplaceVars(d, config, transport_tpg.BaseUrl(Product, config)+`projects/{{project}}/locations/{{location}}/managementServers`)
	if err != nil {
		return err
	}
