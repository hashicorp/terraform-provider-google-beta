...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/backupdr/resource_backup_dr_backup_plan_association_test.go
//
...
func TestAccBackupDRBackupPlanAssociation_fullUpdate(t *testing.T) {
	// Uses time.Now
	acctest.SkipIfVcr(t)
