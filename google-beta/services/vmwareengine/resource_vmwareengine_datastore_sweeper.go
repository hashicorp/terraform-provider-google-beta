...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_vmwareengine_datastore",
		ListAndAction:  listAndActionVmwareengineDatastore,
		DeleteFunction: testSweepVmwareengineDatastore,
	}
...
func testSweepVmwareengineDatastore(_ string) error {
	return listAndActionVmwareengineDatastore(deleteResourceVmwareengineDatastore)
}

func listAndActionVmwareengineDatastore(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "VmwareengineDatastore"
	...
	intermediateValues[1]["region"] = "southamerica-west1-a"
	intermediateValues[2] = map[string]string{}
	intermediateValues[2]["region"] = "me-west1-a"
	intermediateValues[3] = map[string]string{}
	intermediateValues[3]["region"] = "me-west1-b"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://vmwareengine.googleapis.com/v1/projects/{{project}}/locations/{{location}}/datastores", "?")[0]
		...
		resourceList, ok := res["datastores"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'datastores'")
		} else {
...
func deleteResourceVmwareengineDatastore(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://vmwareengine.googleapis.com/v1/projects/{{project}}/locations/{{location}}/datastores/{{name}}"
