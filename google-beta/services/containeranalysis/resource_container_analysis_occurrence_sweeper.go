...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContainerAnalysisOccurrence,
		DeleteFunction: testSweepContainerAnalysisOccurrence,
	}
...
func testSweepContainerAnalysisOccurrence(_ string) error {
	return listAndActionContainerAnalysisOccurrence(deleteResourceContainerAnalysisOccurrence)
}

func listAndActionContainerAnalysisOccurrence(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'occurrences'")
		} else {
...
func deleteResourceContainerAnalysisOccurrence(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
