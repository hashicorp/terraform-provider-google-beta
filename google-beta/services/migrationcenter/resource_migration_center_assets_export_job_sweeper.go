...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMigrationCenterAssetsExportJob,
		DeleteFunction: testSweepMigrationCenterAssetsExportJob,
	}
...
func testSweepMigrationCenterAssetsExportJob(_ string) error {
	return listAndActionMigrationCenterAssetsExportJob(deleteResourceMigrationCenterAssetsExportJob)
}

func listAndActionMigrationCenterAssetsExportJob(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "MigrationCenterAssetsExportJob"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://migrationcenter.googleapis.com/v1/projects/{{project}}/locations/{{location}}/assetsExportJobs", "?")[0]
		...
		resourceList, ok := res["assetsExportJobs"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'assetsExportJobs'")
		} else {
...
func deleteResourceMigrationCenterAssetsExportJob(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://migrationcenter.googleapis.com/v1/projects/{{project}}/locations/{{location}}/assetsExportJobs/{{assets_export_job_id}}"
