...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMigrationCenterReportConfig,
		DeleteFunction: testSweepMigrationCenterReportConfig,
	}
...
func testSweepMigrationCenterReportConfig(_ string) error {
	return listAndActionMigrationCenterReportConfig(deleteResourceMigrationCenterReportConfig)
}

func listAndActionMigrationCenterReportConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "MigrationCenterReportConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://migrationcenter.googleapis.com/v1/projects/{{project}}/locations/{{location}}/reportConfigs", "?")[0]
...
func deleteResourceMigrationCenterReportConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://migrationcenter.googleapis.com/v1/projects/{{project}}/locations/{{location}}/reportConfigs/{{report_config_id}}"
