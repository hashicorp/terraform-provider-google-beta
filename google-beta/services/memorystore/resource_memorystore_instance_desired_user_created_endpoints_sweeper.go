...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_memorystore_instance_desired_user_created_endpoints",
		ListAndAction:  listAndActionMemorystoreInstanceDesiredUserCreatedEndpoints,
		DeleteFunction: testSweepMemorystoreInstanceDesiredUserCreatedEndpoints,
	}
...
func testSweepMemorystoreInstanceDesiredUserCreatedEndpoints(_ string) error {
	return listAndActionMemorystoreInstanceDesiredUserCreatedEndpoints(deleteResourceMemorystoreInstanceDesiredUserCreatedEndpoints)
}

func listAndActionMemorystoreInstanceDesiredUserCreatedEndpoints(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "MemorystoreInstanceDesiredUserCreatedEndpoints"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://memorystore.googleapis.com/v1beta/projects/{{project}}/locations/{{region}}/instances", "?")[0]
...
func deleteResourceMemorystoreInstanceDesiredUserCreatedEndpoints(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://memorystore.googleapis.com/v1beta/projects/{{project}}/locations/{{region}}/instances/{{name}}"
