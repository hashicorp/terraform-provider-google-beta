...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMemorystoreInstance,
		DeleteFunction: testSweepMemorystoreInstance,
	}
...
func testSweepMemorystoreInstance(_ string) error {
	return listAndActionMemorystoreInstance(deleteResourceMemorystoreInstance)
}

func listAndActionMemorystoreInstance(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "MemorystoreInstance"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://memorystore.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/instances", "?")[0]
...
func deleteResourceMemorystoreInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://memorystore.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/instances/{{instance_id}}"
