...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionFilestoreBackup,
		DeleteFunction: testSweepFilestoreBackup,
	}
...
func testSweepFilestoreBackup(_ string) error {
	return listAndActionFilestoreBackup(deleteResourceFilestoreBackup)
}

func listAndActionFilestoreBackup(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "FilestoreBackup"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://file.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/backups", "?")[0]
...
func deleteResourceFilestoreBackup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://file.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/backups/{{name}}"
