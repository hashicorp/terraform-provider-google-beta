...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionFilestoreInstance,
		DeleteFunction: testSweepFilestoreInstance,
	}
...
func testSweepFilestoreInstance(_ string) error {
	return listAndActionFilestoreInstance(deleteResourceFilestoreInstance)
}

func listAndActionFilestoreInstance(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[1]["zone"] = "us-central1-b"
	intermediateValues[2] = map[string]string{}
	intermediateValues[2]["location"] = "us-central1"
	intermediateValues[3] = map[string]string{}
	intermediateValues[3]["location"] = "us-east1"
	intermediateValues[4] = map[string]string{}
	intermediateValues[4]["location"] = "us-west1"
	intermediateValues[5] = map[string]string{}
	intermediateValues[5]["location"] = "me-west1-b"
...
func deleteResourceFilestoreInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
