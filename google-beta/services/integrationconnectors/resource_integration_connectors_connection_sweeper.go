...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIntegrationConnectorsConnection,
		DeleteFunction: testSweepIntegrationConnectorsConnection,
	}
...
func testSweepIntegrationConnectorsConnection(_ string) error {
	return listAndActionIntegrationConnectorsConnection(deleteResourceIntegrationConnectorsConnection)
}

func listAndActionIntegrationConnectorsConnection(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "IntegrationConnectorsConnection"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://connectors.googleapis.com/v1/projects/{{project}}/locations/{{location}}/connections", "?")[0]
...
func deleteResourceIntegrationConnectorsConnection(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://connectors.googleapis.com/v1/projects/{{project}}/locations/{{location}}/connections/{{name}}"
