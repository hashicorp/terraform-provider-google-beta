...
func TestAccContainerAzureCluster_BetaBasicHandWritten(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerAzureCluster_BetaBasicHandWritten(context),
			},
			{
				ResourceName:            "google_container_azure_cluster.primary",
				ImportState:             true,
...
func TestAccContainerAzureCluster_BetaBasicEnumHandWritten(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccContainerAzureCluster_BetaBasicEnumHandWritten(context),
			},
			{
				ResourceName:            "google_container_azure_cluster.primary",
				ImportState:             true,
...
func testAccContainerAzureCluster_BetaBasicEnumHandWritten(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_container_azure_versions" "versions" {
  project = "%{project_name}"
  location = "us-west1"
...
func testAccContainerAzureCluster_BetaBasicEnumHandWrittenUpdate0(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_container_azure_versions" "versions" {
  project = "%{project_name}"
  location = "us-west1"
