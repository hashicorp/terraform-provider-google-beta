...
func TestAccVertexAIIndexListQuery_generated(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccVertexAIIndex_vertexAiIndexExampleListQuery(context),
...
func testAccVertexAIIndex_vertexAiIndexExampleListQuery(context map[string]interface{}) string {
