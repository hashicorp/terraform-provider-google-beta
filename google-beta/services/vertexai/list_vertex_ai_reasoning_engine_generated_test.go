...
func TestAccVertexAIReasoningEngineListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_vertex_ai_reasoning_engine.reasoning_engine",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccVertexAIReasoningEngine_vertexAiReasoningEngineDeletionPolicyExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_vertex_ai_reasoning_engine.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_vertex_ai_reasoning_engine.list_query",
...
func testAccVertexAIReasoningEngine_vertexAiReasoningEngineDeletionPolicyExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_vertex_ai_reasoning_engine" "list_query" {
    provider = google
	limit = 10000
    config {
    }
