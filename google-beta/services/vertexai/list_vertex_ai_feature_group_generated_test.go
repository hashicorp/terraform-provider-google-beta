...
func TestAccVertexAIFeatureGroupListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_vertex_ai_feature_group.feature_group",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccVertexAIFeatureGroup_vertexAiFeatureGroupExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_vertex_ai_feature_group.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_vertex_ai_feature_group.list_query",
...
func testAccVertexAIFeatureGroup_vertexAiFeatureGroupExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_vertex_ai_feature_group" "list_query" {
    provider = google
	limit = 10000
    config {
    }
