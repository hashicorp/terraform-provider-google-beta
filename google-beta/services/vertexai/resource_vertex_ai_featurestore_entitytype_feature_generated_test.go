...
func TestAccVertexAIFeaturestoreEntitytypeFeature_vertexAiFeaturestoreEntitytypeFeatureExample(t *testing.T) {
	...
	context := map[string]interface{}{
		...
		"name":          "tf_test_terraform_feature" + randomSuffix,
...
func TestAccVertexAIFeaturestoreEntitytypeFeature_vertexAiFeaturestoreEntitytypeFeatureWithBetaFieldsExample(t *testing.T) {
	...
	context := map[string]interface{}{
		"kms_key_name":  "tf-test-kms-name" + randomSuffix,
		"name":          "tf_test_terraform_feature_2" + randomSuffix,
		"project":       "tf-test-vertex-ai" + randomSuffix,
		"random_suffix": randomSuffix,
	}
...
func testAccCheckVertexAIFeaturestoreEntitytypeFeatureDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, transport_tpg.BaseUrl(vertexai.Product, config)+"{{entitytype}}/features/{{name}}")
			if err != nil {
				return err
			}
