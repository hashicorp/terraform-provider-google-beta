...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionVertexAIEndpoint,
		DeleteFunction: testSweepVertexAIEndpoint,
	}
...
func testSweepVertexAIEndpoint(_ string) error {
	return listAndActionVertexAIEndpoint(deleteResourceVertexAIEndpoint)
}

func listAndActionVertexAIEndpoint(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceVertexAIEndpoint(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
