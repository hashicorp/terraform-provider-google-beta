...
func testSweepDataprocCluster(region string) error {
	...
	listTemplate := strings.Split("https://dataproc.googleapis.com/v1/projects/{{project}}/regions/{{region}}/clusters", "?")[0]
