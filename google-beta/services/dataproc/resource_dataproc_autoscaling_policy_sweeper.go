...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDataprocAutoscalingPolicy,
		DeleteFunction: testSweepDataprocAutoscalingPolicy,
	}
...
func testSweepDataprocAutoscalingPolicy(_ string) error {
	return listAndActionDataprocAutoscalingPolicy(deleteResourceDataprocAutoscalingPolicy)
}

func listAndActionDataprocAutoscalingPolicy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceDataprocAutoscalingPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
