...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMemcacheInstance,
		DeleteFunction: testSweepMemcacheInstance,
	}
...
func testSweepMemcacheInstance(_ string) error {
	return listAndActionMemcacheInstance(deleteResourceMemcacheInstance)
}

func listAndActionMemcacheInstance(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceMemcacheInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
