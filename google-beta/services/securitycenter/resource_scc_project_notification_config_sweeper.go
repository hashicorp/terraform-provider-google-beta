...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSecurityCenterProjectNotificationConfig,
		DeleteFunction: testSweepSecurityCenterProjectNotificationConfig,
	}
...
func testSweepSecurityCenterProjectNotificationConfig(_ string) error {
	return listAndActionSecurityCenterProjectNotificationConfig(deleteResourceSecurityCenterProjectNotificationConfig)
}

func listAndActionSecurityCenterProjectNotificationConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "SecurityCenterProjectNotificationConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://securitycenter.googleapis.com/v1/projects/{{project}}/notificationConfigs", "?")[0]
...
func deleteResourceSecurityCenterProjectNotificationConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://securitycenter.googleapis.com/v1/{{name}}"
