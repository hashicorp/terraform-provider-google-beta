...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSecurityCenterProjectSccBigQueryExport,
		DeleteFunction: testSweepSecurityCenterProjectSccBigQueryExport,
	}
...
func testSweepSecurityCenterProjectSccBigQueryExport(_ string) error {
	return listAndActionSecurityCenterProjectSccBigQueryExport(deleteResourceSecurityCenterProjectSccBigQueryExport)
}

func listAndActionSecurityCenterProjectSccBigQueryExport(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "SecurityCenterProjectSccBigQueryExport"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://securitycenter.googleapis.com/v1/projects/{{project}}/bigQueryExports", "?")[0]
...
func deleteResourceSecurityCenterProjectSccBigQueryExport(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://securitycenter.googleapis.com/v1/projects/{{project}}/bigQueryExports/{{big_query_export_id}}"
