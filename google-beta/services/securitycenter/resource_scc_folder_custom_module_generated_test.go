...
func TestAccSecurityCenterFolderCustomModule_sccFolderCustomModuleBasicExample(t *testing.T) {
	t.Parallel()
...
func TestAccSecurityCenterFolderCustomModule_sccFolderCustomModuleFullExample(t *testing.T) {
	t.Parallel()
