...
func TestAccDiscoveryEngineDataStoreListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_data_store.basic",
						[]string{
							"name",
							"data_store_id",
						},
					...
					listScope.Capture(map[string]string{
						"location": "google_discovery_engine_data_store.basic",
					}),
				),
			},
			{
				Query:           true,
				Config:          testAccDiscoveryEngineDataStore_discoveryengineDatastoreBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_data_store.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_data_store.list_query",
...
func testAccDiscoveryEngineDataStore_discoveryengineDatastoreBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
variable "location" { type = string }
list "google_discovery_engine_data_store" "list_query" {
    provider = google
	limit = 10000
    config {
