...
func TestAccDiscoveryEngineTargetSiteListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_target_site.basic",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccDiscoveryEngineTargetSite_discoveryengineTargetsiteBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_target_site.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_target_site.list_query",
...
func testAccDiscoveryEngineTargetSite_discoveryengineTargetsiteBasicExampleListQuery(context map[string]interface{}) string {
