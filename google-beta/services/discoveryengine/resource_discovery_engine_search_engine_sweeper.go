...
func init() {
	sweeper.AddTestSweepers("DiscoveryEngineSearchEngine", testSweepDiscoveryEngineSearchEngine)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepDiscoveryEngineSearchEngine(region string) error {
	resourceName := "DiscoveryEngineSearchEngine"
	...
	resourceList, ok := res["searchEngines"]
	if !ok {
