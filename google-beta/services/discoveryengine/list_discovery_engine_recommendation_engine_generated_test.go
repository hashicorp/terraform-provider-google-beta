		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_discovery_engine_recommendation_engine.generic",
						[]string{
							"name",
							"engine_id",
						},
			...
			{
				Query:           true,
				Config:          testAccDiscoveryEngineRecommendationEngine_discoveryengineRecommendationengineGenericExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_discovery_engine_recommendation_engine.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_discovery_engine_recommendation_engine.list_query",
