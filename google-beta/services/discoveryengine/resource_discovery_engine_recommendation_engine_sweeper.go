...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDiscoveryEngineRecommendationEngine,
		DeleteFunction: testSweepDiscoveryEngineRecommendationEngine,
	}
...
func testSweepDiscoveryEngineRecommendationEngine(_ string) error {
	return listAndActionDiscoveryEngineRecommendationEngine(deleteResourceDiscoveryEngineRecommendationEngine)
}

func listAndActionDiscoveryEngineRecommendationEngine(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DiscoveryEngineRecommendationEngine"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://{{location}}-discoveryengine.googleapis.com/v1/projects/{{project}}/locations/{{location}}/collections/default_collection/engines", "?")[0]
...
func deleteResourceDiscoveryEngineRecommendationEngine(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://{{location}}-discoveryengine.googleapis.com/v1/projects/{{project}}/locations/{{location}}/collections/default_collection/engines/{{engine_id}}"
