...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDataprocMetastoreService,
		DeleteFunction: testSweepDataprocMetastoreService,
	}
...
func testSweepDataprocMetastoreService(_ string) error {
	return listAndActionDataprocMetastoreService(deleteResourceDataprocMetastoreService)
}

func listAndActionDataprocMetastoreService(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DataprocMetastoreService"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://metastore.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/services", "?")[0]
...
func deleteResourceDataprocMetastoreService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://metastore.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/services/{{service_id}}"
