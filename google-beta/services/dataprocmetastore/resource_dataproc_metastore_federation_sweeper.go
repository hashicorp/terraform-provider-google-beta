...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDataprocMetastoreFederation,
		DeleteFunction: testSweepDataprocMetastoreFederation,
	}
...
func testSweepDataprocMetastoreFederation(_ string) error {
	return listAndActionDataprocMetastoreFederation(deleteResourceDataprocMetastoreFederation)
}

func listAndActionDataprocMetastoreFederation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DataprocMetastoreFederation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://metastore.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/federations", "?")[0]
		...
		resourceList, ok := res["federations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'federations'")
		} else {
...
func deleteResourceDataprocMetastoreFederation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://metastore.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/federations/{{federation_id}}"
