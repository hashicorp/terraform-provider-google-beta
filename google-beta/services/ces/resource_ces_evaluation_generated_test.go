...
func TestAccCESEvaluation_cesEvaluationBasicExample(t *testing.T) {
	...
	context := map[string]interface{}{
		...
		"evaluation_id":    "tf-test-eval-basic" + randomSuffix,
...
func TestAccCESEvaluation_cesEvaluationToolsetExample(t *testing.T) {
	t.Parallel()

	randomSuffix := acctest.RandString(t, 10)

	context := map[string]interface{}{
		"app_display_name": "tf-test-my-app-toolset" + randomSuffix,
		"app_id":           "tf-test-app-id-toolset" + randomSuffix,
...
func testAccCESEvaluation_cesEvaluationToolsetExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_ces_app" "app" {
  provider = google-beta
  app_id = "%{app_id}"
...
func testAccCheckCESEvaluationDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, fmt.Sprintf("%s%s", transport_tpg.BaseUrl(ces.Product, config), "projects/{{project}}/locations/{{location}}/apps/{{app}}/evaluations/{{evaluation_id}}"))
			if err != nil {
				return err
			}
