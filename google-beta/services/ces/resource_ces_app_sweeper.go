...
func listAndActionCESApp(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://ces.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/apps", "?")[0]
...
func deleteResourceCESApp(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://ces.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/apps/{{name}}"
