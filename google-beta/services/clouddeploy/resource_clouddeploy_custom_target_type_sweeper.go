...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionClouddeployCustomTargetType,
		DeleteFunction: testSweepClouddeployCustomTargetType,
	}
...
func testSweepClouddeployCustomTargetType(_ string) error {
	return listAndActionClouddeployCustomTargetType(deleteResourceClouddeployCustomTargetType)
}

func listAndActionClouddeployCustomTargetType(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ClouddeployCustomTargetType"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://clouddeploy.googleapis.com/v1/projects/{{project}}/locations/{{location}}/customTargetTypes", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'customTargetTypes'")
		} else {
...
func deleteResourceClouddeployCustomTargetType(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://clouddeploy.googleapis.com/v1/projects/{{project}}/locations/{{location}}/customTargetTypes/{{name}}"
