...
func TestAccFirebaseAndroidAppListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_firebase_android_app.basic",
						[]string{
							"name",
							"app_id",
						},
			...
			{
				Query:           true,
				Config:          testAccFirebaseAndroidApp_firebaseAndroidAppBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_firebase_android_app.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_firebase_android_app.list_query",
...
func testAccFirebaseAndroidApp_firebaseAndroidAppBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_firebase_android_app" "list_query" {
