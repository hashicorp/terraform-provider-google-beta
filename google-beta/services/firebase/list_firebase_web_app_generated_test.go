...
func TestAccFirebaseWebAppListQuery_generated(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccFirebaseWebApp_firebaseWebAppBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_firebase_web_app.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_firebase_web_app.list_query",
...
func testAccFirebaseWebApp_firebaseWebAppBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_firebase_web_app" "list_query" {
