...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/firebase/data_source_google_firebase_apple_app.go.tmpl
//
...
func init() {
	registry.Schema{
		Name:        "google_firebase_apple_app",
		ProductName: "firebase",
		Type:        registry.SchemaTypeDataSource,
		Schema:      DataSourceGoogleFirebaseAppleApp(),
	}.Register()
}
