...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkSecurityAuthorizationPolicy,
		DeleteFunction: testSweepNetworkSecurityAuthorizationPolicy,
	}
...
func testSweepNetworkSecurityAuthorizationPolicy(_ string) error {
	return listAndActionNetworkSecurityAuthorizationPolicy(deleteResourceNetworkSecurityAuthorizationPolicy)
}

func listAndActionNetworkSecurityAuthorizationPolicy(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'authorizationPolicies'")
		} else {
...
func deleteResourceNetworkSecurityAuthorizationPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
