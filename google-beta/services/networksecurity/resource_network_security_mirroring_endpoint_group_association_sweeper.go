...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_network_security_mirroring_endpoint_group_association",
		ListAndAction:  listAndActionNetworkSecurityMirroringEndpointGroupAssociation,
		DeleteFunction: testSweepNetworkSecurityMirroringEndpointGroupAssociation,
	}
...
func testSweepNetworkSecurityMirroringEndpointGroupAssociation(_ string) error {
	return listAndActionNetworkSecurityMirroringEndpointGroupAssociation(deleteResourceNetworkSecurityMirroringEndpointGroupAssociation)
}

func listAndActionNetworkSecurityMirroringEndpointGroupAssociation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkSecurityMirroringEndpointGroupAssociation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networksecurity.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/mirroringEndpointGroupAssociations", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'mirroringEndpointGroupAssociations'")
		} else {
...
func deleteResourceNetworkSecurityMirroringEndpointGroupAssociation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networksecurity.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/mirroringEndpointGroupAssociations/{{mirroring_endpoint_group_association_id}}"
