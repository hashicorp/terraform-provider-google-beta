...
func TestAccNetworkSecurityMirroringEndpointListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_network_security_mirroring_endpoint.default",
						[]string{
							"name",
					...
					listScope.Capture(map[string]string{
						"location": "google_network_security_mirroring_endpoint.default",
					}),
				),
			},
			{
				Query:           true,
				Config:          testAccNetworkSecurityMirroringEndpoint_networkSecurityMirroringEndpointBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_network_security_mirroring_endpoint.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_network_security_mirroring_endpoint.list_query",
...
func testAccNetworkSecurityMirroringEndpoint_networkSecurityMirroringEndpointBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
variable "location" { type = string }
list "google_network_security_mirroring_endpoint" "list_query" {
    provider = google
	limit = 10000
    config {
