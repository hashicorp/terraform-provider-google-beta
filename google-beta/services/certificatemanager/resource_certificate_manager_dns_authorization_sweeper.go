...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCertificateManagerDnsAuthorization,
		DeleteFunction: testSweepCertificateManagerDnsAuthorization,
	}
...
func testSweepCertificateManagerDnsAuthorization(_ string) error {
	return listAndActionCertificateManagerDnsAuthorization(deleteResourceCertificateManagerDnsAuthorization)
}

func listAndActionCertificateManagerDnsAuthorization(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CertificateManagerDnsAuthorization"
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'dnsAuthorizations'")
		} else {
...
func deleteResourceCertificateManagerDnsAuthorization(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
