...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCertificateManagerTrustConfig,
		DeleteFunction: testSweepCertificateManagerTrustConfig,
	}
...
func testSweepCertificateManagerTrustConfig(_ string) error {
	return listAndActionCertificateManagerTrustConfig(deleteResourceCertificateManagerTrustConfig)
}

func listAndActionCertificateManagerTrustConfig(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'trustConfigs'")
		} else {
...
func deleteResourceCertificateManagerTrustConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
