...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCertificateManagerCertificateMap,
		DeleteFunction: testSweepCertificateManagerCertificateMap,
	}
...
func testSweepCertificateManagerCertificateMap(_ string) error {
	return listAndActionCertificateManagerCertificateMap(deleteResourceCertificateManagerCertificateMap)
}

func listAndActionCertificateManagerCertificateMap(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'certificateMaps'")
		} else {
...
func deleteResourceCertificateManagerCertificateMap(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
