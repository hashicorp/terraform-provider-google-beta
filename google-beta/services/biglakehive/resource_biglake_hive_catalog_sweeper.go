...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBiglakeHiveHiveCatalog,
		DeleteFunction: testSweepBiglakeHiveHiveCatalog,
	}
...
func testSweepBiglakeHiveHiveCatalog(_ string) error {
	return listAndActionBiglakeHiveHiveCatalog(deleteResourceBiglakeHiveHiveCatalog)
}

func listAndActionBiglakeHiveHiveCatalog(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "BiglakeHiveHiveCatalog"
...
func deleteResourceBiglakeHiveHiveCatalog(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
