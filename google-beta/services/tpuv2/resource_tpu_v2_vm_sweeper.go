...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionTpuV2Vm,
		DeleteFunction: testSweepTpuV2Vm,
	}
...
func testSweepTpuV2Vm(_ string) error {
	return listAndActionTpuV2Vm(deleteResourceTpuV2Vm)
}

func listAndActionTpuV2Vm(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceTpuV2Vm(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
