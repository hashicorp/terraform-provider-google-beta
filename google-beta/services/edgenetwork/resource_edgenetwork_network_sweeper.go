...
func init() {
	sweeper.AddTestSweepers("EdgenetworkNetwork", testSweepEdgenetworkNetwork)
}

func testSweepEdgenetworkNetwork(_ string) error {
	var deletionerror error
	resourceName := "EdgenetworkNetwork"
	...
	for _, region := range regions {
		...
		listTemplate := strings.Split("https://edgenetwork.googleapis.com/v1/projects/{{project}}/locations/{{location}}/aggregated/networks", "?")[0]
		...
		for _, ri := range rl {
			...
			deleteTemplate := "https://edgenetwork.googleapis.com/v1/projects/{{project}}/locations/{{location}}/zones/{{zone}}/networks/{{network_id}}"
			if obj["zone"] == nil {
