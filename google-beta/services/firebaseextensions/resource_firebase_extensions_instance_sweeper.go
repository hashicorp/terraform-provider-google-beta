...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionFirebaseExtensionsInstance,
		DeleteFunction: testSweepFirebaseExtensionsInstance,
	}
...
func testSweepFirebaseExtensionsInstance(_ string) error {
	return listAndActionFirebaseExtensionsInstance(deleteResourceFirebaseExtensionsInstance)
}

func listAndActionFirebaseExtensionsInstance(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceFirebaseExtensionsInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
