...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityv1ServiceConnectionPolicy,
		DeleteFunction: testSweepNetworkConnectivityv1ServiceConnectionPolicy,
	}
...
func testSweepNetworkConnectivityv1ServiceConnectionPolicy(_ string) error {
	return listAndActionNetworkConnectivityv1ServiceConnectionPolicy(deleteResourceNetworkConnectivityv1ServiceConnectionPolicy)
}

func listAndActionNetworkConnectivityv1ServiceConnectionPolicy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityv1ServiceConnectionPolicy"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkconnectivity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/serviceConnectionPolicies", "?")[0]
		...
		resourceList, ok := res["serviceConnectionPolicies"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'serviceConnectionPolicies'")
		} else {
...
func deleteResourceNetworkConnectivityv1ServiceConnectionPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkconnectivity.googleapis.com/v1/projects/{{project}}/locations/{{location}}/serviceConnectionPolicies/{{name}}"
