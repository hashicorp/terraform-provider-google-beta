...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_network_connectivity_internal_range",
		ListAndAction:  listAndActionNetworkConnectivityv1InternalRange,
		DeleteFunction: testSweepNetworkConnectivityv1InternalRange,
	}
...
func testSweepNetworkConnectivityv1InternalRange(_ string) error {
	return listAndActionNetworkConnectivityv1InternalRange(deleteResourceNetworkConnectivityv1InternalRange)
}

func listAndActionNetworkConnectivityv1InternalRange(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityv1InternalRange"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["internalRanges"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'internalRanges'")
		} else {
...
func deleteResourceNetworkConnectivityv1InternalRange(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
