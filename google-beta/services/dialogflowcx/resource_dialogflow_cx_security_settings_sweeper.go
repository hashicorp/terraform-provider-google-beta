...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_dialogflow_cx_security_settings",
		ListAndAction:  listAndActionDialogflowCXSecuritySettings,
		DeleteFunction: testSweepDialogflowCXSecuritySettings,
	}
...
func testSweepDialogflowCXSecuritySettings(_ string) error {
	return listAndActionDialogflowCXSecuritySettings(deleteResourceDialogflowCXSecuritySettings)
}

func listAndActionDialogflowCXSecuritySettings(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DialogflowCXSecuritySettings"
...
func deleteResourceDialogflowCXSecuritySettings(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
