...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionMonitoringNotificationChannel,
		DeleteFunction: testSweepMonitoringNotificationChannel,
	}
...
func testSweepMonitoringNotificationChannel(_ string) error {
	return listAndActionMonitoringNotificationChannel(deleteResourceMonitoringNotificationChannel)
}

func listAndActionMonitoringNotificationChannel(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "MonitoringNotificationChannel"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["notificationChannels"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'notificationChannels'")
		} else {
...
func deleteResourceMonitoringNotificationChannel(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
