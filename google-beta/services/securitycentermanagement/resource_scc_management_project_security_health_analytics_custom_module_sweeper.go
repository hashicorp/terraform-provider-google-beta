...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule,
		DeleteFunction: testSweepSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule,
	}
...
func testSweepSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule(_ string) error {
	return listAndActionSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule(deleteResourceSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule)
}

func listAndActionSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://securitycentermanagement.googleapis.com/v1/projects/{{project}}/locations/{{location}}/securityHealthAnalyticsCustomModules", "?")[0]
		...
		resourceList, ok := res["projectSecurityHealthAnalyticsCustomModules"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'projectSecurityHealthAnalyticsCustomModules'")
		} else {
...
func deleteResourceSecurityCenterManagementProjectSecurityHealthAnalyticsCustomModule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://securitycentermanagement.googleapis.com/v1/projects/{{project}}/locations/{{location}}/securityHealthAnalyticsCustomModules/{{name}}"
