...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityTransport,
		DeleteFunction: testSweepNetworkConnectivityTransport,
	}
...
func testSweepNetworkConnectivityTransport(_ string) error {
	return listAndActionNetworkConnectivityTransport(deleteResourceNetworkConnectivityTransport)
}

func listAndActionNetworkConnectivityTransport(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityTransport"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkconnectivity.googleapis.com/v1beta/projects/{{project}}/locations/{{region}}/transports", "?")[0]
...
func deleteResourceNetworkConnectivityTransport(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkconnectivity.googleapis.com/v1beta/projects/{{project}}/locations/{{region}}/transports/{{name}}"
