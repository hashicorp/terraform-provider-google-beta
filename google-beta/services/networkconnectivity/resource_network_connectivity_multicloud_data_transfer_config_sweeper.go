...
func testSweepNetworkConnectivityMulticloudDataTransferConfig(_ string) error {
	return listAndActionNetworkConnectivityMulticloudDataTransferConfig(deleteResourceNetworkConnectivityMulticloudDataTransferConfig)
}

func listAndActionNetworkConnectivityMulticloudDataTransferConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityMulticloudDataTransferConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkconnectivity.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/multicloudDataTransferConfigs", "?")[0]
		...
		resourceList, ok := res["multicloudDataTransferConfigs"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'multicloudDataTransferConfigs'")
		} else {
...
func deleteResourceNetworkConnectivityMulticloudDataTransferConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkconnectivity.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/multicloudDataTransferConfigs/{{name}}"
