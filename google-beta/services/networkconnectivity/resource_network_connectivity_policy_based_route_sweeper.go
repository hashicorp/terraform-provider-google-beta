...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityPolicyBasedRoute,
		DeleteFunction: testSweepNetworkConnectivityPolicyBasedRoute,
	}
...
func testSweepNetworkConnectivityPolicyBasedRoute(_ string) error {
	return listAndActionNetworkConnectivityPolicyBasedRoute(deleteResourceNetworkConnectivityPolicyBasedRoute)
}

func listAndActionNetworkConnectivityPolicyBasedRoute(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityPolicyBasedRoute"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["policyBasedRoutes"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'policyBasedRoutes'")
		} else {
...
func deleteResourceNetworkConnectivityPolicyBasedRoute(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
