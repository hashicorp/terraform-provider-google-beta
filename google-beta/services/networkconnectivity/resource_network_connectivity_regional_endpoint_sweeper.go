...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityRegionalEndpoint,
		DeleteFunction: testSweepNetworkConnectivityRegionalEndpoint,
	}
...
func testSweepNetworkConnectivityRegionalEndpoint(_ string) error {
	return listAndActionNetworkConnectivityRegionalEndpoint(deleteResourceNetworkConnectivityRegionalEndpoint)
}

func listAndActionNetworkConnectivityRegionalEndpoint(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityRegionalEndpoint"
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'regionalEndpoints'")
		} else {
...
func deleteResourceNetworkConnectivityRegionalEndpoint(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
