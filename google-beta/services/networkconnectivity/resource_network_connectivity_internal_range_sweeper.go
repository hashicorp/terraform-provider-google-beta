...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityInternalRange,
		DeleteFunction: testSweepNetworkConnectivityInternalRange,
	}
...
func testSweepNetworkConnectivityInternalRange(_ string) error {
	return listAndActionNetworkConnectivityInternalRange(deleteResourceNetworkConnectivityInternalRange)
}

func listAndActionNetworkConnectivityInternalRange(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityInternalRange"
...
func deleteResourceNetworkConnectivityInternalRange(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
