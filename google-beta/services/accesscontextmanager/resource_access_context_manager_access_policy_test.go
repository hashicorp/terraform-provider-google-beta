...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/accesscontextmanager/resource_access_context_manager_access_policy_test.go.tmpl
//
...
func TestAccAccessContextManager(t *testing.T) {
	testCases := map[string]func(t *testing.T){
		...
		"service_perimeter_dry_run_ingress_policy_update": testAccAccessContextManagerServicePerimeterDryRunIngressPolicy_updateTest,
