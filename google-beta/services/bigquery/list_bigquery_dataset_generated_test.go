...
func TestAccBigQueryDatasetListQuery_generated(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccBigQueryDataset_bigqueryDatasetBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_bigquery_dataset.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_bigquery_dataset.list_query",
...
func testAccBigQueryDataset_bigqueryDatasetBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_bigquery_dataset" "list_query" {
    provider = google
	limit = 10000
    config {
    }
