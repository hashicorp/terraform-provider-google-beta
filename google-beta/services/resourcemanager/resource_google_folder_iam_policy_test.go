...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/resourcemanager/resource_google_folder_iam_policy_test.go
//
...
func testAccCheckGoogleFolderIamPolicyDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		...
		for _, rs := range s.RootModule().Resources {
			...
			policy, err := resourcemanagerv3.NewClient(config, config.UserAgent).Folders.GetIamPolicy(folder, &cloudresourcemanagerv3.GetIamPolicyRequest{}).Do()
