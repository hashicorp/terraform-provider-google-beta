...
func TestAccDataformRepositoryReleaseConfig_dataformRepositoryReleaseConfigDisabledExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataformRepositoryReleaseConfig_dataformRepositoryReleaseConfigDisabledExample(context),
			},
			{
				ResourceName:            "google_dataform_repository_release_config.release",
				ImportState:             true,
...
func testAccDataformRepositoryReleaseConfig_dataformRepositoryReleaseConfigDisabledExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_sourcerepo_repository" "git_repository" {
  provider = google-beta
  name     = "%{git_repository_name}"
