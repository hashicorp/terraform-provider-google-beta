...
func TestAccDataformRepositoryWorkflowConfig_dataformRepositoryWorkflowConfigWithDisabledExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataformRepositoryWorkflowConfig_dataformRepositoryWorkflowConfigWithDisabledExample(context),
			},
			{
				ResourceName:            "google_dataform_repository_workflow_config.workflow",
				ImportState:             true,
...
func testAccDataformRepositoryWorkflowConfig_dataformRepositoryWorkflowConfigWithDisabledExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_sourcerepo_repository" "git_repository" {
  provider = google-beta
  name     = "%{git_repository_name}"
