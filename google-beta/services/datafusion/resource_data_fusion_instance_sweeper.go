...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDataFusionInstance,
		DeleteFunction: testSweepDataFusionInstance,
	}
...
func testSweepDataFusionInstance(_ string) error {
	return listAndActionDataFusionInstance(deleteResourceDataFusionInstance)
}

func listAndActionDataFusionInstance(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DataFusionInstance"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://datafusion.googleapis.com/v1beta1/projects/{{project}}/locations/{{region}}/instances", "?")[0]
...
func deleteResourceDataFusionInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://datafusion.googleapis.com/v1beta1/projects/{{project}}/locations/{{region}}/instances/{{name}}"
