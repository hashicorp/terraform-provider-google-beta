...
func TestAccServiceUsageV2ConsumerPolicy_update(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccServiceUsageV2ConsumerPolicy_allowDeletion(context),
			},
		},
	})
}
...
func testAccServiceUsageV2ConsumerPolicy_allowDeletion(context map[string]interface{}) string {
	return acctest.Nprintf(`
    provider "google-beta" {
      user_project_override = true
      billing_project = "%{project_id}"
