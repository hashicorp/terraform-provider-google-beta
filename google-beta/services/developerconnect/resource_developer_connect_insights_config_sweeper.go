...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDeveloperConnectInsightsConfig,
		DeleteFunction: testSweepDeveloperConnectInsightsConfig,
	}
...
func testSweepDeveloperConnectInsightsConfig(_ string) error {
	return listAndActionDeveloperConnectInsightsConfig(deleteResourceDeveloperConnectInsightsConfig)
}

func listAndActionDeveloperConnectInsightsConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DeveloperConnectInsightsConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://developerconnect.googleapis.com/v1/projects/{{project}}/locations/{{location}}/insightsConfigs", "?")[0]
		...
		resourceList, ok := res["insightsConfigs"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'insightsConfigs'")
		} else {
...
func deleteResourceDeveloperConnectInsightsConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://developerconnect.googleapis.com/v1/projects/{{project}}/locations/{{location}}/insightsConfigs/{{insights_config_id}}"
