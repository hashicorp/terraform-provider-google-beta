...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/assuredworkloads/resource_assured_workloads_workload_generated_test.go.tmpl
//
...
func testAccCheckAssuredWorkloadsWorkloadDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			client := assuredworkloads.NewDCLAssuredWorkloadsClient(config, config.UserAgent, billingProject, 0)
