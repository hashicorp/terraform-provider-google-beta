...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionGkeonpremVmwareCluster,
		DeleteFunction: testSweepGkeonpremVmwareCluster,
	}
...
func testSweepGkeonpremVmwareCluster(_ string) error {
	return listAndActionGkeonpremVmwareCluster(deleteResourceGkeonpremVmwareCluster)
}

func listAndActionGkeonpremVmwareCluster(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "GkeonpremVmwareCluster"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://gkeonprem.googleapis.com/v1/projects/{{project}}/locations/{{location}}/vmwareClusters", "?")[0]
...
func deleteResourceGkeonpremVmwareCluster(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://gkeonprem.googleapis.com/v1/projects/{{project}}/locations/{{location}}/vmwareClusters/{{name}}?force=true"
