...
func TestAccNetworkServicesLbRouteExtension_validation(t *testing.T) {
	t.Parallel()
...
func testAccNetworkServicesLbRouteExtension_validation_invalid(context map[string]interface{}) string {
	return acctest.Nprintf(`
# Internal HTTP load balancer with a managed instance group backend
# VPC network
resource "google_compute_network" "ilb_network" {
...
resource "google_network_services_lb_route_extension" "default" {
  ...
  extension_chains {
    ...
    extensions {
      ...
      forward_headers  = ["custom-header"]
      supported_events = ["EVENT_TYPE_UNSPECIFIED"]
    }
  }
