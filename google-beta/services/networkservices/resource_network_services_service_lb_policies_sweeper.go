...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_network_services_service_lb_policies",
...
func testSweepNetworkServicesServiceLbPolicies(_ string) error {
	return listAndActionNetworkServicesServiceLbPolicies(deleteResourceNetworkServicesServiceLbPolicies)
}

func listAndActionNetworkServicesServiceLbPolicies(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesServiceLbPolicies"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/serviceLbPolicies", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'serviceLbPolicies'")
		} else {
...
func deleteResourceNetworkServicesServiceLbPolicies(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/serviceLbPolicies/{{name}}"
