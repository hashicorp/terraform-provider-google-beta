...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesAgentConnectivityTemplate,
		DeleteFunction: testSweepNetworkServicesAgentConnectivityTemplate,
	}
...
func testSweepNetworkServicesAgentConnectivityTemplate(_ string) error {
	return listAndActionNetworkServicesAgentConnectivityTemplate(deleteResourceNetworkServicesAgentConnectivityTemplate)
}

func listAndActionNetworkServicesAgentConnectivityTemplate(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesAgentConnectivityTemplate"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/agentConnectivityTemplates", "?")[0]
		...
		resourceList, ok := res["agentConnectivityTemplates"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'agentConnectivityTemplates'")
		} else {
...
func deleteResourceNetworkServicesAgentConnectivityTemplate(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/agentConnectivityTemplates/{{agent_connectivity_template_id}}"
