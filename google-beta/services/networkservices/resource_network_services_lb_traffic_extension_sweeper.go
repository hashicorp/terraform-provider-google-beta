...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesLbTrafficExtension,
		DeleteFunction: testSweepNetworkServicesLbTrafficExtension,
	}
...
func testSweepNetworkServicesLbTrafficExtension(_ string) error {
	return listAndActionNetworkServicesLbTrafficExtension(deleteResourceNetworkServicesLbTrafficExtension)
}

func listAndActionNetworkServicesLbTrafficExtension(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'lbTrafficExtensions'")
		} else {
...
func deleteResourceNetworkServicesLbTrafficExtension(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
