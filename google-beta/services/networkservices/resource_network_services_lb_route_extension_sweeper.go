...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_network_services_lb_route_extension",
		ListAndAction:  listAndActionNetworkServicesLbRouteExtension,
		DeleteFunction: testSweepNetworkServicesLbRouteExtension,
	}
...
func testSweepNetworkServicesLbRouteExtension(_ string) error {
	return listAndActionNetworkServicesLbRouteExtension(deleteResourceNetworkServicesLbRouteExtension)
}

func listAndActionNetworkServicesLbRouteExtension(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkServicesLbRouteExtension"
	...
	intermediateValues[0]["region"] = "us-west1"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/lbRouteExtensions", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'lbRouteExtensions'")
		} else {
...
func deleteResourceNetworkServicesLbRouteExtension(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkservices.googleapis.com/v1/projects/{{project}}/locations/{{location}}/lbRouteExtensions/{{name}}"
