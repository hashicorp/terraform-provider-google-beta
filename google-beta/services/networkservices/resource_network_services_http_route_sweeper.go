...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkServicesHttpRoute,
		DeleteFunction: testSweepNetworkServicesHttpRoute,
	}
...
func testSweepNetworkServicesHttpRoute(_ string) error {
	return listAndActionNetworkServicesHttpRoute(deleteResourceNetworkServicesHttpRoute)
}

func listAndActionNetworkServicesHttpRoute(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'httpRoutes'")
		} else {
...
func deleteResourceNetworkServicesHttpRoute(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
