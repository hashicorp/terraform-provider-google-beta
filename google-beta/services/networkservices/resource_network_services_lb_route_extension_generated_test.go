...
func TestAccNetworkServicesLbRouteExtension_networkServicesLbRouteExtensionBasicExample(t *testing.T) {
	t.Parallel()
	...
	context := map[string]interface{}{
		...
		"lb_route_extension_name":       "tf-test-l7-ilb-route-ext" + randomSuffix,
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkServicesLbRouteExtension_networkServicesLbRouteExtensionBasicExample(context),
			},
			{
...
func testAccNetworkServicesLbRouteExtension_networkServicesLbRouteExtensionBasicExample(context map[string]interface{}) string {
...
func TestAccNetworkServicesLbRouteExtension_networkServicesLbRouteExtensionObservabilityExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccNetworkServicesLbRouteExtension_networkServicesLbRouteExtensionObservabilityExample(context),
			},
			{
				ResourceName:            "google_network_services_lb_route_extension.default",
				ImportState:             true,
...
func testAccNetworkServicesLbRouteExtension_networkServicesLbRouteExtensionObservabilityExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
# Internal HTTP load balancer with a managed instance group backend
# VPC network
resource "google_compute_network" "ilb_network" {
...
func testAccCheckNetworkServicesLbRouteExtensionDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			if rs.Type != "google_network_services_lb_route_extension" {
				continue
			}
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, "{{NetworkServicesBasePath}}projects/{{project}}/locations/{{location}}/lbRouteExtensions/{{name}}")
			if err != nil {
				return err
			}
			...
			if err == nil {
				return fmt.Errorf("NetworkServicesLbRouteExtension still exists at %s", url)
			}
		}
