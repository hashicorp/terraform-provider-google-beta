...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCoreBillingProjectInfo,
		DeleteFunction: testSweepCoreBillingProjectInfo,
	}
...
func testSweepCoreBillingProjectInfo(_ string) error {
	return listAndActionCoreBillingProjectInfo(deleteResourceCoreBillingProjectInfo)
}

func listAndActionCoreBillingProjectInfo(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CoreBillingProjectInfo"
...
func deleteResourceCoreBillingProjectInfo(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
