...
func listAndActionNetworkManagementOrganizationVpcFlowLogsConfig(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkmanagement.googleapis.com/v1beta1/organizations/{{organization}}/locations/{{location}}/vpcFlowLogsConfigs", "?")[0]
...
func deleteResourceNetworkManagementOrganizationVpcFlowLogsConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkmanagement.googleapis.com/v1beta1/organizations/{{organization}}/locations/{{location}}/vpcFlowLogsConfigs/{{vpc_flow_logs_config_id}}"
