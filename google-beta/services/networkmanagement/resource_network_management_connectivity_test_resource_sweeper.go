...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkManagementConnectivityTest,
		DeleteFunction: testSweepNetworkManagementConnectivityTest,
	}
...
func testSweepNetworkManagementConnectivityTest(_ string) error {
	return listAndActionNetworkManagementConnectivityTest(deleteResourceNetworkManagementConnectivityTest)
}

func listAndActionNetworkManagementConnectivityTest(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'connectivityTests'")
		} else {
...
func deleteResourceNetworkManagementConnectivityTest(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
