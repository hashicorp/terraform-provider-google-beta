...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/dns/resource_dns_managed_zone_test.go.tmpl
//
...
func TestAccDNSManagedZone_reverseLookup(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDnsManagedZone_reverseLookup(suffix),
			},
			{
