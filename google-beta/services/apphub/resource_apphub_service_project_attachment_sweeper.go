...
func init() {
	sweeper.AddTestSweepers("ApphubServiceProjectAttachment", testSweepApphubServiceProjectAttachment)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepApphubServiceProjectAttachment(region string) error {
