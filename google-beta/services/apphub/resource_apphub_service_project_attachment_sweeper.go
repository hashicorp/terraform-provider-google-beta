...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionApphubServiceProjectAttachment,
		DeleteFunction: testSweepApphubServiceProjectAttachment,
	}
...
func testSweepApphubServiceProjectAttachment(_ string) error {
	return listAndActionApphubServiceProjectAttachment(deleteResourceApphubServiceProjectAttachment)
}

func listAndActionApphubServiceProjectAttachment(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ApphubServiceProjectAttachment"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://apphub.googleapis.com/v1/projects/{{project}}/locations/global/serviceProjectAttachments", "?")[0]
...
func deleteResourceApphubServiceProjectAttachment(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
