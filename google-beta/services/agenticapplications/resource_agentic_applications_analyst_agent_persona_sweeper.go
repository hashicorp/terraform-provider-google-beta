...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionAgenticApplicationsAnalystAgentPersona,
		DeleteFunction: testSweepAgenticApplicationsAnalystAgentPersona,
	}
...
func testSweepAgenticApplicationsAnalystAgentPersona(_ string) error {
	return listAndActionAgenticApplicationsAnalystAgentPersona(deleteResourceAgenticApplicationsAnalystAgentPersona)
}

func listAndActionAgenticApplicationsAnalystAgentPersona(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "AgenticApplicationsAnalystAgentPersona"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://agenticapplications.googleapis.com/v1/projects/{{project}}/locations/{{location}}/analystAgentPersonas", "?")[0]
		...
		resourceList, ok := res["analystAgentPersonas"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'analystAgentPersonas'")
		} else {
...
func deleteResourceAgenticApplicationsAnalystAgentPersona(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://agenticapplications.googleapis.com/v1/projects/{{project}}/locations/{{location}}/analystAgentPersonas/{{analyst_agent_persona_id}}"
