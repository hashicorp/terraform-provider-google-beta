...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBigqueryConnectionConnection,
		DeleteFunction: testSweepBigqueryConnectionConnection,
	}
...
func testSweepBigqueryConnectionConnection(_ string) error {
	return listAndActionBigqueryConnectionConnection(deleteResourceBigqueryConnectionConnection)
}

func listAndActionBigqueryConnectionConnection(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[2]["region"] = "azure-eastus2"
	intermediateValues[3] = map[string]string{}
	intermediateValues[3]["region"] = "aws-us-east-1"
...
func deleteResourceBigqueryConnectionConnection(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
