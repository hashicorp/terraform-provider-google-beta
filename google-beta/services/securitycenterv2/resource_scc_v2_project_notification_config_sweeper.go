...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSecurityCenterV2ProjectNotificationConfig,
		DeleteFunction: testSweepSecurityCenterV2ProjectNotificationConfig,
	}
...
func testSweepSecurityCenterV2ProjectNotificationConfig(_ string) error {
	return listAndActionSecurityCenterV2ProjectNotificationConfig(deleteResourceSecurityCenterV2ProjectNotificationConfig)
}

func listAndActionSecurityCenterV2ProjectNotificationConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "SecurityCenterV2ProjectNotificationConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://securitycenter.googleapis.com/v2/projects/{{project}}/locations/{{location}}/notificationConfigs", "?")[0]
...
func deleteResourceSecurityCenterV2ProjectNotificationConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
