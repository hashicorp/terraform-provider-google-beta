...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionSecurityCenterV2ProjectSccBigQueryExport,
		DeleteFunction: testSweepSecurityCenterV2ProjectSccBigQueryExport,
	}
...
func testSweepSecurityCenterV2ProjectSccBigQueryExport(_ string) error {
	return listAndActionSecurityCenterV2ProjectSccBigQueryExport(deleteResourceSecurityCenterV2ProjectSccBigQueryExport)
}

func listAndActionSecurityCenterV2ProjectSccBigQueryExport(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceSecurityCenterV2ProjectSccBigQueryExport(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
