...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsAssessmentRule,
		DeleteFunction: testSweepContactCenterInsightsAssessmentRule,
	}
...
func testSweepContactCenterInsightsAssessmentRule(_ string) error {
	return listAndActionContactCenterInsightsAssessmentRule(deleteResourceContactCenterInsightsAssessmentRule)
}

func listAndActionContactCenterInsightsAssessmentRule(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsAssessmentRule"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/assessmentRules", "?")[0]
		...
		resourceList, ok := res["assessmentRules"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'assessmentRules'")
		} else {
...
func deleteResourceContactCenterInsightsAssessmentRule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/assessmentRules/{{name}}"
