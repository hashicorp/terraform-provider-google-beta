...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsAutoLabelingRule,
		DeleteFunction: testSweepContactCenterInsightsAutoLabelingRule,
	}
...
func testSweepContactCenterInsightsAutoLabelingRule(_ string) error {
	return listAndActionContactCenterInsightsAutoLabelingRule(deleteResourceContactCenterInsightsAutoLabelingRule)
}

func listAndActionContactCenterInsightsAutoLabelingRule(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsAutoLabelingRule"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/autoLabelingRules", "?")[0]
		...
		resourceList, ok := res["autoLabelingRules"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'autoLabelingRules'")
		} else {
...
func deleteResourceContactCenterInsightsAutoLabelingRule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/autoLabelingRules/{{name}}"
