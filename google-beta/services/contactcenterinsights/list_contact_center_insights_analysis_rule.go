...
func init() {
	registry.FrameworkListResource{
		Name:        "google_contact_center_insights_analysis_rule",
		ProductName: "ContactCenterInsights",
		Func:        NewContactCenterInsightsAnalysisRuleListResource,
	}.Register()
}

var _ list.ListResource = &ContactCenterInsightsAnalysisRuleListResource{}

type ContactCenterInsightsAnalysisRuleListResource struct {
	tpgresource.ListResourceMetadata
}

func NewContactCenterInsightsAnalysisRuleListResource() list.ListResource {
	listR := &ContactCenterInsightsAnalysisRuleListResource{}
	listR.TypeName = "google_contact_center_insights_analysis_rule"
	listR.SDKv2Resource = ResourceContactCenterInsightsAnalysisRule()
...
// ContactCenterInsightsAnalysisRuleListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ContactCenterInsightsAnalysisRuleListModel struct {
	Location types.String `tfsdk:"location"`
	Project  types.String `tfsdk:"project"`
}

func (listR *ContactCenterInsightsAnalysisRuleListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ContactCenterInsightsAnalysisRuleListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListContactCenterInsightsAnalysisRules(
			listR.Client,
			location,
			project,
...
func ListContactCenterInsightsAnalysisRules(config *transport_tpg.Config,
	location string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceContactCenterInsightsAnalysisRule().Data(&terraform.InstanceState{})
	if location != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ContactCenterInsightsBasePath}}projects/{{project}}/locations/{{location}}/analysisRules")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceContactCenterInsightsAnalysisRule(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "analysisRules",
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceContactCenterInsightsAnalysisRuleFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}
