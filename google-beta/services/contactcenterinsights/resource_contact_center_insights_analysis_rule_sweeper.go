...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsAnalysisRule,
		DeleteFunction: testSweepContactCenterInsightsAnalysisRule,
	}
...
func testSweepContactCenterInsightsAnalysisRule(_ string) error {
	return listAndActionContactCenterInsightsAnalysisRule(deleteResourceContactCenterInsightsAnalysisRule)
}

func listAndActionContactCenterInsightsAnalysisRule(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsAnalysisRule"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/analysisRules", "?")[0]
		...
		resourceList, ok := res["analysisRules"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'analysisRules'")
		} else {
...
func deleteResourceContactCenterInsightsAnalysisRule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/analysisRules/{{name}}"
