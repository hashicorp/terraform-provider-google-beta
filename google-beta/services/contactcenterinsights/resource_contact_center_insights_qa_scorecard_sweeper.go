...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionContactCenterInsightsQaScorecard,
		DeleteFunction: testSweepContactCenterInsightsQaScorecard,
	}
...
func testSweepContactCenterInsightsQaScorecard(_ string) error {
	return listAndActionContactCenterInsightsQaScorecard(deleteResourceContactCenterInsightsQaScorecard)
}

func listAndActionContactCenterInsightsQaScorecard(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsQaScorecard"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/qaScorecards", "?")[0]
		...
		resourceList, ok := res["qaScorecards"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'qaScorecards'")
		} else {
...
func deleteResourceContactCenterInsightsQaScorecard(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/qaScorecards/{{qa_scorecard_id}}"
