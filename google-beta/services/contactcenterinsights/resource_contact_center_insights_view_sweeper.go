...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_contact_center_insights_view",
		ListAndAction:  listAndActionContactCenterInsightsView,
		DeleteFunction: testSweepContactCenterInsightsView,
	}
...
func testSweepContactCenterInsightsView(_ string) error {
	return listAndActionContactCenterInsightsView(deleteResourceContactCenterInsightsView)
}

func listAndActionContactCenterInsightsView(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ContactCenterInsightsView"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/views", "?")[0]
		...
		resourceList, ok := res["views"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'views'")
		} else {
...
func deleteResourceContactCenterInsightsView(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://contactcenterinsights.googleapis.com/v1/projects/{{project}}/locations/{{location}}/views/{{name}}"
