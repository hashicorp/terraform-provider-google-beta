...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNotebooksLocation,
		DeleteFunction: testSweepNotebooksLocation,
	}
...
func testSweepNotebooksLocation(_ string) error {
	return listAndActionNotebooksLocation(deleteResourceNotebooksLocation)
}

func listAndActionNotebooksLocation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NotebooksLocation"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://notebooks.googleapis.com/v1/projects/{{project}}/locations", "?")[0]
...
func deleteResourceNotebooksLocation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://notebooks.googleapis.com/v1/projects/{{project}}/locations/{{name}}"
