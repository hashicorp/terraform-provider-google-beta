...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNotebooksInstance,
		DeleteFunction: testSweepNotebooksInstance,
	}
...
func testSweepNotebooksInstance(_ string) error {
	return listAndActionNotebooksInstance(deleteResourceNotebooksInstance)
}

func listAndActionNotebooksInstance(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceNotebooksInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
