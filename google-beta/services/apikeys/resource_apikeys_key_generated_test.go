...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/apikeys/resource_apikeys_key_generated_test.go
//
...
func testAccCheckApikeysKeyDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			client := apikeys.NewDCLApikeysClient(config, config.UserAgent, billingProject, 0)
