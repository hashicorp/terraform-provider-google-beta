...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/resource_compute_ssl_certificate_test.go
//
...
func testAccCheckComputeSslCertificateExists(t *testing.T, n string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		found, err := compute.DEPRECATED_LegacyApiaryClient(config, config.UserAgent).SslCertificates.Get(
