...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeTargetGrpcProxy,
		DeleteFunction: testSweepComputeTargetGrpcProxy,
	}
...
func testSweepComputeTargetGrpcProxy(_ string) error {
	return listAndActionComputeTargetGrpcProxy(deleteResourceComputeTargetGrpcProxy)
}

func listAndActionComputeTargetGrpcProxy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeTargetGrpcProxy"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/global/targetGrpcProxies", "?")[0]
...
func deleteResourceComputeTargetGrpcProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/global/targetGrpcProxies/{{name}}"
