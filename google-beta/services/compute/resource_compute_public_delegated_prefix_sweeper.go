...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputePublicDelegatedPrefix,
		DeleteFunction: testSweepComputePublicDelegatedPrefix,
	}
...
func testSweepComputePublicDelegatedPrefix(_ string) error {
	return listAndActionComputePublicDelegatedPrefix(deleteResourceComputePublicDelegatedPrefix)
}

func listAndActionComputePublicDelegatedPrefix(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'publicDelegatedPrefixs'")
		} else {
...
func deleteResourceComputePublicDelegatedPrefix(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
