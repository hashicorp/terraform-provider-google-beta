...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionHealthAggregationPolicy,
		DeleteFunction: testSweepComputeRegionHealthAggregationPolicy,
	}
...
func testSweepComputeRegionHealthAggregationPolicy(_ string) error {
	return listAndActionComputeRegionHealthAggregationPolicy(deleteResourceComputeRegionHealthAggregationPolicy)
}

func listAndActionComputeRegionHealthAggregationPolicy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeRegionHealthAggregationPolicy"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/healthAggregationPolicies", "?")[0]
...
func deleteResourceComputeRegionHealthAggregationPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/healthAggregationPolicies/{{name}}"
