...
func TestAccComputeRegionBackendBucketListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_backend_bucket.image_backend",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionBackendBucket_regionBackendBucketBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_backend_bucket.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_backend_bucket.list_query",
