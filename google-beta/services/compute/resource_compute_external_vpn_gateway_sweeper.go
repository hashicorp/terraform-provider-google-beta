...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeExternalVpnGateway,
		DeleteFunction: testSweepComputeExternalVpnGateway,
	}
...
func testSweepComputeExternalVpnGateway(_ string) error {
	return listAndActionComputeExternalVpnGateway(deleteResourceComputeExternalVpnGateway)
}

func listAndActionComputeExternalVpnGateway(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeExternalVpnGateway(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
