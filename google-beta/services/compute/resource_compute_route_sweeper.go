...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRoute,
		DeleteFunction: testSweepComputeRoute,
	}
...
func testSweepComputeRoute(_ string) error {
	return listAndActionComputeRoute(deleteResourceComputeRoute)
}

func listAndActionComputeRoute(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeRoute(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
