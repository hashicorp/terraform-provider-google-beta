...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeTargetSslProxy,
		DeleteFunction: testSweepComputeTargetSslProxy,
	}
...
func testSweepComputeTargetSslProxy(_ string) error {
	return listAndActionComputeTargetSslProxy(deleteResourceComputeTargetSslProxy)
}

func listAndActionComputeTargetSslProxy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeTargetSslProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
