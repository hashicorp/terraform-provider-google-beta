...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionUrlMap,
		DeleteFunction: testSweepComputeRegionUrlMap,
	}
...
func testSweepComputeRegionUrlMap(_ string) error {
	return listAndActionComputeRegionUrlMap(deleteResourceComputeRegionUrlMap)
}

func listAndActionComputeRegionUrlMap(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeRegionUrlMap(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
