...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeTargetHttpProxy,
		DeleteFunction: testSweepComputeTargetHttpProxy,
	}
...
func testSweepComputeTargetHttpProxy(_ string) error {
	return listAndActionComputeTargetHttpProxy(deleteResourceComputeTargetHttpProxy)
}

func listAndActionComputeTargetHttpProxy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeTargetHttpProxy"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/global/targetHttpProxies", "?")[0]
...
func deleteResourceComputeTargetHttpProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/global/targetHttpProxies/{{name}}"
