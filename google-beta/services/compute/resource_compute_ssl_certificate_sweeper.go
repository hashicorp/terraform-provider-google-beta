...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeSslCertificate,
		DeleteFunction: testSweepComputeSslCertificate,
	}
...
func testSweepComputeSslCertificate(_ string) error {
	return listAndActionComputeSslCertificate(deleteResourceComputeSslCertificate)
}

func listAndActionComputeSslCertificate(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeSslCertificate(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
