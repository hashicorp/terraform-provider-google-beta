...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/data_source_google_compute_zones.go.tmpl
//
...
func dataSourceGoogleComputeZonesRead(d *schema.ResourceData, meta interface{}) error {
	...
	zones := []string{}
	err = NewClient(config, userAgent).Zones.List(project).Filter(filter).Pages(config.Context, func(zl *compute.ZoneList) error {
