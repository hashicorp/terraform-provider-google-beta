...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeManagedSslCertificate,
		DeleteFunction: testSweepComputeManagedSslCertificate,
	}
...
func testSweepComputeManagedSslCertificate(_ string) error {
	return listAndActionComputeManagedSslCertificate(deleteResourceComputeManagedSslCertificate)
}

func listAndActionComputeManagedSslCertificate(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeManagedSslCertificate(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
