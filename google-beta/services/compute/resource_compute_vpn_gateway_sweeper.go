...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeVpnGateway,
		DeleteFunction: testSweepComputeVpnGateway,
	}
...
func testSweepComputeVpnGateway(_ string) error {
	return listAndActionComputeVpnGateway(deleteResourceComputeVpnGateway)
}

func listAndActionComputeVpnGateway(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeVpnGateway(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
