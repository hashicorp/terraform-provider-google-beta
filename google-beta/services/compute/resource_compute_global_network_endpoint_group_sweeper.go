...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeGlobalNetworkEndpointGroup,
		DeleteFunction: testSweepComputeGlobalNetworkEndpointGroup,
	}
...
func testSweepComputeGlobalNetworkEndpointGroup(_ string) error {
	return listAndActionComputeGlobalNetworkEndpointGroup(deleteResourceComputeGlobalNetworkEndpointGroup)
}

func listAndActionComputeGlobalNetworkEndpointGroup(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeGlobalNetworkEndpointGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
