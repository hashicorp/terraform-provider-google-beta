		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDisk(&instance, instanceName, true, true),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_basic3(instanceName)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDisk(&instance, instanceName, true, true),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_basic4(instanceName)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDisk(&instance, instanceName, true, true),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_basic5(instanceName)),
				),
			},
		},
	})
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_resourceManagerTagsUpdate(context)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(t, "google_compute_instance.foobar", &instance),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_diskResourcePoliciesOnePolicyUpdate(context)),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(t, "google_compute_instance.foobar", &instance),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_diskResourcePoliciesOnePolicy(context_1)),
				),
			},
			{
				ResourceName:      "google_compute_instance.foobar",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_machineType(instanceName, machineTypeUrl)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_descriptionUpdate(instanceName)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_ipv6(ipName, instanceName, ptrName)),
				),
			},
			{
				ResourceName:      "google_compute_instance.foobar",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_ipv6ExternalReservation(instanceName)),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_internalIpv6(ipName, instanceName)),
				),
			},
			computeInstanceImportStep("us-west2-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_networkTier(instanceName)),
				),
			},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_disks_encryption(bootEncryptionKey, diskNameToEncryptionKey, instanceName, acctest.RandString(t, 10))),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDiskEncryptionKey("google_compute_instance.foobar", &instance, bootEncryptionKeyHash, diskNameToEncryptionKey),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_disks_encryption_restartUpdate(bootEncryptionKey, diskNameToEncryptionKey, instanceName)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_disks_kms(bootKmsKeyName, diskNameToEncryptionKey, instanceName, acctest.RandString(t, 10))),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			...
			// check removing
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeResourcePolicy(&instance, "", 0),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_removeResourcePolicy(instanceName, scheduleName1, scheduleName2)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_attachedDisk(diskName, instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDisk(&instance, diskName, false, false),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_attachedDisk_sourceUrl(diskName, instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDisk(&instance, diskName, false, false),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_attachedDisk_modeRo(diskName, instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			...
			// check updating
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceDisk(&instance, diskName, false, false),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_updateAttachedDiskEncryptionKey(diskName, instanceName)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_bootDisk_source(diskName, instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceBootDisk(&instance, diskName),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_bootDisk_sourceUrl(diskName, instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_bootDisk_type(instanceName, diskType)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_bootDisk_mode(instanceName, diskMode)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_with375GbScratchDisk(instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_with18TbScratchDisk(instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{}),
		},
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceMetadata(
						&instance, "qux", "true"),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_forceNewAndChangeMetadata(instanceName)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_update(instanceName)),
				),
			},
		},
	})
			...
			// Check that removing them works
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_stopInstanceToUpdate3(instanceName)),
				),
			},
			computeInstanceImportStep("us-central1-a", instanceName, []string{"allow_stopping_for_update"}),
		},
		...
		Steps: []resource.TestStep{
			...
			computeInstanceImportStep(context_4["zone"].(string), context_4["instance_name"].(string), []string{}),
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("google_compute_instance.foobar", "scheduling.0.host_error_timeout_seconds", "90"),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar",
						testAccComputeInstance_hostErrorTimeoutSeconds(context_1)),
				),
			},
			computeInstanceImportStep(context_1["zone"].(string), context_1["instance_name"].(string), []string{}),
		},
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.foobar5",
						testAccComputeInstanceConfidentialInstanceConfigEnableTdx(instanceName, "TDX")),
				),
			},
		},
	})
...
func TestAccComputeInstance_partnerMetadata(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeInstance_partnerMetadata(instanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
			...
			computeInstanceImportStep("us-central1-a", instanceName, []string{fmt.Sprintf("partner_metadata.%s", namespace)}),
		},
	})
}
...
func TestAccComputeInstance_partnerMetadata_update(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeInstance_partnerMetadata_empty(instanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
				),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeInstanceBootDisk(&instance, diskName),
					acctest.GetTestMetadataForTgc("compute", "google_compute_instance.regional_vm_instance",
						testAccComputeInstance_regionBootDisk(instanceName, diskName, suffix)),
				),
			},
		},
	})
...
func TestAccComputeInstanceNetworkIntefaceWithSecurityPolicy(t *testing.T) {
	testCases := map[string]func(t *testing.T){
		...
		"two_nics_two_access_configs_update_one_policy":           testAccComputeInstance_nic_securityPolicyCreateWithTwoNicsAndTwoAccessConfigsUpdateOnlyOnePolicy,
		...
		"two_nics_two_access_configs_update_two_policies":         testAccComputeInstance_nic_securityPolicyCreateWithTwoNicsAndTwoAccessConfigsUpdateSwapPolicies,
		"access_config_update_access_config":                      testAccComputeInstance_nic_securityPolicyCreateWithAccessConfigUpdateAccessConfig,
		"wit_no_access_config":                                    testAccComputeInstance_nic_securityPolicyCreateWithoutAccessConfig,
	}
...
func testAccComputeInstance_nic_securityPolicyCreateWithTwoAccessConfigs(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeInstance_nic_securityPolicyCreateWithOneNicAndTwoAccessConfigs(suffix, policyName, instanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
...
func testAccComputeInstance_nic_securityPolicyCreateWithEmptyAndNullSecurityPolicies(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeInstance_nic_securityPolicyCreateWithTwoNicsAndAccessConfigsWithEmptyAndNullSecurityPolicies(suffix, instanceName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
					testAccCheckComputeInstanceNicAccessConfigHasNoSecurityPolicy(&instance),
				),
			},
			{
				ResourceName:      "google_compute_instance.foobar",
...
func testAccComputeInstance_nic_securityPolicyCreateWithTwoAccessConfigsUpdateSecurityPoliciesWithStoppedMachine(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccComputeInstance_nic_securityPolicyCreateWithTwoAccessConfigsWithTwoSecurityPoliciesAndStatus(suffix, policyName, instanceName, "\"\"", "TERMINATED"),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeInstanceExists(
						t, "google_compute_instance.foobar", &instance),
					testAccCheckComputeInstanceHasStatus(&instance, "TERMINATED"),
			...
			{
				Config:      testAccComputeInstance_nic_securityPolicyCreateWithTwoAccessConfigsWithTwoSecurityPoliciesAndStatus(suffix, policyName, instanceName, "google_compute_region_security_policy.policyforinstance.self_link", "TERMINATED"),
				ExpectError: regexp.MustCompile("Error to update security policy because the current instance status must be \"RUNNING\". The security policy or some access config may have changed which requires the security policy to be re-applied"),
			},
		},
	})
}
...
func testAccComputeInstance_nic_securityPolicyCreateWithoutAccessConfig(t *testing.T) {
	var instanceName = fmt.Sprintf("tf-test-instance-%s", acctest.RandString(t, 10))
	var policyName = fmt.Sprintf("tf-test-policy-%s", acctest.RandString(t, 10))
	var suffix = acctest.RandString(t, 10)
...
func testAccCheckComputeInstanceNicAccessConfigHasSecurityPolicy(instance *compute.Instance, securityPolicy string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		return fmt.Errorf("Security Policy with name %s not present", securityPolicy)
	}
}
...
func testAccComputeInstance_partnerMetadata_empty(instance string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family    = "ubuntu-2004-lts"
  project   = "ubuntu-os-cloud"
...
resource "google_compute_address" "ipv6-address" {
  ...
  network_tier       = "PREMIUM"
  ipv6_endpoint_type = "VM"
  subnetwork         = google_compute_subnetwork.subnet-ipv6.name
}
...
resource "google_compute_address" "ipv6-address2" {
  ...
  network_tier       = "PREMIUM"
  ipv6_endpoint_type = "VM"
  subnetwork         = google_compute_subnetwork.subnet-ipv62.name
}
...
resource "google_compute_instance" "foobar" {
  ...
  network_interface {
    ...
    subnetwork = google_compute_subnetwork.subnet-ipv62.self_link
    stack_type = "IPV4_IPV6"
    ipv6_access_config {
      external_ipv6               = google_compute_address.ipv6-address2.address
      external_ipv6_prefix_length = 96
      name                        = "external-ipv6-access-config"
      network_tier                = "PREMIUM"
    }
