...
func init() {
	registry.FrameworkListResource{
		...
		ProductName: "Compute",
		Func:        NewComputeRegionHealthAggregationPolicyListResource,
	}.Register()
}

var _ list.ListResource = &ComputeRegionHealthAggregationPolicyListResource{}

type ComputeRegionHealthAggregationPolicyListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeRegionHealthAggregationPolicyListResource() list.ListResource {
	listR := &ComputeRegionHealthAggregationPolicyListResource{}
	listR.TypeName = "google_compute_region_health_aggregation_policy"
	listR.SDKv2Resource = ResourceComputeRegionHealthAggregationPolicy()
...
// ComputeRegionHealthAggregationPolicyListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeRegionHealthAggregationPolicyListModel struct {
	Region  types.String `tfsdk:"region"`
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeRegionHealthAggregationPolicyListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeRegionHealthAggregationPolicyListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListComputeRegionHealthAggregationPolicys(
			listR.Client,
			region,
			project,
...
func ListComputeRegionHealthAggregationPolicys(config *transport_tpg.Config,
	region string,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeRegionHealthAggregationPolicy().Data(&terraform.InstanceState{})
	if region != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ComputeBasePath}}projects/{{project}}/regions/{{region}}/healthAggregationPolicies")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeRegionHealthAggregationPolicy(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "regionHealthAggregationPolicies",
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceComputeRegionHealthAggregationPolicyFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}
