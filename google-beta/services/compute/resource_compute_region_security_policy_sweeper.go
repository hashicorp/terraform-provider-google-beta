...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionSecurityPolicy,
		DeleteFunction: testSweepComputeRegionSecurityPolicy,
	}
...
func testSweepComputeRegionSecurityPolicy(_ string) error {
	return listAndActionComputeRegionSecurityPolicy(deleteResourceComputeRegionSecurityPolicy)
}

func listAndActionComputeRegionSecurityPolicy(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[0]["region"] = "us-south1"
	intermediateValues[1] = map[string]string{}
	intermediateValues[1]["region"] = "us-west2"
	intermediateValues[2] = map[string]string{}
	intermediateValues[2]["region"] = "us-west1"
	intermediateValues[3] = map[string]string{}
	intermediateValues[3]["region"] = "asia-southeast1"
	...
	intermediateValues[6]["region"] = "us-central1"
...
func deleteResourceComputeRegionSecurityPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
