...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/resource_compute_disk_test.go.tmpl
//
...
func TestAccComputeDisk_VSSWindowsDefault(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeDisk_VSSWindowsDefault(diskName),
			},
			{
				ResourceName:            "google_compute_disk.foobar",
				ImportState:             true,
...
func TestAccComputeDisk_VSSWindows(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccComputeDisk_VSSWindows(diskName, true),
			},
			{
				ResourceName:            "google_compute_disk.foobar",
				ImportState:             true,
			...
			{
				Config: testAccComputeDisk_VSSWindows(diskName, false),
			},
			{
				ResourceName:            "google_compute_disk.foobar",
				ImportState:             true,
...
func testAccComputeDisk_VSSWindowsDefault(diskName string) string {
	return fmt.Sprintf(`
resource "google_compute_disk" "foobar" {
...
func testAccComputeDisk_VSSWindows(diskName string, eraseWindowsVssSignature bool) string {
	return fmt.Sprintf(`
resource "google_compute_disk" "foobar" {
  provider = google-beta
  name = "%s"
