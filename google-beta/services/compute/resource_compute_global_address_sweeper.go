...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeGlobalAddress,
		DeleteFunction: testSweepComputeGlobalAddress,
	}
...
func testSweepComputeGlobalAddress(_ string) error {
	return listAndActionComputeGlobalAddress(deleteResourceComputeGlobalAddress)
}

func listAndActionComputeGlobalAddress(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeGlobalAddress(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
