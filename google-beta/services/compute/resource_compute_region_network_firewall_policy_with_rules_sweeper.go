...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_compute_region_network_firewall_policy_with_rules",
		ListAndAction:  listAndActionComputeRegionNetworkFirewallPolicyWithRules,
		DeleteFunction: testSweepComputeRegionNetworkFirewallPolicyWithRules,
	}
...
func testSweepComputeRegionNetworkFirewallPolicyWithRules(_ string) error {
	return listAndActionComputeRegionNetworkFirewallPolicyWithRules(deleteResourceComputeRegionNetworkFirewallPolicyWithRules)
}

func listAndActionComputeRegionNetworkFirewallPolicyWithRules(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeRegionNetworkFirewallPolicyWithRules(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
