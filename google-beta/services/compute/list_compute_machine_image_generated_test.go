...
func TestAccComputeMachineImageListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeMachineImage_machineImageBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_machine_image.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_machine_image.list_query",
...
func testAccComputeMachineImage_machineImageBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_machine_image" "list_query" {
