...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/resource_compute_project_metadata_test.go
//
...
func testAccCheckComputeProjectMetadataDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		...
		for _, rs := range s.RootModule().Resources {
			...
			project, err := compute.DEPRECATED_LegacyApiaryClient(config, config.UserAgent).Projects.Get(rs.Primary.ID).Do()
