...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeVpnTunnel,
		DeleteFunction: testSweepComputeVpnTunnel,
	}
...
func testSweepComputeVpnTunnel(_ string) error {
	return listAndActionComputeVpnTunnel(deleteResourceComputeVpnTunnel)
}

func listAndActionComputeVpnTunnel(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeVpnTunnel(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
