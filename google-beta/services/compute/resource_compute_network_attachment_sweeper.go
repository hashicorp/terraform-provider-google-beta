...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeNetworkAttachment,
		DeleteFunction: testSweepComputeNetworkAttachment,
	}
...
func testSweepComputeNetworkAttachment(_ string) error {
	return listAndActionComputeNetworkAttachment(deleteResourceComputeNetworkAttachment)
}

func listAndActionComputeNetworkAttachment(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeNetworkAttachment(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
