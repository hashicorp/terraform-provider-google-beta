...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionTargetHttpProxy,
		DeleteFunction: testSweepComputeRegionTargetHttpProxy,
	}
...
func testSweepComputeRegionTargetHttpProxy(_ string) error {
	return listAndActionComputeRegionTargetHttpProxy(deleteResourceComputeRegionTargetHttpProxy)
}

func listAndActionComputeRegionTargetHttpProxy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeRegionTargetHttpProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
