...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeInterconnectAttachmentGroup,
		DeleteFunction: testSweepComputeInterconnectAttachmentGroup,
	}
...
func testSweepComputeInterconnectAttachmentGroup(_ string) error {
	return listAndActionComputeInterconnectAttachmentGroup(deleteResourceComputeInterconnectAttachmentGroup)
}

func listAndActionComputeInterconnectAttachmentGroup(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeInterconnectAttachmentGroup"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/global/interconnectAttachmentGroups", "?")[0]
		...
		resourceList, ok := res["interconnectAttachmentGroups"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'interconnectAttachmentGroups'")
		} else {
...
func deleteResourceComputeInterconnectAttachmentGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/global/interconnectAttachmentGroups/{{name}}"
