...
func TestAccComputePacketMirroringListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_packet_mirroring.foobar",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputePacketMirroring_computePacketMirroringFullExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_packet_mirroring.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_packet_mirroring.list_query",
