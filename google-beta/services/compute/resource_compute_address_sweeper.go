...
func testSweepComputeAddress(_ string) error {
	return listAndActionComputeAddress(deleteResourceComputeAddress)
}

func listAndActionComputeAddress(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeAddress"
...
func deleteResourceComputeAddress(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
