...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeForwardingRule,
		DeleteFunction: testSweepComputeForwardingRule,
	}
	// Add dependencies
...
func testSweepComputeForwardingRule(_ string) error {
	return listAndActionComputeForwardingRule(deleteResourceComputeForwardingRule)
}

func listAndActionComputeForwardingRule(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeForwardingRule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
