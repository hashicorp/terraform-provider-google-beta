...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeAutoscaler,
		DeleteFunction: testSweepComputeAutoscaler,
	}
...
func testSweepComputeAutoscaler(_ string) error {
	return listAndActionComputeAutoscaler(deleteResourceComputeAutoscaler)
}

func listAndActionComputeAutoscaler(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[1]["zone"] = "us-central1-f"
...
func deleteResourceComputeAutoscaler(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
