...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionNetworkFirewallPolicy,
		DeleteFunction: testSweepComputeRegionNetworkFirewallPolicy,
	}
...
func testSweepComputeRegionNetworkFirewallPolicy(_ string) error {
	return listAndActionComputeRegionNetworkFirewallPolicy(deleteResourceComputeRegionNetworkFirewallPolicy)
}

func listAndActionComputeRegionNetworkFirewallPolicy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeRegionNetworkFirewallPolicy"
...
func deleteResourceComputeRegionNetworkFirewallPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
