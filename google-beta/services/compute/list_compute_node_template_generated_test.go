...
func TestAccComputeNodeTemplateListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_node_template.template",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeNodeTemplate_nodeTemplateBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_node_template.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_node_template.list_query",
