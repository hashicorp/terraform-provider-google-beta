...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionAutoscaler,
		DeleteFunction: testSweepComputeRegionAutoscaler,
	}
...
func testSweepComputeRegionAutoscaler(_ string) error {
	return listAndActionComputeRegionAutoscaler(deleteResourceComputeRegionAutoscaler)
}

func listAndActionComputeRegionAutoscaler(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeRegionAutoscaler(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
