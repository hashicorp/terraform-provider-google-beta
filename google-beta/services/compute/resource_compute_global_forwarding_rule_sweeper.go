...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeGlobalForwardingRule,
		DeleteFunction: testSweepComputeGlobalForwardingRule,
	}
...
func testSweepComputeGlobalForwardingRule(_ string) error {
	return listAndActionComputeGlobalForwardingRule(deleteResourceComputeGlobalForwardingRule)
}

func listAndActionComputeGlobalForwardingRule(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeGlobalForwardingRule"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/global/forwardingRules", "?")[0]
...
func deleteResourceComputeGlobalForwardingRule(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/global/forwardingRules/{{name}}"
