...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeBackendBucket,
		DeleteFunction: testSweepComputeBackendBucket,
	}
...
func testSweepComputeBackendBucket(_ string) error {
	return listAndActionComputeBackendBucket(deleteResourceComputeBackendBucket)
}

func listAndActionComputeBackendBucket(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeBackendBucket(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
