...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeHaVpnGateway,
		DeleteFunction: testSweepComputeHaVpnGateway,
	}
...
func testSweepComputeHaVpnGateway(_ string) error {
	return listAndActionComputeHaVpnGateway(deleteResourceComputeHaVpnGateway)
}

func listAndActionComputeHaVpnGateway(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/vpnGateways", "?")[0]
...
func deleteResourceComputeHaVpnGateway(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/vpnGateways/{{name}}"
