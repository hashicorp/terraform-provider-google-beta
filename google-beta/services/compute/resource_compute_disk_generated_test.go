	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"architecture", "disk_encryption_key.0.raw_key_wo", "disk_encryption_key.0.raw_key_wo_version", "disk_encryption_key.0.rsa_encrypted_key_wo", "disk_encryption_key.0.rsa_encrypted_key_wo_version", "erase_windows_vss_signature", "interface", "labels", "params", "snapshot", "source_storage_object", "terraform_labels", "type", "zone"},
			},
			{
				ResourceName:       "google_compute_disk.default",
				RefreshState:       true,
