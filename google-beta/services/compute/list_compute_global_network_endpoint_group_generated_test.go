...
func TestAccComputeGlobalNetworkEndpointGroupListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_global_network_endpoint_group.neg",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeGlobalNetworkEndpointGroup_globalNetworkEndpointGroupExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_global_network_endpoint_group.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_global_network_endpoint_group.list_query",
