...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeTargetTcpProxy,
		DeleteFunction: testSweepComputeTargetTcpProxy,
	}
...
func testSweepComputeTargetTcpProxy(_ string) error {
	return listAndActionComputeTargetTcpProxy(deleteResourceComputeTargetTcpProxy)
}

func listAndActionComputeTargetTcpProxy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeTargetTcpProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
