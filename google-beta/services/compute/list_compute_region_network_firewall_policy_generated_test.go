...
func TestAccComputeRegionNetworkFirewallPolicyListQuery_generated(t *testing.T) {
	t.Parallel()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_network_firewall_policy.policy",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionNetworkFirewallPolicy_regionNetworkFirewallPolicyFullExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_network_firewall_policy.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_network_firewall_policy.list_query",
