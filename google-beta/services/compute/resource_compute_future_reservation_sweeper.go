...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeFutureReservation,
		DeleteFunction: testSweepComputeFutureReservation,
	}
...
func testSweepComputeFutureReservation(_ string) error {
	return listAndActionComputeFutureReservation(deleteResourceComputeFutureReservation)
}

func listAndActionComputeFutureReservation(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeFutureReservation"
...
func deleteResourceComputeFutureReservation(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
