		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_region_composite_health_check.example_test_composite_health_check",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeRegionCompositeHealthCheck_computeRegionCompositeHealthCheckBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_region_composite_health_check.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_region_composite_health_check.list_query",
