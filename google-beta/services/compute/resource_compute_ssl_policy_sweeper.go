...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeSslPolicy,
		DeleteFunction: testSweepComputeSslPolicy,
	}
...
func testSweepComputeSslPolicy(_ string) error {
	return listAndActionComputeSslPolicy(deleteResourceComputeSslPolicy)
}

func listAndActionComputeSslPolicy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeSslPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
