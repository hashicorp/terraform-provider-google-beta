...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeBackendService,
		DeleteFunction: testSweepComputeBackendService,
	}
...
func testSweepComputeBackendService(_ string) error {
	return listAndActionComputeBackendService(deleteResourceComputeBackendService)
}

func listAndActionComputeBackendService(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeBackendService"
...
func deleteResourceComputeBackendService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
