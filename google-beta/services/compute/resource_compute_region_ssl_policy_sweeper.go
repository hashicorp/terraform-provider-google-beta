...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionSslPolicy,
		DeleteFunction: testSweepComputeRegionSslPolicy,
	}
...
func testSweepComputeRegionSslPolicy(_ string) error {
	return listAndActionComputeRegionSslPolicy(deleteResourceComputeRegionSslPolicy)
}

func listAndActionComputeRegionSslPolicy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeRegionSslPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
