...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputePublicAdvertisedPrefix,
		DeleteFunction: testSweepComputePublicAdvertisedPrefix,
	}
...
func testSweepComputePublicAdvertisedPrefix(_ string) error {
	return listAndActionComputePublicAdvertisedPrefix(deleteResourceComputePublicAdvertisedPrefix)
}

func listAndActionComputePublicAdvertisedPrefix(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'publicAdvertisedPrefixs'")
		} else {
...
func deleteResourceComputePublicAdvertisedPrefix(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
