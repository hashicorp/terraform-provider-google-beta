...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionTargetTcpProxy,
		DeleteFunction: testSweepComputeRegionTargetTcpProxy,
	}
...
func testSweepComputeRegionTargetTcpProxy(_ string) error {
	return listAndActionComputeRegionTargetTcpProxy(deleteResourceComputeRegionTargetTcpProxy)
}

func listAndActionComputeRegionTargetTcpProxy(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[0]["region"] = "europe-west4"
...
func deleteResourceComputeRegionTargetTcpProxy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
