...
func TestAccComputeOrganizationSecurityPolicyRule_organizationSecurityPolicyRuleFirewallExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeOrganizationSecurityPolicyRule_organizationSecurityPolicyRuleFirewallExample(context),
			},
			{
				ResourceName:            "google_compute_organization_security_policy_rule.policy",
				ImportState:             true,
...
func testAccComputeOrganizationSecurityPolicyRule_organizationSecurityPolicyRuleFirewallExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_compute_organization_security_policy" "policy" {
