...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeRegionCompositeHealthCheck,
		DeleteFunction: testSweepComputeRegionCompositeHealthCheck,
	}
...
func testSweepComputeRegionCompositeHealthCheck(_ string) error {
	return listAndActionComputeRegionCompositeHealthCheck(deleteResourceComputeRegionCompositeHealthCheck)
}

func listAndActionComputeRegionCompositeHealthCheck(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeRegionCompositeHealthCheck"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["regionCompositeHealthChecks"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'regionCompositeHealthChecks'")
		} else {
...
func deleteResourceComputeRegionCompositeHealthCheck(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
