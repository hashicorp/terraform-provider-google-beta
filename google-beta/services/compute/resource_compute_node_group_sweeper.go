...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeNodeGroup,
		DeleteFunction: testSweepComputeNodeGroup,
	}
...
func testSweepComputeNodeGroup(_ string) error {
	return listAndActionComputeNodeGroup(deleteResourceComputeNodeGroup)
}

func listAndActionComputeNodeGroup(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[0]["zone"] = "us-central1-f"
...
func deleteResourceComputeNodeGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
