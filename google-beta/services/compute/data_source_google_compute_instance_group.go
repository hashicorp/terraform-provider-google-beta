...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/compute/data_source_google_compute_instance_group.go
//
...
func init() {
	registry.Schema{
		...
		Schema:      DataSourceGoogleComputeInstanceGroup(),
	}.Register()
}
