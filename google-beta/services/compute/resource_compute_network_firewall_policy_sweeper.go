...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeNetworkFirewallPolicy,
		DeleteFunction: testSweepComputeNetworkFirewallPolicy,
	}
...
func testSweepComputeNetworkFirewallPolicy(_ string) error {
	return listAndActionComputeNetworkFirewallPolicy(deleteResourceComputeNetworkFirewallPolicy)
}

func listAndActionComputeNetworkFirewallPolicy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeNetworkFirewallPolicy"
...
func deleteResourceComputeNetworkFirewallPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
