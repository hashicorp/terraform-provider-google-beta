...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeZoneVmExtensionPolicy,
		DeleteFunction: testSweepComputeZoneVmExtensionPolicy,
	}
...
func testSweepComputeZoneVmExtensionPolicy(_ string) error {
	return listAndActionComputeZoneVmExtensionPolicy(deleteResourceComputeZoneVmExtensionPolicy)
}

func listAndActionComputeZoneVmExtensionPolicy(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeZoneVmExtensionPolicy"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["zoneVmExtensionPolicies"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'zoneVmExtensionPolicies'")
		} else {
...
func deleteResourceComputeZoneVmExtensionPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
