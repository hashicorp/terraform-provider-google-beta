...
func init() {
	registry.FrameworkListResource{
		Name:        "google_compute_interconnect_attachment_group",
		ProductName: "Compute",
		Func:        NewComputeInterconnectAttachmentGroupListResource,
	}.Register()
}

var _ list.ListResource = &ComputeInterconnectAttachmentGroupListResource{}

type ComputeInterconnectAttachmentGroupListResource struct {
	tpgresource.ListResourceMetadata
}

func NewComputeInterconnectAttachmentGroupListResource() list.ListResource {
	listR := &ComputeInterconnectAttachmentGroupListResource{}
	listR.TypeName = "google_compute_interconnect_attachment_group"
	listR.SDKv2Resource = ResourceComputeInterconnectAttachmentGroup()
...
// ComputeInterconnectAttachmentGroupListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type ComputeInterconnectAttachmentGroupListModel struct {
	Project types.String `tfsdk:"project"`
}

func (listR *ComputeInterconnectAttachmentGroupListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data ComputeInterconnectAttachmentGroupListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListComputeInterconnectAttachmentGroups(
			listR.Client,
			project,
...
func ListComputeInterconnectAttachmentGroups(config *transport_tpg.Config,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceComputeInterconnectAttachmentGroup().Data(&terraform.InstanceState{})
	if project != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{ComputeBasePath}}projects/{{project}}/global/interconnectAttachmentGroups")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceComputeInterconnectAttachmentGroup(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "interconnectAttachmentGroups",
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceComputeInterconnectAttachmentGroupFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}
