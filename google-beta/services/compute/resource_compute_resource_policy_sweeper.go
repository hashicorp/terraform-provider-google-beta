...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeResourcePolicy,
		DeleteFunction: testSweepComputeResourcePolicy,
	}
...
func testSweepComputeResourcePolicy(_ string) error {
	return listAndActionComputeResourcePolicy(deleteResourceComputeResourcePolicy)
}

func listAndActionComputeResourcePolicy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeResourcePolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
