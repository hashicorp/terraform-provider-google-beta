...
func TestAccComputeSecurityPolicy_securityPolicyWithBodyExclude(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeSecurityPolicy_securityPolicyWithBodyExclude(context),
			},
			{
				ResourceName:            "google_compute_security_policy.policy_rule_one",
				ImportState:             true,
				ImportStateVerify:       true,
...
func testAccComputeSecurityPolicy_securityPolicyWithBodyExclude(context map[string]interface{}) string {
	return acctest.Nprintf(`
...
func TestAccComputeSecurityPolicy_withRequestBody(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeSecurityPolicy_withRequestBody(context),
			},
		},
	})
}

func testAccComputeSecurityPolicy_withRequestBody(context map[string]interface{}) string {
	return acctest.Nprintf(`
provider "google-beta" {
  region = "%{region}"
}
...
func testAccCheckComputeSecurityPolicyDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		...
		for _, rs := range s.RootModule().Resources {
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, "{{ComputeBasePath}}projects/{{project}}/global/securityPolicies/{{name}}")
			if err != nil {
				return err
			}
