...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeNetworkFirewallPolicyWithRules,
		DeleteFunction: testSweepComputeNetworkFirewallPolicyWithRules,
	}
...
func testSweepComputeNetworkFirewallPolicyWithRules(_ string) error {
	return listAndActionComputeNetworkFirewallPolicyWithRules(deleteResourceComputeNetworkFirewallPolicyWithRules)
}

func listAndActionComputeNetworkFirewallPolicyWithRules(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ComputeNetworkFirewallPolicyWithRules"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/global/firewallPolicies", "?")[0]
...
func deleteResourceComputeNetworkFirewallPolicyWithRules(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/global/firewallPolicies/{{name}}"
