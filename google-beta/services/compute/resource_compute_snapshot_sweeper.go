...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionComputeSnapshot,
		DeleteFunction: testSweepComputeSnapshot,
	}
...
func testSweepComputeSnapshot(_ string) error {
	return listAndActionComputeSnapshot(deleteResourceComputeSnapshot)
}

func listAndActionComputeSnapshot(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceComputeSnapshot(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
