...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/secretmanager/resource_secret_manager_secret_test.go
//
...
func TestAccSecretManagerSecret_tags(t *testing.T) {
	...
	tagKey := tags.BootstrapSharedTestOrganizationTagKey(t, "secret_manager_secret-tagkey", map[string]interface{}{})
