...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionLookerInstance,
		DeleteFunction: testSweepLookerInstance,
	}
...
func testSweepLookerInstance(_ string) error {
	return listAndActionLookerInstance(deleteResourceLookerInstance)
}

func listAndActionLookerInstance(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceLookerInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
