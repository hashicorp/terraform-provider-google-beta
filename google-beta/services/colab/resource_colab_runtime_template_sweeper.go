...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionColabRuntimeTemplate,
		DeleteFunction: testSweepColabRuntimeTemplate,
	}
...
func testSweepColabRuntimeTemplate(_ string) error {
	return listAndActionColabRuntimeTemplate(deleteResourceColabRuntimeTemplate)
}

func listAndActionColabRuntimeTemplate(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ColabRuntimeTemplate"
...
func deleteResourceColabRuntimeTemplate(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
