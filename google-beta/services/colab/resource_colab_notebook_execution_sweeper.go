...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionColabNotebookExecution,
		DeleteFunction: testSweepColabNotebookExecution,
	}
...
func testSweepColabNotebookExecution(_ string) error {
	return listAndActionColabNotebookExecution(deleteResourceColabNotebookExecution)
}

func listAndActionColabNotebookExecution(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ColabNotebookExecution"
...
func deleteResourceColabNotebookExecution(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
