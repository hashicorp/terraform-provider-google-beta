...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionColabRuntime,
		DeleteFunction: testSweepColabRuntime,
	}
...
func testSweepColabRuntime(_ string) error {
	return listAndActionColabRuntime(deleteResourceColabRuntime)
}

func listAndActionColabRuntime(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ColabRuntime"
...
func deleteResourceColabRuntime(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
