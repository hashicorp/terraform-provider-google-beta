...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/cloudasset/data_source_google_cloud_asset_resources_search_all.go.tmpl
//
...
func datasourceGoogleCloudAssetResourcesSearchAllRead(d *schema.ResourceData, meta interface{}) error {
	...
	if universeDomain != "" && universeDomain != "googleapis.com" {
		url = fmt.Sprintf("https://cloudasset.%s/v1p1beta1/%s/resources:searchAll", universeDomain, scope)
	} else {
