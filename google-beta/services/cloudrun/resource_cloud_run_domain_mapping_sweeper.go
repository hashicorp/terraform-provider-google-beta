...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudRunDomainMapping,
		DeleteFunction: testSweepCloudRunDomainMapping,
	}
...
func testSweepCloudRunDomainMapping(_ string) error {
	return listAndActionCloudRunDomainMapping(deleteResourceCloudRunDomainMapping)
}

func listAndActionCloudRunDomainMapping(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CloudRunDomainMapping"
...
func deleteResourceCloudRunDomainMapping(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
