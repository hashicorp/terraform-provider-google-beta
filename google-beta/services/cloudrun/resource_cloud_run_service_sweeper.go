...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudRunService,
		DeleteFunction: testSweepCloudRunService,
	}
...
func testSweepCloudRunService(_ string) error {
	return listAndActionCloudRunService(deleteResourceCloudRunService)
}

func listAndActionCloudRunService(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CloudRunService"
	...
	intermediateValues[2]["region"] = "europe-north1"
...
func deleteResourceCloudRunService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
