...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_gke_hub_fleet",
		ListAndAction:  listAndActionGKEHub2Fleet,
		DeleteFunction: testSweepGKEHub2Fleet,
	}
...
func testSweepGKEHub2Fleet(_ string) error {
	return listAndActionGKEHub2Fleet(deleteResourceGKEHub2Fleet)
}

func listAndActionGKEHub2Fleet(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "GKEHub2Fleet"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://gkehub.googleapis.com/v1beta/projects/{{project}}/locations/global/fleets", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'fleets'")
		} else {
...
func deleteResourceGKEHub2Fleet(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://gkehub.googleapis.com/v1beta/projects/{{project}}/locations/global/fleets/default"
