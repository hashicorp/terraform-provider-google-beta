...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionParameterManagerRegionalRegionalParameter,
		DeleteFunction: testSweepParameterManagerRegionalRegionalParameter,
	}
...
func testSweepParameterManagerRegionalRegionalParameter(_ string) error {
	return listAndActionParameterManagerRegionalRegionalParameter(deleteResourceParameterManagerRegionalRegionalParameter)
}

func listAndActionParameterManagerRegionalRegionalParameter(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ParameterManagerRegionalRegionalParameter"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://parametermanager.{{location}}.rep.googleapis.com/v1/projects/{{project}}/locations/{{location}}/parameters", "?")[0]
...
func deleteResourceParameterManagerRegionalRegionalParameter(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://parametermanager.{{location}}.rep.googleapis.com/v1/projects/{{project}}/locations/{{location}}/parameters/{{parameter_id}}"
