...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDatabaseMigrationServiceMigrationJob,
		DeleteFunction: testSweepDatabaseMigrationServiceMigrationJob,
	}
...
func testSweepDatabaseMigrationServiceMigrationJob(_ string) error {
	return listAndActionDatabaseMigrationServiceMigrationJob(deleteResourceDatabaseMigrationServiceMigrationJob)
}

func listAndActionDatabaseMigrationServiceMigrationJob(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "DatabaseMigrationServiceMigrationJob"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://datamigration.googleapis.com/v1/projects/{{project}}/locations/{{location}}/migrationJobs", "?")[0]
		...
		resourceList, ok := res["migrationJobs"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'migrationJobs'")
		} else {
...
func deleteResourceDatabaseMigrationServiceMigrationJob(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://datamigration.googleapis.com/v1/projects/{{project}}/locations/{{location}}/migrationJobs/{{migration_job_id}}"
