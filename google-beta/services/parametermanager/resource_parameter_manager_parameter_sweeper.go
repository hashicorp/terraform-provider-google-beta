...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionParameterManagerParameter,
		DeleteFunction: testSweepParameterManagerParameter,
	}
...
func testSweepParameterManagerParameter(_ string) error {
	return listAndActionParameterManagerParameter(deleteResourceParameterManagerParameter)
}

func listAndActionParameterManagerParameter(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "ParameterManagerParameter"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://parametermanager.googleapis.com/v1/projects/{{project}}/locations/global/parameters", "?")[0]
...
func deleteResourceParameterManagerParameter(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://parametermanager.googleapis.com/v1/projects/{{project}}/locations/global/parameters/{{parameter_id}}"
