...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/parametermanager/data_source_parameter_manager_parameter_version_render.go.tmpl
//
...
func init() {
	registry.Schema{
		Name:        "google_parameter_manager_parameter_version_render",
		ProductName: "parametermanager",
		Type:        registry.SchemaTypeDataSource,
		Schema:      DataSourceParameterManagerParameterVersionRender(),
	}.Register()
}
