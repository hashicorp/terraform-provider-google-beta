...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudBuildTrigger,
		DeleteFunction: testSweepCloudBuildTrigger,
	}
...
func testSweepCloudBuildTrigger(_ string) error {
	return listAndActionCloudBuildTrigger(deleteResourceCloudBuildTrigger)
}

func listAndActionCloudBuildTrigger(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceCloudBuildTrigger(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
