...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudBuildBitbucketServerConfig,
		DeleteFunction: testSweepCloudBuildBitbucketServerConfig,
	}
...
func testSweepCloudBuildBitbucketServerConfig(_ string) error {
	return listAndActionCloudBuildBitbucketServerConfig(deleteResourceCloudBuildBitbucketServerConfig)
}

func listAndActionCloudBuildBitbucketServerConfig(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CloudBuildBitbucketServerConfig"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://cloudbuild.googleapis.com/v1/projects/{{project}}/locations/{{location}}/bitbucketServerConfigs", "?")[0]
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'bitbucketServerConfigs'")
		} else {
...
func deleteResourceCloudBuildBitbucketServerConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://cloudbuild.googleapis.com/v1/projects/{{project}}/locations/{{location}}/bitbucketServerConfigs/{{config_id}}"
