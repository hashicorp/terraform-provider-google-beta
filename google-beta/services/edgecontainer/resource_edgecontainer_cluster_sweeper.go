...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionEdgecontainerCluster,
		DeleteFunction: testSweepEdgecontainerCluster,
	}
...
func testSweepEdgecontainerCluster(_ string) error {
	return listAndActionEdgecontainerCluster(deleteResourceEdgecontainerCluster)
}

func listAndActionEdgecontainerCluster(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceEdgecontainerCluster(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
