...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionLustreInstance,
		DeleteFunction: testSweepLustreInstance,
	}
...
func testSweepLustreInstance(_ string) error {
	return listAndActionLustreInstance(deleteResourceLustreInstance)
}

func listAndActionLustreInstance(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "LustreInstance"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://lustre.googleapis.com/v1/projects/{{project}}/locations/{{location}}/instances", "?")[0]
...
func deleteResourceLustreInstance(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://lustre.googleapis.com/v1/projects/{{project}}/locations/{{location}}/instances/{{instance_id}}"
