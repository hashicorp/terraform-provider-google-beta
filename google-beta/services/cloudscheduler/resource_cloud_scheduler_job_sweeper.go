...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudSchedulerJob,
		DeleteFunction: testSweepCloudSchedulerJob,
	}
...
func testSweepCloudSchedulerJob(_ string) error {
	return listAndActionCloudSchedulerJob(deleteResourceCloudSchedulerJob)
}

func listAndActionCloudSchedulerJob(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceCloudSchedulerJob(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
