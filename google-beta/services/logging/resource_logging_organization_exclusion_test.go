...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/logging/resource_logging_organization_exclusion_test.go
//
...
func testAccCheckLoggingOrganizationExclusionDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		...
		for _, rs := range s.RootModule().Resources {
			...
			_, err := logging.NewClient(config, config.UserAgent).Organizations.Exclusions.Get(attributes["id"]).Do()
			if err == nil {
