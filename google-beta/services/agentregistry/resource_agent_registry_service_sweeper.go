...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionAgentRegistryService,
		DeleteFunction: testSweepAgentRegistryService,
	}
...
func testSweepAgentRegistryService(_ string) error {
	return listAndActionAgentRegistryService(deleteResourceAgentRegistryService)
}

func listAndActionAgentRegistryService(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "AgentRegistryService"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://agentregistry.googleapis.com/v1/projects/{{project}}/locations/{{location}}/services", "?")[0]
...
func deleteResourceAgentRegistryService(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://agentregistry.googleapis.com/v1/projects/{{project}}/locations/{{location}}/services/{{service_id}}"
