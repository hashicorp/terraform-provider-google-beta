...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudBillingProjectInfo,
		DeleteFunction: testSweepCloudBillingProjectInfo,
	}
...
func testSweepCloudBillingProjectInfo(_ string) error {
	return listAndActionCloudBillingProjectInfo(deleteResourceCloudBillingProjectInfo)
}

func listAndActionCloudBillingProjectInfo(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "CloudBillingProjectInfo"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://cloudbilling.googleapis.com/v1/projects/{{project}}/billingInfo", "?")[0]
...
func deleteResourceCloudBillingProjectInfo(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://cloudbilling.googleapis.com/v1/projects/{{project}}/billingInfo/{{name}}"
