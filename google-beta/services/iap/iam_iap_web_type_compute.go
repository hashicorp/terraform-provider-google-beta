...
//
//     Configuration: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/products/iap/WebTypeCompute.yaml
...
func init() {
	registry.Schema{
		...
		Schema:      tpgiamresource.ResourceIamBinding(IapWebTypeComputeIamSchema, IapWebTypeComputeIamUpdaterProducer, IapWebTypeComputeIdParseFunc),
	}.Register()
	registry.Schema{
		Name:        "google_iap_web_type_compute_iam_member",
		ProductName: "Iap",
		Type:        registry.SchemaTypeIAMResource,
		Schema:      NewIapWebTypeComputeIamMemberResource(),
	}.Register()
	registry.Schema{
		Name:        "google_iap_web_type_compute_iam_policy",
		ProductName: "Iap",
		Type:        registry.SchemaTypeIAMResource,
		Schema:      tpgiamresource.ResourceIamPolicy(IapWebTypeComputeIamSchema, IapWebTypeComputeIamUpdaterProducer, IapWebTypeComputeIdParseFunc),
	}.Register()
	registry.Schema{
		Name:        "google_iap_web_type_compute_iam_policy",
		ProductName: "Iap",
		Type:        registry.SchemaTypeIAMDataSource,
		Schema:      tpgiamresource.DataSourceIamPolicy(IapWebTypeComputeIamSchema, IapWebTypeComputeIamUpdaterProducer),
	}.Register()
}

// NewIapWebTypeComputeIamMemberResource returns the google_iap_web_type_compute_iam_member
// managed resource. It is shared by the managed resource registration and the
// list resource, so both stay in sync.
func NewIapWebTypeComputeIamMemberResource() *schema.Resource {
	return tpgiamresource.ResourceIamMember(
		IapWebTypeComputeIamSchema,
		IapWebTypeComputeIamUpdaterProducer,
		IapWebTypeComputeIdParseFunc,
		tpgiamresource.IamWithParentResourceIdentity(IapWebTypeComputeIamParentParentResourceIdentityParser),
	)
}
...
func IapWebTypeComputeIamParentParentResourceIdentityParser(d *schema.ResourceData, identity *schema.IdentityData, transportConfig *transport_tpg.Config) (string, error) {
	return tpgiamresource.ParseIamResourceIdentity(d, identity, transportConfig, tpgiamresource.IamResourceIdentityConfig{
		Params: []tpgiamresource.IamIdentityParam{
			{Key: "project", IdentityKey: "project"},
		},
		UriFormat: "projects/%s/iap_web/compute",
	})
}
