...
func listAndActionIAM3ProjectAccessPolicy(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://iam.googleapis.com/v3beta/projects/{{project}}/locations/{{location}}/accessPolicies", "?")[0]
...
func deleteResourceIAM3ProjectAccessPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://iam.googleapis.com/v3beta/projects/{{project}}/locations/{{location}}/accessPolicies/{{access_policy_id}}"
