...
//
//	Source file: https://github.com/GoogleCloudPlatform/magic-modules/tree/main/mmv1/third_party/terraform/services/gemini/resource_gemini_gibq_observability_setting_binding_test.go
//
