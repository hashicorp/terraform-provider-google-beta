...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionGeminiGdaObservabilitySetting,
		DeleteFunction: testSweepGeminiGdaObservabilitySetting,
	}
...
func testSweepGeminiGdaObservabilitySetting(_ string) error {
	return listAndActionGeminiGdaObservabilitySetting(deleteResourceGeminiGdaObservabilitySetting)
}

func listAndActionGeminiGdaObservabilitySetting(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "GeminiGdaObservabilitySetting"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/gdaObservabilitySettings", "?")[0]
		...
		resourceList, ok := res["gdaObservabilitySettings"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'gdaObservabilitySettings'")
		} else {
...
func deleteResourceGeminiGdaObservabilitySetting(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/gdaObservabilitySettings/{{gda_observability_setting_id}}"
