...
func init() {
	sweeper.AddTestSweepers("GeminiCodeRepositoryIndex", testSweepGeminiCodeRepositoryIndex)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepGeminiCodeRepositoryIndex(region string) error {
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/codeRepositoryIndexes/{{code_repository_index_id}}"
