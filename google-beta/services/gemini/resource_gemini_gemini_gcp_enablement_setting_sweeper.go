...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionGeminiGeminiGcpEnablementSetting,
		DeleteFunction: testSweepGeminiGeminiGcpEnablementSetting,
	}
...
func testSweepGeminiGeminiGcpEnablementSetting(_ string) error {
	return listAndActionGeminiGeminiGcpEnablementSetting(deleteResourceGeminiGeminiGcpEnablementSetting)
}

func listAndActionGeminiGeminiGcpEnablementSetting(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "GeminiGeminiGcpEnablementSetting"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/geminiGcpEnablementSettings", "?")[0]
		...
		resourceList, ok := res["geminiGcpEnablementSettings"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'geminiGcpEnablementSettings'")
		} else {
...
func deleteResourceGeminiGeminiGcpEnablementSetting(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/geminiGcpEnablementSettings/{{gemini_gcp_enablement_setting_id}}"
