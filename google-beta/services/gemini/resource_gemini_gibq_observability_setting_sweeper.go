...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionGeminiGibqObservabilitySetting,
		DeleteFunction: testSweepGeminiGibqObservabilitySetting,
	}
...
func testSweepGeminiGibqObservabilitySetting(_ string) error {
	return listAndActionGeminiGibqObservabilitySetting(deleteResourceGeminiGibqObservabilitySetting)
}

func listAndActionGeminiGibqObservabilitySetting(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "GeminiGibqObservabilitySetting"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/gibqObservabilitySettings", "?")[0]
		...
		resourceList, ok := res["gibqObservabilitySettings"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'gibqObservabilitySettings'")
		} else {
...
func deleteResourceGeminiGibqObservabilitySetting(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://cloudaicompanion.googleapis.com/v1/projects/{{project}}/locations/{{location}}/gibqObservabilitySettings/{{gibq_observability_setting_id}}"
