...
func TestAccContainerCluster_withManagedOpenTelemetryConfig(t *testing.T) {
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccContainerCluster_withManagedOpenTelemetryConfig(clusterName, networkName, subnetworkName, "SCOPE_UNSPECIFIED"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("google_container_cluster.with_managed_opentelemetry",
						"managed_opentelemetry_config.0.scope", "SCOPE_UNSPECIFIED"),
				),
			},
			{
				ResourceName:            "google_container_cluster.with_managed_opentelemetry",
...
func TestAccContainerCluster_withTpu(t *testing.T) {
	...
	// Skip in VCR until the test issue is resolved
	// https://github.com/hashicorp/terraform-provider-google/issues/21968
	acctest.SkipIfVcr(t)
...
func TestAccContainerCluster_withTPUConfig(t *testing.T) {
	...
	// Skip in VCR until the test issue is resolved
	// https://github.com/hashicorp/terraform-provider-google/issues/21993
	acctest.SkipIfVcr(t)
