...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudfunctions2function,
		DeleteFunction: testSweepCloudfunctions2function,
	}
...
func testSweepCloudfunctions2function(_ string) error {
	return listAndActionCloudfunctions2function(deleteResourceCloudfunctions2function)
}

func listAndActionCloudfunctions2function(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[1]["region"] = "europe-west6"
...
func deleteResourceCloudfunctions2function(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
