...
func TestAccApigeeOrganizationListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccApigeeOrganization_apigeeOrganizationCloudBasicTestExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_apigee_organization.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_apigee_organization.list_query",
...
func testAccApigeeOrganization_apigeeOrganizationCloudBasicTestExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_apigee_organization" "list_query" {
    provider = google
	limit = 10000
    config {
    }
