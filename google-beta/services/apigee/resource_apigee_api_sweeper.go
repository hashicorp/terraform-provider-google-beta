...
func init() {
	sweeper.AddTestSweepersLegacy("ApigeeApi", testSweepApigeeApi)
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepApigeeApi(region string) error {
	resourceName := "ApigeeApi"
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://apigee.googleapis.com/v1/organizations/{{org_id}}/apis/{{name}}"
