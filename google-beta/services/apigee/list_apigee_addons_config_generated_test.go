...
func TestAccApigeeAddonsConfigListQuery_generated(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_apigee_addons_config.apigee_org_addons",
						[]string{
							"org",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccApigeeAddonsConfig_apigeeAddonsTestExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_apigee_addons_config.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_apigee_addons_config.list_query",
...
func testAccApigeeAddonsConfig_apigeeAddonsTestExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_apigee_addons_config" "list_query" {
    provider = google
	limit = 10000
    config {
    }
