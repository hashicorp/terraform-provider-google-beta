...
func TestAccApigeeEnvironmentKeyvaluemaps_apigeeEnvironmentKeyvaluemapsBetaTestExample(t *testing.T) {
	t.Parallel()
...
func testAccApigeeEnvironmentKeyvaluemaps_apigeeEnvironmentKeyvaluemapsBetaTestExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_project" "project" { 
...
func testAccCheckApigeeEnvironmentKeyvaluemapsDestroyProducer(t *testing.T) func(s *terraform.State) error {
	return func(s *terraform.State) error {
		for name, rs := range s.RootModule().Resources {
			...
			url, err := tpgresource.ReplaceVarsForTest(config, rs, fmt.Sprintf("%s%s", transport_tpg.BaseUrl(apigee.Product, config), "{{env_id}}/keyvaluemaps/{{name}}/entries"))
			if err != nil {
				return err
			}
