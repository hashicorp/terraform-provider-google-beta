...
func testSweepNetappkmsconfig(region string) error {
	...
	listTemplate := strings.Split("https://netapp.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/kmsConfigs", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://netapp.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/kmsConfigs/{{name}}"
