...
func testSweepNetappactiveDirectory(region string) error {
	...
	listTemplate := strings.Split("https://netapp.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/activeDirectories", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://netapp.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/activeDirectories/{{name}}"
