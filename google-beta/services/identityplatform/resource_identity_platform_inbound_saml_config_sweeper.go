...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIdentityPlatformInboundSamlConfig,
		DeleteFunction: testSweepIdentityPlatformInboundSamlConfig,
	}
...
func testSweepIdentityPlatformInboundSamlConfig(_ string) error {
	return listAndActionIdentityPlatformInboundSamlConfig(deleteResourceIdentityPlatformInboundSamlConfig)
}

func listAndActionIdentityPlatformInboundSamlConfig(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'inboundSamlConfigs'")
		} else {
...
func deleteResourceIdentityPlatformInboundSamlConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
