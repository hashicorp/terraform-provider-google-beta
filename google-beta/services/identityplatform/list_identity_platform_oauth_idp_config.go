...
func init() {
	registry.FrameworkListResource{
		...
		Func:        NewIdentityPlatformOauthIdpConfigListResource,
	}.Register()
}

var _ list.ListResource = &IdentityPlatformOauthIdpConfigListResource{}

type IdentityPlatformOauthIdpConfigListResource struct {
	tpgresource.ListResourceMetadata
}

func NewIdentityPlatformOauthIdpConfigListResource() list.ListResource {
	listR := &IdentityPlatformOauthIdpConfigListResource{}
	listR.TypeName = "google_identity_platform_oauth_idp_config"
	listR.SDKv2Resource = ResourceIdentityPlatformOauthIdpConfig()
...
// IdentityPlatformOauthIdpConfigListModel matches ListResourceMetadata.ListConfigFields (tfsdk names and types).
type IdentityPlatformOauthIdpConfigListModel struct {
	Project types.String `tfsdk:"project"`
}

func (listR *IdentityPlatformOauthIdpConfigListResource) List(ctx context.Context, listReq list.ListRequest, stream *list.ListResultsStream) {
	var data IdentityPlatformOauthIdpConfigListModel
	...
	stream.Results = func(push func(list.ListResult) bool) {
		err := ListIdentityPlatformOauthIdpConfigs(
			listR.Client,
			project,
...
func ListIdentityPlatformOauthIdpConfigs(config *transport_tpg.Config,
	project string,
	callback func(*schema.ResourceData) error,
) error {
	resourceData := ResourceIdentityPlatformOauthIdpConfig().Data(&terraform.InstanceState{})
	if project != "" {
	...
	url, err := tpgresource.ReplaceVars(resourceData, config, "{{IdentityPlatformBasePath}}projects/{{project}}/oauthIdpConfigs")
	if err != nil {
		return err
	}
	...
	return transport_tpg.ListPages(transport_tpg.ListPagesOptions{
		...
		Resource:       ResourceIdentityPlatformOauthIdpConfig(),
		ListURL:        url,
		BillingProject: billingProject,
		UserAgent:      userAgent,
		ItemName:       "oauthIdpConfigs",
		Flattener: func(res map[string]interface{}, d *schema.ResourceData, config *transport_tpg.Config) error {
			...
			if err = ResourceIdentityPlatformOauthIdpConfigFlatten(d, config, res, config, project, userAgent, billingProject, url, headers); err != nil {
				return err
			}
