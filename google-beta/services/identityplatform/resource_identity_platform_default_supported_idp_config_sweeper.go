...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIdentityPlatformDefaultSupportedIdpConfig,
		DeleteFunction: testSweepIdentityPlatformDefaultSupportedIdpConfig,
	}
...
func testSweepIdentityPlatformDefaultSupportedIdpConfig(_ string) error {
	return listAndActionIdentityPlatformDefaultSupportedIdpConfig(deleteResourceIdentityPlatformDefaultSupportedIdpConfig)
}

func listAndActionIdentityPlatformDefaultSupportedIdpConfig(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'defaultSupportedIdpConfigs'")
		} else {
...
func deleteResourceIdentityPlatformDefaultSupportedIdpConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
