...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIdentityPlatformOauthIdpConfig,
		DeleteFunction: testSweepIdentityPlatformOauthIdpConfig,
	}
...
func testSweepIdentityPlatformOauthIdpConfig(_ string) error {
	return listAndActionIdentityPlatformOauthIdpConfig(deleteResourceIdentityPlatformOauthIdpConfig)
}

func listAndActionIdentityPlatformOauthIdpConfig(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceIdentityPlatformOauthIdpConfig(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
