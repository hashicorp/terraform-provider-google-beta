...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionIdentityPlatformTenant,
		DeleteFunction: testSweepIdentityPlatformTenant,
	}
...
func testSweepIdentityPlatformTenant(_ string) error {
	return listAndActionIdentityPlatformTenant(deleteResourceIdentityPlatformTenant)
}

func listAndActionIdentityPlatformTenant(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceIdentityPlatformTenant(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
