...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionDeploymentManagerDeployment,
		DeleteFunction: testSweepDeploymentManagerDeployment,
	}
...
func testSweepDeploymentManagerDeployment(_ string) error {
	return listAndActionDeploymentManagerDeployment(deleteResourceDeploymentManagerDeployment)
}

func listAndActionDeploymentManagerDeployment(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceDeploymentManagerDeployment(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
