...
func createWorkbenchWaiter(config *transport_tpg.Config, op map[string]interface{}, project, activity, userAgent string) (*WorkbenchOperationWaiter, error) {
	w := &WorkbenchOperationWaiter{
		Config:    config,
		UserAgent: userAgent,
		Project:   project,
	}
...
func WorkbenchOperationWaitTimeWithResponse(config *transport_tpg.Config, op map[string]interface{}, response *map[string]interface{}, project, activity, userAgent string, timeout time.Duration) error {
	w, err := createWorkbenchWaiter(config, op, project, activity, userAgent)
	if err != nil {
		return err
	}
