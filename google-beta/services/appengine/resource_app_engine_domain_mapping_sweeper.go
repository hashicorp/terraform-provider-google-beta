...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionAppEngineDomainMapping,
		DeleteFunction: testSweepAppEngineDomainMapping,
	}
...
func testSweepAppEngineDomainMapping(_ string) error {
	return listAndActionAppEngineDomainMapping(deleteResourceAppEngineDomainMapping)
}

func listAndActionAppEngineDomainMapping(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "AppEngineDomainMapping"
...
func deleteResourceAppEngineDomainMapping(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
