...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionBigqueryDatapolicyDataPolicy,
		DeleteFunction: testSweepBigqueryDatapolicyDataPolicy,
	}
...
func testSweepBigqueryDatapolicyDataPolicy(_ string) error {
	return listAndActionBigqueryDatapolicyDataPolicy(deleteResourceBigqueryDatapolicyDataPolicy)
}

func listAndActionBigqueryDatapolicyDataPolicy(action sweeper.ResourceAction) error {
	var lastError error
...
func deleteResourceBigqueryDatapolicyDataPolicy(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
