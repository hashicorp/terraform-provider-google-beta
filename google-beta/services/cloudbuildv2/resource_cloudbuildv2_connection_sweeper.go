...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionCloudbuildv2Connection,
		DeleteFunction: testSweepCloudbuildv2Connection,
	}
...
func testSweepCloudbuildv2Connection(_ string) error {
	return listAndActionCloudbuildv2Connection(deleteResourceCloudbuildv2Connection)
}

func listAndActionCloudbuildv2Connection(action sweeper.ResourceAction) error {
	var lastError error
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://cloudbuild.googleapis.com/v2/projects/{{project}}/locations/{{location}}/connections", "?")[0]
...
func deleteResourceCloudbuildv2Connection(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://cloudbuild.googleapis.com/v2/projects/{{project}}/locations/{{location}}/connections/{{name}}"
