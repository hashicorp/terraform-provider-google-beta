...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionTPUNode,
		DeleteFunction: testSweepTPUNode,
	}
...
func testSweepTPUNode(_ string) error {
	return listAndActionTPUNode(deleteResourceTPUNode)
}

func listAndActionTPUNode(action sweeper.ResourceAction) error {
	var lastError error
	...
	intermediateValues[0]["zone"] = "us-central1-b"
...
func deleteResourceTPUNode(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
