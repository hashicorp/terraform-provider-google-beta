...
func testSweepComputeRouterBgpPeer(region string) error {
	...
	listTemplate := strings.Split("https://www.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/routers/{{router}}", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://www.googleapis.com/compute/beta/projects/{{project}}/regions/{{region}}/routers/{{router}}"
