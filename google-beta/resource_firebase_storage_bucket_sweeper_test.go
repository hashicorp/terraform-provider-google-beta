...
func init() {
	resource.AddTestSweepers("FirebaseStorageBucket", &resource.Sweeper{
		Name: "FirebaseStorageBucket",
		F:    testSweepFirebaseStorageBucket,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepFirebaseStorageBucket(region string) error {
