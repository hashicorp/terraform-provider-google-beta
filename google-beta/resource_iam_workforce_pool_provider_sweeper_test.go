...
func init() {
	resource.AddTestSweepers("IAMWorkforcePoolWorkforcePoolProvider", &resource.Sweeper{
		Name: "IAMWorkforcePoolWorkforcePoolProvider",
		F:    testSweepIAMWorkforcePoolWorkforcePoolProvider,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepIAMWorkforcePoolWorkforcePoolProvider(region string) error {
	resourceName := "IAMWorkforcePoolWorkforcePoolProvider"
	...
	resourceList, ok := res["workforcePoolProviders"]
	if !ok {
