...
func init() {
	resource.AddTestSweepers("ServiceDirectoryService", &resource.Sweeper{
		Name: "ServiceDirectoryService",
		F:    testSweepServiceDirectoryService,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepServiceDirectoryService(region string) error {
	resourceName := "ServiceDirectoryService"
