...
func resourceComputeRegionDiskCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if !isEmptyValue(reflect.ValueOf(diskEncryptionKeyProp)) {
	...
	if err != nil {
		return err
	} else if !isEmptyValue(reflect.ValueOf(sourceSnapshotProp)) {
	...
	if err != nil {
		return err
	} else if !isEmptyValue(reflect.ValueOf(sourceSnapshotEncryptionKeyProp)) {
...
func flattenComputeRegionDiskDiskEncryptionKey(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["kms_key_name"] =
		flattenComputeRegionDiskDiskEncryptionKeyKmsKeyName(original["kmsKeyName"], d)
...
func flattenComputeRegionDiskSourceSnapshotEncryptionKey(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["kms_key_name"] =
		flattenComputeRegionDiskSourceSnapshotEncryptionKeyKmsKeyName(original["kmsKeyName"], d)
	transformed["sha256"] =
