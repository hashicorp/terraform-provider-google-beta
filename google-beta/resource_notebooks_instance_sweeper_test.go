...
func testSweepNotebooksInstance(region string) error {
	...
	listTemplate := strings.Split("https://notebooks.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/instances", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://notebooks.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/instances/{{name}}"
