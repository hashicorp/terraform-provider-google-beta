...
func TestAccCGCSnippet_sqlInstanceIamConditionExample(t *testing.T) {
	t.Parallel()
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCGCSnippet_sqlInstanceIamConditionExample(context),
			},
			{
				ResourceName:            "google_sql_database_instance.default",
				ImportState:             true,
...
func testAccCGCSnippet_sqlInstanceIamConditionExample(context map[string]interface{}) string {
	return Nprintf(`
...
resource "google_sql_database_instance" "default" {
  name             = "tf-test-mysql-instance-iam-condition%{random_suffix}"
  provider         = google-beta
  region           = "us-central1"
  database_version = "MYSQL_8_0"
  settings {
