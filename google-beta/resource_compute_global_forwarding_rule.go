...
func resourceComputeGlobalForwardingRuleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("allow_psc_global_access"); !isEmptyValue(reflect.ValueOf(allowPscGlobalAccessProp)) && (ok || !reflect.DeepEqual(v, allowPscGlobalAccessProp)) {
...
func expandComputeGlobalForwardingRuleAllowPscGlobalAccess(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
