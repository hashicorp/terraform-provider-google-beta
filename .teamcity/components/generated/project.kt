...
fun GoogleBeta(environment: String, manualVcsRoot: AbsoluteId, configuration: ClientConfiguration) : Project {
    return Project{

        var buildConfigs = buildConfigurationsForPackages(packages, providerName, "google-beta", environment, manualVcsRoot, configuration)
